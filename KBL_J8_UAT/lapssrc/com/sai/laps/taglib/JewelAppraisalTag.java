...
public class JewelAppraisalTag extends TagSupport 
{
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	static Logger log=Logger.getLogger(JewelAppraisalTag.class);
	...
	{  
		...
		try
		{
			...
			hshValues=(HashMap)tagDataHelper5.getJewelAppraisalChargeID(hshRequestValues);	
