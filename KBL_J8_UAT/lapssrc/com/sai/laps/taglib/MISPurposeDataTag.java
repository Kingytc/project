...
public class MISPurposeDataTag extends TagSupport
{
	private static final long serialVersionUID = 1L;
	static Logger log=Logger.getLogger(MISPurposeDataTag.class);
	String apptype;
	JspWriter out =null;
	...
	public int doEndTag() throws JspException
	{
		...
		try
		{
			...
			hshValues=taglib.getMISPurposeData(hsh);
			...
			for(int i=0;i<intSize ;i++)
			{
				...
				String strSlNo = Helper.correctNull((String)vecCol.get(2));
				String strValue=strId+"_"+strSlNo;
				out.println("<option title=\""+strId+" - "+strName+"\" value=\""+strValue+"\">"+strId+" - "+strName+"</option>");
			}
