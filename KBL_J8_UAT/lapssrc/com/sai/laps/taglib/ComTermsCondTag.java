...
public class ComTermsCondTag extends TagSupport
{
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	static Logger log=Logger.getLogger(ComTermsCondTag.class);
	...
	try
		{
			...
			HashMap hshRes=(HashMap)tagDataHelper3.getComFacilities(hshQuery);
			...
			for(int i=0;i<arrFacilityId.size();i++)
			{
				...
				out.print("\">"+arrFacilityId.get(i)+" - "+arrFacilities.get(i)+"</option>");
			}	
