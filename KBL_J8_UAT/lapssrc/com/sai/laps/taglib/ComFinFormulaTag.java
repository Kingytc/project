...
public class ComFinFormulaTag extends TagSupport
{
	/**
	 * 
	 */
	static Logger log=Logger.getLogger(ComFinFormulaTag.class);
	...
	try
		...
		HashMap hshRes=(HashMap)tagDataHelper2.getComFinFormula(hshquery);
		//HashMap hshRes = (HashMap)EJBInvoker.executeStateLess("ratemaster",hshquery,"getComFinFormula");
