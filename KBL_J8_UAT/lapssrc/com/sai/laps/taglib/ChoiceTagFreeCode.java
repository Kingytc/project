...
import com.sai.laps.tagdatahelper.TagDataHelper5;
	...
	public class ChoiceTagFreeCode extends TagSupport
	{
		/**
		 * 
		 */
		static Logger log=Logger.getLogger(ChoiceTagFreeCode.class);
		...
		{  
			...
			{	
				...
				HashMap hshRes=(HashMap)tagDataHelper5.getFreeCodeData(hshPar);
