...
public class FinMasterTag extends TagSupport
{
	private static final long serialVersionUID = 1L;
	static Logger log=Logger.getLogger(FinMasterTag.class);
	...
	{  
		...
		try
		{
			...
			val=Helper.correctNull(request.getParameter("val"));
			...
			HashMap hshRes=(HashMap)tagDataHelper6.getDataHelp(hshquery);
