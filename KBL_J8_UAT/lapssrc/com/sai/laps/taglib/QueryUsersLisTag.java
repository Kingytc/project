...
public class QueryUsersLisTag extends TagSupport
{
	/**
	 * 
	 */
	...
	{  	
		...
		{	out = pageContext.getOut();
			...
			hshPar.put("strModuleType",request.getParameter("strModuleType"));
			TagDataHelper6 tagDataHelper6=new TagDataHelper6();
			HashMap hshRes=(HashMap)tagDataHelper6.getProposalUsers(hshPar);			
