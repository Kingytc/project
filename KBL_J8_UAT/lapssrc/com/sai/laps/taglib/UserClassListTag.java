...
import com.sai.laps.tagdatahelper.TagDataHelper6;
	...
	public class UserClassListTag extends TagSupport 
	{
		/**
		 * 
		 */
		static Logger log=Logger.getLogger(UserClassListTag.class);
			...
			try
			{
				...
				if(vecData.size()>0)
				{
					for(int i=0;i<vecData.size();i++)
					{
						...
						{
							out.println("<option value=\""+strDataValue1+"\">"+strDataValue1+"</option>");
						}
					}
				}
