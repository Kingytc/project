...
public class ProcessChargeTag extends TagSupport 
{
	/**
	 * 
	 */
	static Logger log=Logger.getLogger(ProcessChargeTag.class);
	...
	{  
		...
		try
		{
			...
			hshValues=(HashMap)tagDataHelper5.getProcessChargesID(hshRequestValues);	
