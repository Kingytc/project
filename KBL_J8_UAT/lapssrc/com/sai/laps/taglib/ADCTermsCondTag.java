...
public class ADCTermsCondTag extends TagSupport
{
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	static Logger log=Logger.getLogger(ADCTermsCondTag.class);
	...
	try
		{
			...
			HashMap hshRes=(HashMap)tagDataHelper3.getADCFacilities(hshQuery);
			...
			{
				out.println("<option title=\""+arrFacilities.get(i)+"\" value=\""+arrFacilityId.get(i)+"\">"+arrFacilities.get(i)+"</option>");
			}	
