...
public class BSRCodeTag extends TagSupport
{
	
	/**
	 * 
	 */
	static Logger log=Logger.getLogger(BSRCodeTag.class);
	...
	public int doEndTag() throws JspException
	{
		...
		try
		{
			...
			hshValues=taglib.getBSRCodeData(hsh);
