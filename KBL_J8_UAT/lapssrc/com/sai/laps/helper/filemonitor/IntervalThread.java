 ...
 * @description: THIS MODULE IMPLEMENTED FOR THREAD BASED  FOLDER MONITORING.
 * @DESCRIPTION: RUNNABLE INTERFACE HAS BEEN IMPLEMENTED FOR INVOCATION.PROCEEDING WITH MINIMUM PRIORITY THREAD .
 */
public abstract class IntervalThread implements Runnable {
    ...
    public void start() {
        ...
        if (runner == null && interval > 0) {
            runner = new Thread(this,"LAPS DIRECTORY-FILE MONITOR");
            runner.start();
        }
    }
    ...
    public void run() {
    	...
    	//Minimum priority has been added for the thread ///relatively low level thread 
