	...
	<td>
		...
		<tr>
			<td>
				...
				<tr> 
					<td colspan="2">Branch&nbsp;:&nbsp;<b><%=Helper.correctNull((String)hshValues.get("homebranch"))%></b></td>
					<td colspan="2">Branch Code&nbsp;:&nbsp;<b><%=Helper.correctNull((String)hshValues.get("branchcode"))%></b></td>
					<td colspan="2" width="35%" nowrap="nowrap">Region&nbsp;:&nbsp;<b><%=Helper.correctNull((String)hshValues.get("strOrgRegionName"))%></b></td>
				</tr>
				<tr>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="3" align="center" class="outertable">
					...
					<tr>
						...
						<%if(Helper.correctNull((String)hshValues.get("strIntType")).equalsIgnoreCase("Floating")){
							...
							<%}else{ %>(Fixed Spread)<%} %>
							&nbsp;<br>
						&nbsp;i.e&nbsp;<%} %><b><%=nf.format(Double.parseDouble(Helper.correctDouble((String)hshValues.get("strIntRate"))))%></b>%  pa.<br/>
						<%
...
<tr>
	<td>
	<div id="top">
		<table width="88%" border="0" align="center" cellpadding="3" cellspacing="0" class="outertable">
		<tr>
