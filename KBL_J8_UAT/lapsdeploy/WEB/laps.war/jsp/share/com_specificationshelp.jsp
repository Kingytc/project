...
function callSearch()
{
	...
	if(value == "")
	{
		...
		document.forms[0].hidvalue.value="Specifications";
...
function setValues(val1,val2,val3,val4,val5,val6,val7,val8,val9,val10,val11,val12,val13)
{
	...
	{
		//window.opener.document.forms[0].txt_activityname.text=val1;
		...
		window.opener.document.forms[0].txt_spec.text=val12;
		window.opener.document.forms[0].txt_spec.value=val12;
		window.opener.document.forms[0].hidpercentageper.value=val13;
...
<table class="outertable"  width="98%" border="0" cellspacing="0" cellpadding="0" align="center">
	...
	<tr>
      <td><b>Specification Search</b></td>
	</tr>
</table>
	...
	<tr>
		...
		<table class="outertable"  width="100%" border="0" cellspacing="0" cellpadding="1">
			<tr>
				...
				<table class="outertable"  width="100%" border="0" cellspacing="0" cellpadding="1">
					<tr>
					<td align="right" width="22%"><b>Specification Name</b></td>
			...
			<tr>
				...
				<table class="outertable"  width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<td width="50%" align="center"><b>Specification Name</b></td>
				...
				for (int i = 0; i < arrSize; i++) {
					...
					//out.println("==============arryCol====="+arryCol);
						%>
							<tr class="datagrid">
								<td width="7%"><%=i + 1%></td>
								<td width="50%"><a
									href="javascript:setValues('<%= Helper.correctNull((String)arryCol.get(11))%>',
									...
									'<%= Helper.correctNull((String)arryCol.get(11))%>',
									'<%= Helper.correctNull((String)arryCol.get(12))%>')"><%=Helper.correctNull((String) arryCol.get(11))%></a> 
                          	</td>
