...
<script language="javascript" src="<%=ApplicationParams.getAppUrl()%>js/share/browsereport.js"></script>
<script>
                    ...
                    <table width="3%" border="0" cellspacing="0" cellpadding="5"  align="center" height="8">
                      <tr valign="top"> 
                        <td height="0" width="12%"> 
                          <div align="center"> <b> 
                            <input type="button" name="run" value="Run Report" style="background-color:#8F8369;font-weight:bold;color:white;font-size=10;font-family:mssansserif;width:80;font-weight:bold" onClick ="runrep()">
                            </b></div>
                        </td>
                        <td height="0" width="12%"> 
                          <div align="center"> <b> 
