...
function doDelete()
{
	...
	document.forms[0].hidSourceUrl.value="/action/app_creditsales.jsp";
...
function doCancel()
{
	...
	if(varconfirm)
	{
		document.forms[0].hidBeanGetMethod.value="getCreditSalesData";
		document.forms[0].hidBeanId.value="appraisal";
		document.forms[0].action=appURL+"action/app_creditsales.jsp";
		document.forms[0].submit();
	}
}
...
<%
	if (!Helper
			.correctNull((String) session.getAttribute("strAppType"))
			.equalsIgnoreCase("P")) {
...
<table width="100%" border="0" cellpadding="0" cellspacing="0"
	...
	<tr>
		...
		-&gt; Appraisal -&gt;Reason For Manual Processing</td>
	</tr>
</table>
<lapschoice:application /> <jsp:include page="../share/apprlinktab.jsp"
	...
	<jsp:param name="tabid" value="215" />
 	...
 	}else if(Helper.correctNull((String) session.getAttribute("strAppType")).equalsIgnoreCase("A") || Helper.correctNull((String) session.getAttribute("strAppType")).equalsIgnoreCase("F")){%>
 		<jsp:include
