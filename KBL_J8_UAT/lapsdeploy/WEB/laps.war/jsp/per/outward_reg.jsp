...
//vindhya begin
	...
	function doCancel()
	{
		...
		if(ConfirmMsg('102'))
		{
			document.forms[0].action=appURL+"action/outward_reg.jsp";
			document.forms[0].hidBeanId.value = "lapsReport";
			document.forms[0].hidBeanGetMethod.value = "getoutwarddetails";
...
function doSave()  
{
	...
	//document.forms[0].hidAction.value="Insert";
	document.forms[0].hidBeanId.value="lapsReport";	
	document.forms[0].hidBeanMethod.value="updateoutwarddetails";
	document.forms[0].hidBeanGetMethod.value="getoutwarddetails";
	document.forms[0].hidSourceUrl.value="/action/outward_reg.jsp";
...
<table class="outertable" width="100%"  border="0" cellspacing="0" cellpadding="3" align="center">
	...
	<tr class="dataheader" style="text-align: center">
		<td style="text-align: center;width:100%;">Outward Details</td><td></td>	
	</tr>
</table>	
<table class="outertable" width="100%"  border="0" cellspacing="0" cellpadding="3" align="center">	
	<tr>
		<td width="10%">Outward Ref No <b><span class="mantatory">*</span></b></td>
		 <td width="15%"><input type="text" name="txt_inwardrefno"  maxlength="30" value="" ></td>
		<td width="10%">Outward Date<b><span class="mantatory">*</span></b></td>
...
<table class="outertable linebor" width="100%" border="0" cellspacing="0" cellpadding="3">
	<tr align="center">
		...
		<td class="tabactivenew" width="10%"><b>Outward Reg No</b></td>
		<td class="tabactivenew" width="10%"><b>Outward Date</b></td>
