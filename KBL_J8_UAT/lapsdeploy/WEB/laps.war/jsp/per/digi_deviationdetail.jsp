...
var strSetupClassForOtherDev="<%=Helper.correctNull((String)hshValues.get("strSetupClassForOtherDev"))%>";
var BREcount="<%=Helper.correctNull((String)hshValues.get("BREcount"))%>";
var strloancostloanprd="<%=Helper.correctNull((String)hshValues.get("LOAN_COSTLOANPRD"))%>";
var LOAN_BRE_UPDATE="<%=Helper.correctNull((String)hshValues.get("LOAN_BRE_UPDATE"))%>";
var DIGI_DEVIATION_CALMAXLOAN="<%=Helper.correctNull((String)hshValues.get("DIGI_DEVIATION_CALMAXLOAN"))%>";
var varDelegatedAuthority="<%=Helper.correctNull((String)hshValues.get("DelegatedAuthority"))%>";
var varAlert="<%=Helper.correctNull((String)hshValues.get("alert"))%>";
var varNewDevValue="<%=Helper.correctNull((String)hshValues.get("NewDevValue"))%>";
var varApprovalAccRej="<%=Helper.correctNull((String)hshValues.get("ApprovalAccRej"))%>";
var vardigiApprovedUserid="<%=Helper.correctNull((String)hshValues.get("strdigiApprovedUserid"))%>";
...
function doClose()
{
		...
		window.opener.document.forms[0].action=appURL+"action/perDigiLoandetails.jsp";	
...
function callApprovedUser()
{
	...
	if(parseInt(userclass) >= parseInt(varDeviatedUserClass))
	{
		...
		if(document.forms[0].select_la.disabled==true ||document.forms[0].select_intrate.disabled==true || document.forms[0].select_tenor.disabled==true || 
		  document.forms[0].select_margin.disabled==true ||document.forms[0].select_rage.disabled==true || document.forms[0].select_repayment.disabled==true ||
		  document.forms[0].select_processfee.disabled==true || document.forms[0].select_od.disabled==true )
		{
			document.forms[0].updateApprove.disabled=true;
		}
		else
		{
			if(document.forms[0].appholder.value==strUserId)
			{
				document.forms[0].updateApprove.disabled=false;
			}
		}
	}
	else
...
function disablefields()
{
	...
	else
	{
 	...
 	if( document.forms[0].sel_loanamount.value=="N" && document.forms[0].sel_interestrate.value=="N" && document.forms[0].sel_tenor.value=="N" &&
 		document.forms[0].sel_margin.value=="N" && document.forms[0].sel_retirement.value=="N" &&  document.forms[0].sel_repaycapacity.value=="N" && 
 		document.forms[0].sel_procfee.value=="N" && document.forms[0].sel_otherdev.value=="N" )
	{
		document.forms[0].updateApprove.disabled=true;
	}
	else
...
function doSave()
{
	...
	if(document.forms[0].txt_penall_int.value=="")
	{
	document.forms[0].txt_penall_int.focus();
	ShowAlert('121','Penalty Interest or Zero');
	return;
	}
	
	if(document.forms[0].sel_loanamount.value=="Y")
	{
		if((trim(document.forms[0].txt_loanamountnew.value)=="") || document.forms[0].txt_loanamountnew.value=="0")
			{
	...
	{
		if(trim(document.forms[0].txt_otherDeviationNew.value)=="")
			{
			document.forms[0].txt_otherDeviationNew.focus();
			ShowAlert('121','NMI multiplier New Value');
			return;
			}
	}
	if(document.forms[0].sel_otherdev.value=="Y")
	{
		if(trim(document.forms[0].txt_odrem.value)=="")
			...
			ShowAlert('121','NMI multiplier Remarks');
			return;
			}
	}
	...
	if(document.forms[0].sel_loanamount.value=="Y")
	{
		if(document.forms[0].sel_repaycapacity.value=="N")
			{
			alert("Please Make Devation as yes in Repayment Capacity (%) / FOIR");
			document.forms[0].sel_repaycapacity.focus();
			return;
			}
		if(document.forms[0].sel_otherdev.value=="N")
			{
			alert("Please Make Devation as yes in NMI multiplier");
			document.forms[0].sel_otherdev.focus();
			return;
			}
	}
	...
	document.forms[0].hidBeanMethod.value="updateDigiDeviationData";
	document.forms[0].hidBeanGetMethod.value="getData";
	document.forms[0].hidSourceUrl.value="/action/digi_deviationdetail.jsp";
...
function CallOnload()
{
	if(document.forms[0].appholder.value!=strUserId)
	{
		...
		document.forms[0].updateBRE.disabled=true;
		document.forms[0].updateApprove.disabled=true;
		document.forms[0].updateUndo.disabled=true;
	}
	if(sel_loanamount!=""){
	...
	//bre button
		document.forms[0].updateBRE.disabled=false;
		...
		if(varapplnholder == 'Y')
		{
			if(document.forms[0].btn_la.disabled==false ||document.forms[0].btn_tenor.disabled==false ||document.forms[0].btn_margin.disabled==false ||
				document.forms[0].btn_rage.disabled==false ||document.forms[0].btn_repayment.disabled==false ||	 document.forms[0].btn_processfee.disabled==false || document.forms[0].btn_od.disabled==false)
			{
				document.forms[0].updateUndo.disabled=false;
			}
			else 
			{
				document.forms[0].updateUndo.disabled=true;
		...
		if(varDelegatedAuthority == 'Y')
		{
			document.forms[0].updateBRE.disabled=true;
			//document.forms[0].updateApprove.disabled=false;
			document.forms[0].cmdsave.disabled=true;
			document.forms[0].cmdedit.disabled=true;
			document.forms[0].txt_otherdevremarks.readOnly=false;
			document.forms[0].txt_otherDeviationOld.readOnly=true;
			document.forms[0].txt_otherDeviationNew.readOnly=true;
			document.forms[0].txt_odrem.readOnly=true;
			...
			if(document.forms[0].txt_otherdevremarks.value == "") {
				if(document.forms[0].appholder.value==strUserId)
				{
					...
					{
						document.forms[0].updateApprove.disabled=true;
						if(vardigiApprovedUserid==strUserId)
						{
						document.forms[0].updateUndo.disabled=false;
						}
					}
		...
		else
		{
			...
			if(LOAN_BRE_UPDATE == "Y" && varAlert=="Alert" && DIGI_DEVIATION_CALMAXLOAN != "")
			{ 
					alert(DIGI_DEVIATION_CALMAXLOAN);
				
			}	
		}
		
		if(varApprovalAccRej=="A")
		{
			document.forms[0].updateBRE.disabled=true;
			document.forms[0].cmdedit.disabled=true;
			document.forms[0].updateApprove.disabled=true;
...
function doCancel()
{
	...
	if(varconfirm)
	{
		document.forms[0].hidBeanId.value="perlimitofloan";
		document.forms[0].hidBeanGetMethod.value="getData";
		document.forms[0].action=appURL+"action/digi_deviationdetail.jsp";
		document.forms[0].submit();
	}
}
function hideRows()
...
function updApprove()
{
	if(document.forms[0].sel_loanamount.value=="Y")
	{
		...
		document.forms[0].select_la.value="A";
	}
	if(document.forms[0].sel_interestrate.value=="Y")
	{
		if(trim(document.forms[0].txt_interestratenew.value)=="")
		...
		document.forms[0].select_intrate.value="A";
	}
	if(document.forms[0].sel_tenor.value=="Y")
	{
		if(trim(document.forms[0].txt_tenornew.value)=="")
		...
		document.forms[0].select_tenor.value="A";
	}
	if(document.forms[0].sel_margin.value=="Y")
	{
		if(trim(document.forms[0].txt_marginnew.value)=="")
		...
		document.forms[0].select_margin.value="A";
	}
	if(document.forms[0].sel_retirement.value=="Y")
	{
		if(trim(document.forms[0].txt_retirementnew.value)=="")
		...
		document.forms[0].select_rage.value="A";
	}
	if(document.forms[0].sel_repaycapacity.value=="Y")
	{
		if(trim(document.forms[0].txt_repaynew.value)=="")
		...
		document.forms[0].select_repayment.value="A";
	}
	if(document.forms[0].sel_procfee.value=="Y")
	{
		if(trim(document.forms[0].txt_procfeenew.value)=="")
		...
		document.forms[0].select_processfee.value="A";
	}
	if(document.forms[0].sel_otherdev.value=="Y")
	{
		if(trim(document.forms[0].txt_odrem.value)=="")
		...
		document.forms[0].select_od.value="A";
	}
	...
	if(userclass < strSetupClassForOtherDev)
	{
		...
		if(BREcount<7 || varNewDevValue=="0")
		{
			alert("BRE update not done! ");
			return;
		}
	}
	/*if(document.forms[0].sel_loanamount.value=="Y"){
		if(document.forms[0].txt_loanamountnew.value="0")
	{
		ShowAlert('121','Loan Amount New Value');
	}}
	if(document.forms[0].sel_margin.value=="Y"){
		if(document.forms[0].txt_marginnew.value="0")
	{
		ShowAlert('121','Margin (%)	New Value');
	}}
	if(document.forms[0].sel_otherdev.value=="Y"){
		if(document.forms[0].txt_otherDeviationNew.value="0")
	{
		ShowAlert('121','NMI multiplier New Value');
	}}*/
	document.forms[0].hidAction.value="approve";
...
function updUndo()
{
	...
	if(document.forms[0].select_la.value == "A" || document.forms[0].select_la.value == "R" )
	{
		document.forms[0].hidundoval.value=document.forms[0].hidundoval.value+ " loan";
	}
	if(document.forms[0].select_intrate.value == "A" || document.forms[0].select_intrate.value == "R" )
	{
		document.forms[0].hidundoval.value=document.forms[0].hidundoval.value+ " int";
	}
	if(document.forms[0].select_tenor.value == "A" || document.forms[0].select_tenor.value == "R" )
	{
		document.forms[0].hidundoval.value=document.forms[0].hidundoval.value+ " tenor";
	}
	if(document.forms[0].select_margin.value == "A" || document.forms[0].select_margin.value == "R" )
	{
		document.forms[0].hidundoval.value=document.forms[0].hidundoval.value+ " margin";		
	}
	if(document.forms[0].select_rage.value == "A" || document.forms[0].select_rage.value == "R" )
	{
		document.forms[0].hidundoval.value=document.forms[0].hidundoval.value+ " age";		
	}
	if(document.forms[0].select_repayment.value == "A" || document.forms[0].select_repayment.value == "R" )
	{
		document.forms[0].hidundoval.value=document.forms[0].hidundoval.value+ " repay";		
	}
	if(document.forms[0].select_processfee.value == "A" || document.forms[0].select_processfee.value == "R" )
	{
		document.forms[0].hidundoval.value=document.forms[0].hidundoval.value+ " profee";		
	}
	if(document.forms[0].select_od.value == "A" || document.forms[0].select_od.value == "R" )
	{
		document.forms[0].hidundoval.value=document.forms[0].hidundoval.value+ " other";		
	}
...
function callBreUpdate()
{
	...
	if(strloancostloanprd=="0")
	{
		alert("Cost of the Project is 0.please Enter Cost of the Project in Loan Product Tab before clicking BRE update");
		window.opener.document.forms[0].hidBeanGetMethod.value="getLoanProducts";
		window.opener.document.forms[0].hidBeanId.value="perapplicant";
		window.opener.document.forms[0].action=appURL+"action/perDigiLoandetails.jsp";	
		window.opener.document.forms[0].submit();
...
<div id="progress" style="position:absolute; width:106px; visibility:hidden; height:19px; z-index:9999999; left: 550px; top: 350px" >
...
<table width="60%" border="0" cellspacing="0" align="center" cellpadding="3" class="datagrid">
                	<tr align="center"> 
                		
                		<%if( Helper.correctNull((String)hshValues.get("ApprovalAccRej")).equalsIgnoreCase("A")){%>
                		<td><span style="font-size: 15px;"> BRE Status- <B><span style="color: #7a4d98"> Approved </span> </B>  </span> &nbsp&nbsp
                		<span style="font-size: 15px;"> Approved By- <B><span style="color: #7a4d98"><%=Helper.correctNull((String)hshValues.get("strdigiApprovedUserid"))%></span> </B>  </span>
                	  </td>
                		
                		<%} else if(Helper.correctNull((String)hshValues.get("ApprovalAccRej")).equalsIgnoreCase("R")) {%>
                		<td><span style="font-size: 15px;"> BRE Status- <B><span style="color: #7a4d98"> Rejected </span> </B>  </span> &nbsp&nbsp
            		    <span style="font-size: 15px;"> Rejected By- <B><span style="color: #7a4d98"><%=Helper.correctNull((String)hshValues.get("strdigiApprovedUserid"))%></span> </B>  </span>
            		   </td>
            		    
                	<%} else  {%>
                		<td><span style="font-size: 15px;"> BRE Status- <B><span style="color: #7a4d98">  </span> </B>  </span></td>
                	<%}%>
                	</tr>
                	</table>
        ...
        <table width="100%" border="0" cellspacing="1" cellpadding="3" class="outertable" >
          <tr class="dataheader" > 
            ...
            <td width="30%">Remarks / Comments</td>
          	<td width="10%" align="center" style="visibility: hidden;position: relative;">Approval</td>
             <td width="10%" align="center" style="visibility: hidden;position: relative;">Addition of Interest</td>
            <td width="10%" align="center" style="visibility: hidden;position: relative;">Undo</td> 
          </tr>
          <tr class="datagrid"> 
            ...
            <td width="10%" align="center" style="visibility: hidden;position: relative"> 
          ...
          <tr class="datagrid" id="id_IntRate"> 
            ...
            <td width="10%"> 
              <input type="hidden" name="hidintrate" value="<%=Helper.correctNull((String)hshValues.get("sel_interestrat"))%>"/>
          ...
          <tr class="datagrid" id="id_RepayCap"> 
            ...
            <td nowrap="nowrap" width="20%">Repayment Capacity (%) / FOIR
           ...
           <tr class="datagrid" id="id_ProcessFee"> 
            ...
            <td width="10%"> 
              <input type="text" size='5' name="txt_procfeeold" style="text-align:right" value="<%=Helper.correctNull((String)hshValues.get("LOAN_DIGI_TOT_PROCESSINGFEE"))%>">
            </td>
            <td align="center" width="10%"> 
            ...
            <td width="10%" align="center" style="visibility: hidden;position: relative">
        	 ...
        	 <tr class="datagrid"> 
            <td width="20%">NMI multiplier 
              <input type="hidden" size='10' name="txt_otherdevtype" style="text-align:right" value="OC">
            </td>
             <td width="10%"> 
              <input type="text" size='5' name="txt_otherDeviationOld" style="text-align:right" value="<%=Helper.correctNull((String)hshValues.get("DIGI_NMI_MULTIPLIER"))%>">
            </td>
            ...
            <td align="center" width="10%"> 
             ...
             <td width="10%"> 
              <input type="text" size='12' maxlength="9" name="txt_otherDeviationNew" style="text-align:right" value="<%=Helper.correctNull((String)hshValues.get("txtnmi"))%>" onKeyPress="allowNumber(document.forms[0].txt_otherDeviationNew)">
            </td>    
            <td width="30%"> 
              <textarea name="txt_odrem" cols="46" rows="2"><%=Helper.correctNull((String) hshValues.get("NMI_REMARK"))%></textarea>
            </td>
            <td width="10%" align="center" style="visibility: hidden;position: relative"> 
          ...
          <tr class="datagrid"> 
      			...
      			<td width="10%" colspan="4"><input type="text" name="dev_prop_no" size="12" readOnly="readonly" value="<%=Helper.correctNull((String)hshValues.get("APP_PERM_NO"))%>"> 
          ...
          <tr class="datagrid"> 
			...
			<td id="intrefno2" colspan="4"> <input type="text" name="txt_intrefno" onKeyPress="docheckIntRate();" maxlength="30" size="40" value="<%=Helper.correctNull((String) hshValues.get("txt_intraterefnumber"))%>">&nbsp;</td>
          </tr>
           <tr class="datagrid">
			<TD> Penalty Interest </TD>     
			<td colspan="4"> <input type="text" name="txt_penall_int" onKeyPress="allowNumber(document.forms[0].txt_penall_int)" value="<%=Helper.correctNull((String) hshValues.get("DIGI_DEVIATION_ROI"))%>"> </td>    
           </tr>
        </table>
				</td>
			</tr>
					...
					<td>		
					  ...
					  <table border="0" cellspacing="0" cellpadding="3" align="center"  class="outertable linebor buttonbgcolor">
					    <tr> 
					       ...
					       <td align="center">
					        <input type="button" name="updateApprove" value="Approve" 
					       	 class="buttonStyle" style="width: 150" onClick="updApprove()">
					      </td>
					       <td align="center">
					        <input type="button" name="updateUndo" value="Undo" 
					       	 class="buttonStyle" style="width: 150" onClick="updUndo()">
					      </td>
						</tr>
					 </table>		
				</td>
