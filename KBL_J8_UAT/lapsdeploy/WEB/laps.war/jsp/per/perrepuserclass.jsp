...
function doPrintPreview()
{
	...
	win.document.write("<TD width='20%'><font size='4' face='MS Sans Serif'><B><center>User Details Report</center></B></font></TD>");
		 ...
		 for(l=0;l<textlabel.length;l++)
			{
				...
				win.document.write("<div align='center'><font size='1' face='MS Sans Serif'><B>"+ textlabel[l] + "</B></font>");
...
%>
	...
	<%			
		...
		win.document.write("<td align='left' height = '30' nowrap>");
   ...
   else
	{
	   document.write("<tr><td align='center'>No Data Found</td></tr>");
		...
		%>
				...
				document.write("<b><font size='2' face='MS Sans Serif'>Total Applications = &nbsp;</font></b>");
				document.write("<b><font size='2' face='MS Sans Serif'>"+"<%=totcount%>" + "</font></b>");
				document.write("</td>");
				document.write("</tr>");		
