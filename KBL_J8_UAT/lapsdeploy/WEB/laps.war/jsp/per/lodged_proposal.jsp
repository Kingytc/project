...
<table class="outertable" width="100%"  border="0" cellspacing="0" cellpadding="3" align="center">
	...
	<tr class="dataheader" style="text-align: center">
		<td style="text-align: center;width:100%;">Lodged Proposal</td><td></td>	
	</tr>
</table>	
<table class="outertable" width="100%"  border="0" cellspacing="0" cellpadding="3" align="center">	
	<tr>
	...
	<tr>
		...
		<td>Lodge Ref No</td>
		 <td> <input type="text" name="txt_lodgerefno"  maxlength="30" value="<%=Helper.correctNull((String)hshValues.get("txt_lodgerefno"))%>"></td>
		<td>Lodge Date</td>
		 <td><input type="text" name="txt_lodgedate" size="15"
							maxlength="15" 
							value="<%=Helper.correctNull((String)hshValues.get("txt_lodgedate"))%>"
							onBlur="checkDate(this);">
							 <a href="#"
	...
	<tr>
		<td>Reason for lodging</td>
		 <td> <input type="text" name="txt_reasonforlodging"  maxlength="100" size="50" value="<%=Helper.correctNull((String)hshValues.get("txt_reasonforlodging"))%>"></td>
		<td>Remarks</td>
		 <td> <input type="text" name="txt_remarks"  maxlength="30" value="<%=Helper.correctNull((String)hshValues.get("txt_remarks"))%>"></td>
		<td>Whether to be taken up for Processing now ?</td>
		 <td><select name="sel_processing">
								          <option value="0" selected="selected">&lt;---Select---&gt;</option>
	...
	<tr>
		<td>Unlodge Date</td>
		 <td>
		 <input type="text" name="txt_unlodgedate" size="15"
							maxlength="15" 
							value="<%=Helper.correctNull((String)hshValues.get("txt_unlodgedate"))%>"
							onBlur="checkDate(this);">
							 <a href="#"
							onClick="callCalender1('txt_unlodgedate')"
								onMouseOver="window.status='Date Picker';return true;"
									onMouseOut="window.status='';return true;"
							title="Click to view calender" border=0><img
							src="<%=ApplicationParams.getAppUrl()%>/img/calen.gif"
							border="0"></a></td>
		<td>Whether proposal needs to be dropped now ?</td>		 
		 <td><select name="sel_drop">
								          <option value="0" selected="selected">&lt;---Select---&gt;</option>
								          <option value="Y">Yes</option>
								          <option value="N">No</option>								         
								        </select></td>
