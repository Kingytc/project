...
<script language="javascript" src="<%=ApplicationParams.getAppUrl()%>js/per/perrepapprevexcep.js">
</script>
<script>
<!--
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      <td><font size="4"><b><i><font size="4"><b><i><font size="4"><b><i><font size="4"><b><i><font size="4"><b><font color="#000000" size="2"><i><font size="4"><b><i><font face="Times New Roman" size="3"><b><i>Home 
        ...
        <font face="Times New Roman" size="3"><b><i>Reviewer Exception </i></b></font></td>
    </tr>
    <tr> 
      <td align="right">&nbsp; </td>
    </tr>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="6">
                      ...
                      <tr align="center"> 
                        <td width="50%"><font size="1" face="MS Sans Serif"> 
                          <select name="rpselect1" size="12"  style="width:150" multiple >
                          </select>
                          </font></td>
                        <td width="50%"><font size="1" face="MS Sans Serif"> 
                          <select name="rpselect2" size="12"  style="width:150"  multiple>
                            ...
                            <option value="app_status">Applied Date</option>
                            <option value="prd_totalint">Application Status</option>
                            <option value="loan_modintrate">Work Action</option>
                            <option value="app_status">Passed By</option>
                            <option value="app_status">Passed To</option>
                            <option value="app_prdcode">Time Taken</option>
                          </select>
                          </font></td>
                      </tr>
                    </table>
      ...
      <td> 
        <table border="0" cellspacing="0" cellpadding="2">
          <tr valign="top"> 
            ...
            <td height="0" width="16%"> 
              <div align="center"> 
                <input type="button" name="rphelp" value="Help" style="background-color:#009966;cursor:help;;color:white;font-weight:bold;font-size=10;font-family:mssansserif;width:50" onClick="doHelp('perrep.htm#reviewerexception')">
              </div>
            </td>
...
<input type="hidden" name="repname" value ="Personal Reviewer Exception Report">
<input type="hidden" name="txtprofile_name" >
<input type="hidden" name="hidParam">
<input type="hidden" name="hidPage" value="perrunapprevexcep.jsp">
