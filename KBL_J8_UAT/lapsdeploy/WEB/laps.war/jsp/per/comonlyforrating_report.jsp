...
function runrep()
{
	...
	window.open(path+"action/comonlyforrating_report_print.jsp?hidBeanId=perrepappstatus&hidBeanMethod=getData&hidMethod=getAppOFRReport&sellevel="
				+level
				+"&orgselect="+orgselect
				+"&org_name="+org
			    +"&txtDate="+period
...
<iframe  height="0" width="0" id="ifrm" frameborder=0 style="border:0" ></iframe> 
  ...
  <br>
  <table class="outertable" border="1" cellspacing="0" cellpadding="0" align="center">
    <tr> 
      <td> 
