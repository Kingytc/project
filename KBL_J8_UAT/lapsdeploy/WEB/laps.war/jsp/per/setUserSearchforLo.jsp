...
function callSearch1()
{
	...
	document.forms[0].hidBeanGetMethod.value="getUserSearchDataforLopv";
	document.forms[0].hidBeanId.value="setusers";
	document.forms[0].action=appURL+"action/setUserSearchforLo.jsp?txt_name="+document.forms[0].txt_user_id_name.value+"&selval="+selval;	
...
function displayUser(val1,val2,val3,val4,val5,val6,val7,val8,val9,val10,val11,val12,val13,val14,val15,val16,obj)
{
	if(val16=="Y")
    {
	 ...
	 window.opener.document.forms[0].txtdesignation.value=val15;
	 window.close();
    }
    else
    {
        alert("Verifier designation should be Manager and above");
        return ;
    }
     if(val16=="Y")
     {
	 window.opener.document.forms[0].txt_convertedid[selval].value=val1;
	 window.opener.document.forms[0].txt_convertedname[selval].value=val4+" "+val5+" "+val6;
	 window.opener.document.forms[0].txtdesignation[selval].value=val15;
	 window.close();
     }
     else
     {
