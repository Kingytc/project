...
<html>
<head>
<title>Credit Activity Report</title>
...
<script language="javascript" src="<%=ApplicationParams.getAppUrl()%>js/per/perrepappcredit.js">
</script>
<script>
<!--
...
<iframe  height="0" width="0" id="ifrm" frameborder=0 style="border:0" ></iframe> 
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      <td><font size="4"><b><i><font size="4"><b><i><font size="4"><b><i><font size="4"><b><i><font size="4"><b><font color="#000000" size="2"><i><font size="4"><b><i><font face="Times New Roman" size="3"><b><i>Home 
        ...
        <font face="Times New Roman" size="3"><b><i>Reports</i></b></font> <font size="4"><b><i><font size="4"><b><i><font size="4"><b><i><font size="4"><b><i><font size="4"><b><font color="#000000" size="2"><i><font size="4"><b><i><font face="Times New Roman" size="3"><b><i>-&gt;</i></b></font></i></b></font></i></font></b></font></i></b></font></i></b></font></i></b></font></i></b></font> 
        <font face="Times New Roman" size="3"><b><i></i></b></font><font face="Times New Roman" size="3"><b><i>Credit 
        Activity Report</i></b></font></td>
    </tr>
    <tr> 
      <td align="right">&nbsp; </td>
    </tr>
          ...
          <tr> 
            <td> 
              <table width="100%" border="0" cellspacing="0" cellpadding="5" align="center">
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="4">
                      ...
                      <tr align="center"> 
                        ...
                        <td width="50%"><font size="1" face="MS Sans Serif"> 
                          <select name="rpprod" size="11" style="width:300" tabindex="5" >
                          </select>
                          </font></td>
                ...
                <tr> 
                  <td width="24%" align="left"><font face="MS Sans Serif" size="1">Category</font></td>
                </tr>
                <tr> 
                ...
                <tr> 
                  <td><font face="MS Sans Serif" size="1"> 
                    ...
                    <a href="#" onClick="showPeriod()"><b class="fontstyle" tabindex="7" >?</b></a> 
                    </font></td>
                </tr>
              </table>
            </td>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="2">
          <tr valign="top"> 
            <td height="0" width="16%"> 
              <div align="center"> 
                <input type="button" name="rprunreport" value="Run Report" style="background-color:#8F8369;color:white;font-weight:bold;font-size=10;font-family:mssansserif;width:80" onClick="runrep()" tabindex="8" >
              </div>
            </td>
         <!--     <td height="0" width="16%"> 
              <div align="center"> 
            ...
            <td height="0" width="15%"> 
              <div align="center"> 
                <input type="reset" name="rpreset" value="Reset" style="background-color:#8F8369;color:white;font-weight:bold;font-size=10;font-family:mssansserif;width:50" onClick="JavaScript:resetValues()" tabindex="9" >
              </div>
            </td>
            <td height="0" width="16%"> 
              <div align="center"> 
                <input type="button" name="rphelp" value="Help" style="background-color:#009966;cursor:help;;color:white;font-weight:bold;font-size=10;font-family:mssansserif;width:50" onClick="doHelp('perrep.htm#creditactivity')" tabindex="10" >
              </div>
            </td>
            <td height="0" width="21%"> 
              <div align="center"> 
                <input type="button" name="rpclose" value="Close" class="buttonClose" onClick="JavaScript:closeWindow()" tabindex="11" >
              </div>
            </td>
          </tr>
        </table>
  ...
  <input type="hidden" name="hidBeanId" value="repappcredit" >
...
<input type="hidden" name="repname" value ="Personal Credit Activity Report">
<input type="hidden" name="txtprofile_name" >
<input type="hidden" name="hidParam">
<input type="hidden" name="hidPage" value="perrunappcredit.jsp">
