...
<script language="javascript" src="<%=ApplicationParams.getAppUrl()%>js/per/perrepappexception.js">
</script>
<script>
<!--
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      <td><font size="4"><b><i><font size="4"><b><i><font size="4"><b><i><font size="4"><b><i><font size="4"><b><font color="#000000" size="2"><i><font size="4"><b><i><font face="Times New Roman" size="3"><b><i>Home 
        ...
        <font face="Times New Roman" size="3"><b><i>Application Exception</i></b></font></td>
    </tr>
    <tr> 
      <td align="right">&nbsp; </td>
    </tr>
                ...
                <tr> 
                  <td colspan="2" height="30"><font size="1" face="MS Sans Serif"> 
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="3">
                      <tr> 
                        <td width="25%" align="center"><font size="1" face="MS Sans Serif">Organisation 
                          Level</font><font size="1" face="MS Sans Serif"> </font></td>
                        <td width="26%" align="center"><font size="1" face="MS Sans Serif">Process 
                          Status</font></td>
                      </tr>
                      <tr> 
                      ...
                      <tr align="center"> 
                        ...
                        <td><font size="1" face="MS Sans Serif"> 
                          <select name="rpselect2" size="11"  style="width:150"  multiple>
                            ...
                            <option value="createdate">Applied Date</option>
                            <option value="prd_desc">Product Name</option>
                            <option value="org_name">Organisation</option>
                            <option value="permittedhrs">Permitted Hrs</option>
                            <option value="actualhrs">Actual Hrs</option>
                            <option value="exceededhrs">Exceeded Hrs</option>
                          </select>
                          </font></td>
                      </tr>
                      <tr align="center"> 
...
onClick="doHelp('perrep.htm#applicationexception')">
              </div>
            </td>
  ...
  <input type="hidden" name="hidBeanId" value="repappexception" >
...
<input type="hidden" name="repname" value ="Personal Application Exception Report">
<input type="hidden" name="txtprofile_name" >
<input type="hidden" name="hidParam">
<input type="hidden" name="hidPage" value="perrunappexception.jsp">
