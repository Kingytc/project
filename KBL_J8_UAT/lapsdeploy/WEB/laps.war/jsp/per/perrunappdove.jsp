...
function printpreview()
{
	...
	win.document.write("<TD width='20%'><font size='4' face='MS Sans Serif'><B><center>Document Overdue (DOVE) Report</center></B></font></TD>");
...
<link rel="stylesheet" href="/css/blackfont.css" type="text/css">
</head>
<body bgcolor="#EEEAE3" text="#000000" leftmargin="0" topmargin="0"
	marginwidth="0" marginheight="0">
<br>
<h3>
<center>Document Overdue (DOVE) Report</center>
</h3>
...
<table border="1" cellspacing="0" cellpadding="0"
	...
	<tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="2">
			<tr>
				<td width="45%">
				<div align="center"><input type="button" name="Button232253"
					value="&lt;&lt; Previous"
				...
				<td width="55%">
				<div align="center"><input type="button" name="Button2322532"
					value="Print Preview"
