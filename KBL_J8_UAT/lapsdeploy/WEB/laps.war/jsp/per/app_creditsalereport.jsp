...
function doRunReport()
{
	...
	window.open(path+"action/app_creditsalerunreport.jsp?hidBeanId=perrepappstatus&hidBeanMethod=getData&hidMethod=getCreditSaleReport&sellevel="
				+level
				+"&orgselect="+orgselect
				+"&org_name="+org
			    +"&txtDate="+period
...
function doExcelExport()
{
	...
	if (count > 0)
	{
	    ...
	    window.open(path+"action/"+FileName+".xls?hidBeanId=perrepappstatus&hidBeanMethod=getData&hidMethod=getXLCreditSaleReport&sellevel="+level+"&orgselect="+orgselect+"&org_name="+org+"&txtDate="+period,"BuilderReport",prop);    	
}
</script>
<link rel="stylesheet"
...
<table class="outertable" width="100%" border="0" cellspacing="0"
	cellpadding="0">
	<tr>
		<td class="page_flow">Home  -&gt; Reports -&gt; Credit Sales Report</td>
	</tr>
	<tr>
		<td align="right">&nbsp;</td>
	</tr>
                    ...
                    <table class="outertable" width="100%" border="0" cellspacing="0" cellpadding="4">
                      ...
                      <tr align="center"> 
                        <td align="center" colspan="2"> 
                          <table class="outertable border1 tableBg" width="60%" border="0" cellspacing="0" cellpadding="3" align="center" bordercolorlight="#8F8369" bordercolordark="#FFFFFB">
                            <tr> 
                              <td> 
