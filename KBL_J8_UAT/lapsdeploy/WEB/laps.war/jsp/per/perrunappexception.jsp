...
function printpreview()
{
	...
	win.document.write("<TD width='20%'><font size='4' face='MS Sans Serif'><B><center>Application Exception Report</center></B></font></TD>");
		   ...
		   <%	for(int j=0;j<ht.size();j++)
			    {
					...
					if (j == 14 && dt.equalsIgnoreCase("Decreased"))
					{
						colr ="red";
					}
					else if (j == 14 && dt.equalsIgnoreCase("Increased"))
					{
						colr ="blue";
					}
					else
...
<br>
<h3><center>Application Exception Report</center></h3>
