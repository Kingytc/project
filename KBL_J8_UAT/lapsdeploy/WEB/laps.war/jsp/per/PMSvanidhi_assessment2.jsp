...
if(strPageName.equalsIgnoreCase("KSAE"))
	...
	strPageid="43";
else if(strPageName.equalsIgnoreCase("PMS2"))
	strPageid="44";
...
function callonLoad()
{
	...
	if(appstatus=="Open/Pending")
	{
		...
		if(varEligibilty="N"){
			alert('Please define Eligibility in Product -> Svanidhi Eligibilty');
			enableButtons(true,true,true,true,false);
			return;
		}
...
function doDelete()
{
	alert('Assessment for PM Svanidhi 2 is Required,You cannot delete the assessment');
	return;
}
...
function doCancel()
{
	...
	if(varconfirm)
	{
		...
		document.forms[0].action=appURL+"action/PMSvanidhi_assessment2.jsp";
		document.forms[0].submit();
	}
}
...
function doSave()
{
	...
	document.forms[0].hidSourceUrl.value="/action/PMSvanidhi_assessment2.jsp";
	document.forms[0].submit();
}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="outertable">
	...
	<tr>
		...
		%>
		<td class="page_flow"> Home -&gt; Agriculture &amp; SME -&gt; Proposal -&gt; Assessment -&gt;Assessment for PM Svanidhi 2.0</td>
			<% } else {%>
		<td class="page_flow"> Home -&gt; Corporate &amp; SME -&gt; Proposal -&gt; Assessment -&gt; Assessment for PM Svanidhi 2.0	</td>
		<% 	}%>
		</tr>
</table>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0"
	...
	<tr>
		...
		-&gt; Appraisal -&gt;Assessment for PM Svanidhi 2.0</td>
	</tr>
</table>
...
%>
				...
				<tr class="datagrid">
					...
					<td nowrap="nowrap">Svanidhi 1.0 Account number</td>
				...
				<tr class="datagrid">
					...
					<td nowrap="nowrap">Svanidhi 1.0 Account Open Date</td>
					<td nowrap="nowrap"><input type="text"
				...
				<tr class="datagrid">
					...
					<td nowrap="nowrap">Svanidhi 1.0 Account Close Date</td>
					<td nowrap="nowrap"><input type="text"
                 ...
                 <tr class="datagrid">
					...
					<td nowrap="nowrap">Svanidhi 1.0 Loan amount sanctioned</td>
					<td nowrap="nowrap"><input type="text"
                 ...
                 <tr class="datagrid">
					...
					<td nowrap="nowrap">Limit Requested by Borrower under Svanidhi 2.0 </td>
					<td nowrap="nowrap"><input type="text"
