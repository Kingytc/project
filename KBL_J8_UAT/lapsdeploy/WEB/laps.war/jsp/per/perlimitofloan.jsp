...
var varCGTMSEcovLimit="<%=Helper.correctNull((String)hshValues.get("strCGTMSEtotintrate"))%>";
...
function doSave()
{
	...
	if( varPRD_CGTMSE=="Y" )
	{
	     ...
	     {
	    	 var varsancintrate=parseFloat(document.forms[0].txt_interestratenew.value);
		    if(varsancintrate>varparamval_CGTMSEint)
		    {
		    	alert("Total CGTMSE Interest rate should not exceed "+varparamval_CGTMSEint+"%");
				return;
		    }
		...
		for(var i=0;i<document.forms[0].sel_reason.options.length;i++)
		{
		 ...
		 var str_reasonfor1 ="";
			for(var i=0;i<document.forms[0].sel_reason_con.options.length;i++)
			{
				...
				{				
					str_reasonfor1=str_reasonfor1+document.forms[0].sel_reason_con.options[i].value+"@";
				}		
			}
			 var str_reasonfor2 ="";
				for(var i=0;i<document.forms[0].sel_reason_cir.options.length;i++)
				{
					...
					{				
						str_reasonfor2=str_reasonfor2+document.forms[0].sel_reason_cir.options[i].value+"@";
					}		
				}
	document.forms[0].hidsel_reasonfor.value=str_reasonfor;
	document.forms[0].hidsel_reasonforcon.value=str_reasonfor1;
	document.forms[0].hidsel_reasonforcir.value=str_reasonfor2;

	if(document.forms[0].txt_dev_penality.value!="0.00" && document.forms[0].txt_dev_penality.value!=""&& document.forms[0].txt_dev_penality.value!="0" )
	   {
    if(document.forms[0].hidsel_reasonfor.value==""){
	   ...
	   {
    if(document.forms[0].hidsel_reasonforcon.value==""){
	   ...
	   {
    if(document.forms[0].hidsel_reasonforcir.value==""){
	...
	document.forms[0].hidSourceUrl.value="/action/perlimitofloan.jsp";
...
function CallOnload()
{
	...
	var selreason1 = document.forms[0].hidsel_reasonforcon.value.split("@");
	for(var j=0;j<selreason1.length;j++)
	{
		for(var i=0;i<document.forms[0].sel_reason_con.options.length;i++)
		{
			if(document.forms[0].sel_reason_con.options[i].value==selreason1[j])
			{			
	...
	var selreason2 = document.forms[0].hidsel_reasonforcir.value.split("@");
	for(var j=0;j<selreason2.length;j++)
	{
		for(var i=0;i<document.forms[0].sel_reason_cir.options.length;i++)
		{
			if(document.forms[0].sel_reason_cir.options[i].value==selreason2[j])
			{			
...
function doCancel()
{
	document.forms[0].hidBeanId.value="perlimitofloan";
	document.forms[0].hidBeanGetMethod.value="getData";
	document.forms[0].action=appURL+"action/perlimitofloan.jsp";
	document.forms[0].submit();
}
function hideRows()
{
...
function dochecksanrate(){

	/*if(document.forms[0].txt_app_roi.value==""){
		document.forms[0].txt_app_roi.value="0.00";
	}*/
	...
	var varapplicabl_roi=parseFloat(document.forms[0].txt_interestrateold.value);
	...
	if(roundVal(varsancintrate)!=roundVal(vartot_applicable_roi)){
...
function docheckintrateval(){
	if(document.forms[0].sel_interestrate.value=="Y")
    {
		//document.all.id_roi1.style.visibility="visible";
	    //document.all.id_roi1.style.position="relative";
	...
	{
		//document.all.id_roi1.style.visibility="hidden";
	   // document.all.id_roi1.style.position="absolute";
...
<body onload="callLoad();CallOnload();docheckIntRate();docheckintrateval();">
...
<lapschoice:application />
        ...
        <table width="100%" border="0" cellspacing="1" cellpadding="3" class="outertable">
          ...
          <tr class="datagrid" id="id_IntRate"> 
            ...
            <td align="center" width="10%"> 
              <select name="sel_interestrate" onClick="disablefields()" onChange="docheckIntRate();docheckintrateval();">
                <option value="N" selected="selected">No</option>
                <option value="Y">Yes</option>
              </select>
            </td>
          ...
          <tr class="datagrid"> 
            ...
            <td colspan="7"> 
              <textarea name="txt_otherdevremarks" cols="90" rows="4"><%=Helper.correctNull((String) hshValues.get("txt_otherdevremarks"))%></textarea>
							...
							<tr class="datagrid" id="id_roi2">
							<td width="20%" nowrap="nowrap" >Deviation/Penalty&nbsp;<span class="mantatory">(+)</span></td>
								<td  nowrap="nowrap" colspan="2"><input type="text"
									name="txt_dev_penality" style="text-align: right"
									onKeyPress="allowNumber(this)" onBlur="roundtxt(this);checkPercentage(this);" 
									size="8" maxlength="5" value="<%=Helper.correctNull((String) hshValues.get("DEVIATION_PENALITY"))%>"> </td>
									
								<td width="20%" nowrap="nowrap">Reason for Deviation/Penalty</td>
								<td nowrap="nowrap" colspan="6"><select  multiple="multiple" name="sel_reason">
							   <lapstab:reasonformodification attrval="ret"  apptype="D"/>
								</select></td>
									
							</tr>
							<tr id="id_roi3" class="datagrid">
								<td width="40%" nowrap="nowrap" >Concession&nbsp;<span class="mantatory">(-)</span></td>
								<td  nowrap="nowrap" colspan="2"><input type="text"
									name="txt_concession" style="text-align: right"
									onKeyPress="allowNumber(this)" onBlur="roundtxt(this);checkPercentage(this);"
									size="8" maxlength="5" value="<%=Helper.correctNull((String) hshValues.get("DEVIATION_CONCESSION"))%>"> </td>
									<td width="20%" nowrap="nowrap">Reason for Concession</td>
								<td nowrap="nowrap" colspan="6"><select  multiple="multiple" name="sel_reason_con">
							   <lapstab:reasonformodification attrval="ret" apptype="C"/>
								</select></td>
							</tr>
							<tr  class="datagrid" id="id_roi4">
							<td width="40%" nowrap="nowrap" >As per Circular&nbsp;<span class="mantatory">(+/-)</span></td>
							<td colspan="2"><laps:CurrencyTag  name="txt_asper_circular"
					           value='<%=Helper.correctNull((String) hshValues.get("DEVIATION_AS_PER_CIRCULAR"))%>' size="8" maxlength="5" onBlur="roundtxt(this);checkPercentage(this);" /></td>
					           <td width="20%" nowrap="nowrap">Reason for modification of Interest as per circular</td>
								<td nowrap="nowrap" colspan="6"><select  multiple="multiple" name="sel_reason_cir">
							   <lapstab:reasonformodification attrval="ret" apptype="A"/>
								</select></td>
							</tr>
          <tr class="datagrid"> 
          ...
          <tr class="datagrid"> 
            ...
            <td><input type="hidden" size='10' name="txt_intraterefnotype" style="text-align:right" value="IRRN">
...
<input type="hidden" name="hidsel_reasonfor" value="<%=Helper.correctNull((String)hshValues.get("DEVIATION_MOD_REASON"))%>" >
<input type="hidden" name="hidsel_reasonforcon" value="<%=Helper.correctNull((String)hshValues.get("DEVIATION_MOD_INTRATE_CON"))%>" >
<input type="hidden" name="hidsel_reasonforcir" value="<%=Helper.correctNull((String)hshValues.get("DEVIATION_MOD_INTRATE_CIR"))%>" >
