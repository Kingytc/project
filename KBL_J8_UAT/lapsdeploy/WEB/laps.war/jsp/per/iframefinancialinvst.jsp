...
{ 
		...
		{
			%>
			vararrReceiptno["<%=i%>"] = "<%=Helper.correctNull((String)arrAppno1.get(i))%>";
			<%
   	  	}
}
...
if(vararrReceiptno!="")
{
alert("The Receipt no is already made Collateral "+vararrReceiptno);
}
