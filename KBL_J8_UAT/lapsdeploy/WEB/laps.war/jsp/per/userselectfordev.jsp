...
function callSearch1()
{
	...
	document.forms[0].action=appURL+"action/userselectfordev.jsp?txt_name="+document.forms[0].txt_user_id_name.value;	
...
<form name="appform" method="post" class="normal">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
      ...
      <td class="page_flow">Home -&gt; User-&gt; Search Deviation
