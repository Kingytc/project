...
function printpreview()
{
	...
	win.document.write("<TD width='20%'><font size='4' face='MS Sans Serif'><B><center> Efficiency Report</center></B></font></TD>");
...
function printData()
{
	...
	{
	   document.write("<tr><td align='center'><font size=3 face=MS Sans Serif><b>No Data Found</b></font></td></tr>");
	}	
         <%
		  ...
		  %>
		   ...
		   <%	for(int j=0;j<ht.size();j++)
			...
			%>		
					document.write("<td height = '30' align='<%=align%>' color='<%=colr%>'> ");
					document.write("<div align='<%=align%>'  ><font size='1' face='MS Sans Serif' color='<%=colr%>'>"+"<%=dt%>" + "</font></div>");
					document.write("</td>");
...
<br>
<h3><center>Efficiency Report</center></h3>

<form name= "orgfrm" method="post">

<div class="cellContainer">
  
    <table width="800" border="1" cellspacing="0" cellpadding="0" bordercolorlight="#8F8369" bordercolordark="#FFFFFB"  align="center">
      <tr> 
        <td height="3"> 
