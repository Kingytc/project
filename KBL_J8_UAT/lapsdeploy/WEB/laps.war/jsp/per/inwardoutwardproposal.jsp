...
{	
	...
	function doCancel()
	{
		...
		if(ConfirmMsg('102'))
		{
			document.forms[0].action=appURL+"action/inwardoutwardproposal.jsp";
			document.forms[0].hidBeanId.value = "lapsReport";
			document.forms[0].hidBeanGetMethod.value = "getinwardoutwardproposaldetails";
...
{		
		...
		var varQryString = appURL+"action/searchinwradno.jsp?hidBeanId=lapsReport&hidBeanGetMethod=getinwarddetails&Category=Prposal";
...
function doSave()  
{
	...
	document.forms[0].hidBeanId.value="lapsReport";	
	document.forms[0].hidBeanMethod.value="updateinwardoutwardproposaldetails";
	document.forms[0].hidBeanGetMethod.value="getinwardoutwardproposaldetails";
	document.forms[0].hidSourceUrl.value="/action/inwardoutwardproposal.jsp";
...
<table class="outertable" width="100%"  border="0" cellspacing="0" cellpadding="3" align="center">
	...
	<tr class="dataheader" style="text-align: center">
		<td style="text-align: center;width:100%;">Proposal</td><td></td>	
	</tr>
</table>	
<table class="outertable" width="100%"  border="0" cellspacing="0" cellpadding="3" align="center">	
	<tr>
