...
{	
	...
	parent.frames.document.forms[0].sel_eligibility.length ="<%=arrRow.size()+1%>";
...
<%
	 ...
	 {			
			...
			%>		
		    parent.frames.document.forms[0].sel_eligibility.options[<%=i+1%>].text="<%=strClassificationDesc%>";
			parent.frames.document.forms[0].sel_eligibility.options[<%=i+1%>].value="<%=strCode%>";
...
%>
	if(varType!="")
	{
		parent.frames.document.forms[0].sel_eligibility.value=varType;
	}
