...
function getValues()
{
	if (document.forms[0].sellevel.selectedIndex != 0 && document.forms[0].rpselect1.selectedIndex != -1)
	{
	 ...
	 document.all.ifrm2.src=path+"action/iframeprintrep.jsp?hidBeanMethod=getData&hidMethod=getSearchData&hidBeanId=perrepprint&orgcode="+bnkname+"&field="+field+"&txtSearch="+val
		;
	}
...
function closeWindow()
{
	...
	document.forms[0].action="<%=ApplicationParams.getAppUrl()%>action/apprepnav.jsp";
...
{
	document.forms[0].sellevel.selectedIndex=0;
	document.forms[0].rpselect1.length=0;
	document.forms[0].searchby[0].checked = true;
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr> 
        <td><font size="4"><b><i><font size="4"><b><i><font size="4"><b><i><font size="4"><b><i><font size="4"><b><font color="#000000" size="2"><i><font size="4"><b><i><font face="Times New Roman" size="3"><b><i>Home 
          ...
          <font face="Times New Roman" size="3"><b><i>Print Application </i></b></font></td>
      </tr>
      <tr> 
        <td align="right">&nbsp; </td>
      </tr>
                                  ...
                                  <table width="100%" border="0" cellspacing="0" cellpadding="5">
                                    <tr> 
                                      <td width="17%" height="28"><font size="1" face="MS Sans Serif">Organisation
                                        Level</font></td>
                                      <td width="27%" height="28"><font size="1" face="MS Sans Serif">Entities 
                                        </font></td>
                                    </tr>
                                    <tr> 
                                      ...
                                      <td width="27%"><font size="1" face="MS Sans Serif"> 
                                        <select name="rpselect1" size="5" style="width:150" >
                                        </select>
                                        </font></td>
                                    </tr>
                                  </table>
                            ...
                            <table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolorlight="#8F8369" bordercolordark="#FFFFFB">
                              <tr> 
                                <td> 
                                  <table width="100%" border="0" cellspacing="0" cellpadding="5">
                                    <tr> 
                                      <td colspan="2"><font size="1" face="MS Sans Serif">Search 
                                        by </font></td>
                                      <td width="2%"><font size="1" face="MS Sans Serif"></font></td>
                                      <td width="13%"><font size="1" face="MS Sans Serif"></font></td>
                                      <td width="4%"><font size="1" face="MS Sans Serif"></font></td>
                                      <td width="11%"><font size="1" face="MS Sans Serif"></font></td>
                                    ...
                                    <tr> 
                                      <td width="4%"> <font size="1" face="MS Sans Serif"> 
                                        <input type="radio" name="searchby" value="app_no" checked style="border-style:none">
                                        </font></td>
                                      <td width="15%"><font size="1" face="MS Sans Serif">Application 
                                        Number</font></td>
                                      <td width="2%"> <font size="1" face="MS Sans Serif"> 
                                        <input type="radio" name="searchby" value="perapp_lname" style="border-style:none">
                                        </font></td>
                                      <td width="13%" id="defaultname"><font size="1" face="MS Sans Serif">Last 
                                        Name</font></td>
                                      <td width="4%"> <font size="1" face="MS Sans Serif"> 
                                        <input type="radio" name="searchby" value="perapp_panno" style="border-style:none">
                                        </font></td>
                                      <td width="11%" id="defaultid"><font size="1" face="MS Sans Serif">PAN
                                        No </font></td>
                                      <td width="5%">&nbsp;</td>
                                      <td width="12%"> <font size="1" face="MS Sans Serif"> 
                                        <input type="text" name="txtSearch" maxlength="50" size="12" >
                                        </font></td>
                                      <td> 
									  ...
									  <td> 
                                        <input type="button" name="reset" value="Reset" style="background-color:#8F8369;color:white;font-size=10;font-family:mssansserif;width:65;font-weight:bold" onClick ="resetValues()">
                                      </td>
                                    </tr>
                                  </table>
                                </td>
                        ...
                        <tr> 
                          <td> 
                            <table width="100%" border="0" cellspacing="0" cellpadding="3" bordercolorlight="#8F8369" bordercolordark="#FFFFFB">
                              <tr> 
                                <td width="13%" height="20"><font size="1" face="MS Sans Serif"><b>Search 
                                  Results</b></font></td>
                              ...
                              <tr bgcolor="#71694F"> 
                                <td width="13%" height="20" bgcolor="#71694F"> 
                                  <div align="left"><font  color="#FFFFFF"><b>Application 
                                    No.</b></font></div>
                                </td>
                                <td width="18%" height="20"> 
                                  <div align="left"><font  color="#FFFFFF"><b>Applicant 
                                    Name</b></font></div>
                                </td>
                                <td width="12%" height="20"> 
                                  <div align="left"><font  color="#FFFFFF"><b>Pan 
                                    No. </b></font></div>
                                </td>
                                ...
                                <td width="12%" height="20"> 
                                  <div align="left"><font  color="#FFFFFF"><b>Date 
                                    Applied</b></font></div>
                                </td>
                                <td width="19%" height="20" bgcolor="#71694F" align="center"> 
                                  <font  color="#FFFFFF"><b>Application 
                                  is</b></font></td>
                              </tr>
                            </table>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="2">
          <tr valign="middle"> 
            <td valign="top" width="51%"> 
              <div align="center"> 
                <input type="button" name="cmdhelp" value="Help" style="background-color:#009966;cursor:help;;color:white;font-size=10;font-family:mssansserif;width:50;font-weight:bold" onClick="doHelp('perrep.htm#printapplication')">
              </div>
            </td>
