...
<%
String strfaclitiy = Helper.correctNull((String)hshValues.get("com_sno"));
%>
<html>
<head>
<title>Comments On Interest Rate</title>
...
function doDelete()
{
	if(ConfirmMsg(101))
	{
		...
		document.forms[0].hidPage.value="commentsonintrestrate";
		document.forms[0].hidBeanMethod.value="updateCommentsonInterestRate";
		document.forms[0].hidBeanGetMethod.value="getCommentsonInterestRate";
		document.forms[0].hidSourceUrl.value="action/com_commentsonintrestrate.jsp";	
		document.forms[0].method="post";
...
function getvalues()
{
	...
	document.forms[0].hidBeanGetMethod.value="getCommentsonInterestRate";
	document.forms[0].hidPage.value="commentsonintrestrate";
	document.forms[0].action=appURL+"action/com_commentsonintrestrate.jsp";
	document.forms[0].submit();
}
...
function onLoading()
{
	 ...
	 document.forms[0].sel_facility.value = varfacilty;
}
function doEdit()
{
	disableFields(false);
...
%>
<td class="page_flow">Home -&gt; Agriculture -&gt;Application -&gt; Applicant -&gt; Comments On Interest Rate</td>
<%}else{ %>
<td class="page_flow">Home -&gt; Corporate &amp; SME -&gt;Application -&gt; Applicant -&gt; Comments On Interest Rate</td>
<%}%>
</tr>
</table>
<span style="display:none;"><lapschoice:borrowertype /></span><lapschoice:application />
<lapstab:ComfacilityTab tabid="7"/>
<%} %>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="outertable">
                      <tr> 
                        <td valign="top"> 
                          ...
                          <tr><td align="center" valign="top">Select Facility&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                          <select name="sel_facility" onchange="getvalues();">
									<option value="s" selected>--Select--</option>
										<lapschoice:CommentsonInterestRate appno='<%=Helper.correctNull((String)hshValues.get("appno"))%>' />
									</select>
                          </td></tr>
                            <tr> 
                             <td>
