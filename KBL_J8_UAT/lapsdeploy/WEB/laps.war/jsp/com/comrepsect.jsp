...
<html>
<head>
<title>Sectorwise Analysis Of NPA's</title>
...
<script language="javascript" src="<%=ApplicationParams.getAppUrl()%>js/com/comrepsect.js">
</script>
<script>
<!--
...
<form name="orgfrm" method="post">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      <td><font face="Times New Roman" size="3"><b><i>Sectorwise 
        Analysis of&nbsp; NPA's</i></b></font></td>
    </tr>
    <tr> 
      <td align="right">&nbsp; </td>
    </tr>
  ...
  <table width="100%" border="1" cellspacing="0" cellpadding="20" height="400" bordercolorlight="#8F8369" bordercolordark="#FFFFFB">
    <tr> 
      <td valign="middle"> 
        <table border="1" cellspacing="0" cellpadding="3" align="center" bordercolorlight="#FFFFFB" bordercolordark="#DEDACF" width="40%">
          <tr> 
            <td> 
                ...
                <tr> 
                  <td width="75%" valign="top"><font size="1" face="MS Sans Serif"></font><font size="1" face="MS Sans Serif"></font><font size="1" face="MS Sans Serif"></font><font size="1" face="MS Sans Serif"></font><font size="1" face="MS Sans Serif"> 
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="3">
                      <tr> 
                        <td align="center" width="50%"><font face="MS Sans Serif" size="1">&nbsp;</font></td>
                      </tr>
                      <tr> 
                        <td align="center" width="50%"><font face="MS Sans Serif" size="1"> 
                          <input type="hidden" name="txtDate" maxlength="21" size="25" >
                          </font></td>
                      </tr>
                      <tr> 
                        <td align="center" width="50%"><font face="MS Sans Serif" size="1"> 
                      ...
                      <tr> 
                        <td align="center" width="50%"><font size="1" face="MS Sans Serif"> 
                          <select name="rpselect2" size="11" style="width:180" multiple>
                            ...
                            Date</option> -->
							<option value="org_name" selected>Region</option>
                            <option value="npa_no" selected>No. of Accounts</option>
                            <option value="npa_principal" selected>Principal Outstanding</option>
                            <option value="npa_interest" selected>Interest Outstanding</option>
                            <!-- <option value="convert(varchar(10),app_createdate,103) as appdate" selected>Applied 
                            Date</option>
                            <option value="convert(varchar(10),app_processdate,103) as appdate" selected>Approved/Rejected 
                            Date</option> -->
                          </select>
                          </font></td>
                      </tr>
                      <tr> 
                        <td align="center" width="50%" style="visibility:hidden"><font size="1" face="MS Sans Serif"> 
                          <select name="rpselect1" size="0" style="width:150" multiple>
                          </select>
                          </font></td></tr>
                      <tr>
                        <td align="center" width="50%" style="visibility:hidden"><font size="1" face="MS Sans Serif"> 
  ...
  <input type="hidden" name="hidBeanId" value="comrepsect">
  <input type="hidden" name="hidOrgCode"  >
  <input type="hidden" name="hidOpFields"  >
  <input type="hidden" name="hidSelFields"  >
  <input type="hidden" name="repname" value ="Sectorwise Analysis">
