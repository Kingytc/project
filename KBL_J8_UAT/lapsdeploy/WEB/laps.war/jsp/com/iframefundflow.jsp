...
function showPage(appno)
{
	...
	window.open(path+"action/comrunfundflow.jsp?hidBeanId=comrepfundflow&hidBeanMethod=getData&hidMethod=getRowsCols&hidAppno="+appno,"Fund","scrollbars=Yes,toolbar=no,menubar=yes,width=750,height=550,top=10,left=10");
}
</script>
...
%>
    <tr bgcolor="#FFFFFF" > 
      ...
      <td width="13%" align="center"> <font size="1" face="MS Sans Serif" color="darkblue"> 
