...
function doNew()
{
	...
	document.forms[0].action = appURL + "action/com_addkpowerdetails.jsp?hidBeanGetMethod=getKpowerdetailsData&hidBeanId=comsolvency&customername="+varCustomerName+"&appid="+varAppid;
...
function callTokpowLink(appno,status,holder,appid)
{
...
<table width="100%" border="0" cellspacing="0" cellpadding="0"
	class="outertable">
	<tr>
		<td class="page_flow" colspan="4">Home -> K-Power -> Proposal</td>
	</tr>
</table>
						...
						<table width="80%" border="0" cellspacing="0" cellpadding="0"
							...
							<tr valign="top">
								...
								<table width="100%" border="0" cellspacing="1" cellpadding="1" align="center"
									...
									<tr class="datagrid" align="center">
								 	<td align="center">
		                           <a href="javascript:callTokpowLink('<%=Helper.correctNull((String) arrCol.get(0))%>',
