...
<script type="text/javascript">
	...
	function doNew()
	{
        ...
        <%if(Helper.correctNull((String)hshValues.get("com_wc_bnkarg")).equalsIgnoreCase("C")){ %>
	...
	function doCancel()
	{
		if(ConfirmMsg(102))
		{
			...
			document.forms[0].hidBeanGetMethod.value="getBAConsData";
			document.forms[0].action=appURL+"action/com_BAConsortium.jsp";
	...
	function doDelete()
	{
		if(ConfirmMsg(101))
		{
			...
			document.forms[0].hidBeanMethod.value="updateBAConsData";
			document.forms[0].hidBeanId.value="bankappfi";
			document.forms[0].hidBeanGetMethod.value="getBAConsData";
			document.forms[0].action=appURL+"action/ControllerServlet";	
			document.forms[0].hidSourceUrl.value="/action/com_BAConsortium.jsp";			
			document.forms[0].method="post";			
			document.forms[0].submit();	
		}	
	}
	...
	function onloading()
	{
	  ...
	  function selectValues(val1,val2,val3,val4,val5,val6,val7,val8,val9,val10,val11,val12,val13,val14,val15)
	  {
		...
		document.forms[0].sel_Asset_Classfication.value= val11;
		document.forms[0].txt_perbranch.value		= val14;
		document.forms[0].txt_email.value		= val13;
		document.forms[0].hid_LeadBankcode_new.value		= val14;
		document.forms[0].txt_ECSifsccode.value		= val15;
		if(val5=="S")
		{
			document.all.id_MainLimit1.style.visibility	= "visible";
			document.all.id_MainLimit1.style.position	= "relative";
	  ...
	  {
		//if(document.forms[0].hidGetFLAG.value!="Yes")
		{
	  ...
	  function callperType(varValue) {
			...
			document.all.sublimitTL.src = appURL
					+ "action/iframe_tlsublimit.jsp?hidBeanGetMethod=getLimitOfData&hidBeanId=bankapp&consortiumtype="+ varConsortiumType+"&bankcode="+varbankcode+"&appno="+strappno;
		}
	  }
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="outertable">
          ...
          <a href="#" onclick="javascript:gotoTab(appURL,'bankapp','getBankingdetailsData','com_bankingdetails.jsp')">Asset Classification / Comments on Arrears</a></b></td>
			            <td  width="15%" nowrap="nowrap" align="center" class="sub_tab_inactive"><b><a href="#" onclick="javascript:gotoTab(appURL,'bankapp','getBankingArrangement','comBankingArrgnmentNew.jsp')">Banking Arrangement</a></b></td>
		  ...
		  <%if(strBATypeTL.equalsIgnoreCase("C")){ %>
			...
			<td  width="15%" nowrap="nowrap" align="center" class="sub_tab_active"><b>Consortium Details for WC</b></td>
			<%}} %>
			
			<%if((!strBATypeWC.equalsIgnoreCase("")||!strConsTypeWC.equalsIgnoreCase(""))&&!strBATypeWC.equalsIgnoreCase("S")){%>
			<%if(strBATypeWC.equalsIgnoreCase("M")){ %>
			<td  width="15%" nowrap="nowrap" align="center" class="sub_tab_active"><b>Multiple Banking Details for WC</b></td>
			<%} }%>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="2" class="outertable">
			<tr>
				...
				<table width="75%" border="0" cellspacing="1" cellpadding="3" class="outertable">
					...
					<%} %>
					<td align="center" width="25%">Name of the consortium leader<span class="mantatory">*</span></td>
					<%if(Helper.correctNull((String)hshValues.get("com_wc_type")).equalsIgnoreCase("M")){ %>
					...
					value="<%=Helper.correctNull((String)hshValues.get("com_cons_bank_name"))%>">
					<input type="hidden" name="hid_LeadBankcodeCons" value="<%=Helper.correctNull((String)hshValues.get("com_cons_bank_code"))%>">
					...
					<%if(Helper.correctNull((String)hshValues.get("com_wc_type")).equalsIgnoreCase("M")){ %>
					<td align="center"><input type="text" name="txt_consDesc" value="<%=Helper.correctNull((String)hshValues.get("com_cons_desc"))%>" 
					...
					value="<%=Helper.correctNull((String)hshValues.get("com_cons_asondate"))%>">&nbsp;&nbsp;
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="3" class="outertable">
							<tr>
								...
								<table width="100%" border="0" cellspacing="1" cellpadding="5" class="outertable">
									<tr align="center" class="dataheader">
										...
										<td align="center" width="10%">Asset Classification</td>"
									...
									<tr align="center" class="datagrid">
										...
										<td align="center">
										<select name="sel_Asset_Classfication" tabindex="1">
						                 <option value="" selected="selected">&lt;----Select----&gt;</option>                      
							...
							<tr>
								...
								<tr align="center" class="dataheader">
										...
										<td align="center" width="10%">Nature of facility</td>
										<td align="center" width="8%">Main limit/ sub limit</td>
										<td align="center" width="8%">Limit</td>
										<td align="center" width="8%">Outstanding</td>
										<td align="center" width="5%">Interest rate</td>
										<td align="center" width="10%">Asset Classification</td>
										<td align="center" width="10%">Branch Name</td>
										<td align="center" width="15%">Email ID</td>
								...
								<%
									for(int i=0;i<arrRow.size();i++)
									{
										...
										if(Helper.correctNull((String)arrCol.get(3)).equalsIgnoreCase("M"))
										{
											strFacType	= "Main Limit";
										}
										else if(Helper.correctNull((String)arrCol.get(3)).equalsIgnoreCase("S"))
										{
									...
									<tr class="datagrid">
										...
										<td><%=strFacType%></td>
										<td align="right"><%=jtn.format(Double.parseDouble(Helper.correctDouble((String)arrCol.get(5))))%></td>
										<td align="right"><%=jtn.format(Double.parseDouble(Helper.correctDouble((String)arrCol.get(6))))%></td>
										<td align="right"><%=jtn.format(Double.parseDouble(Helper.correctDouble((String)arrCol.get(7))))%></td>
