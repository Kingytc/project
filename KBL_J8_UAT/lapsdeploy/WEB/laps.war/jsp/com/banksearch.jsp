...
function doNew()
{
	...
	document.forms[0].action = appURL + "action/com_bankers.jsp?hidBeanGetMethod=getBankersData&hidBeanId=comsolvency&customername="+varCustomerName+"&appid="+varAppid;
	document.forms[0].hidoldId.value=varoldAppid;
	document.forms[0].hidApplno.value="";
	document.forms[0].hidapplno.value="";
...
function callToSolvencyLink(appno,status,holder,appid,appname)
{
	...
	document.forms[0].hidappstatus.value=status;
	document.forms[0].hidapplholder.value=holder;
	document.forms[0].hidapplname.value=appname;	
	alert("document.forms[0].hidappstatus.value===="+document.forms[0].hidappstatus.value);	
...
<table width="100%" border="0" cellspacing="0" cellpadding="0"
	...
	<tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
			class="outertable">
			<tr>
			<td class="page_flow" colspan="4">Home -> Banker's -> Proposal
				</td>
			</tr>
		</table>
		</td>
						...
						<table width="80%" border="0" cellspacing="0" cellpadding="0"
							...
							<tr valign="top">
								...
								<table width="100%" border="0" cellspacing="1" cellpadding="1" align="center"
		                           ...
		                           '<%=Helper.correctNull((String) arrCol.get(2))%>','<%=Helper.correctNull((String) arrCol.get(3))%>','<%=Helper.correctNull((String) arrCol.get(4))%>') "><%=Helper.correctNull((String) arrCol.get(0))%> </a>
                                 </td>
