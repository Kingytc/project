...
var comapp_name=document.forms[0].comapp_name.value;
	...
	var url = appUrl+"action/qisanalysisprn.jsp?hidBeanId=qis&hidBeanGetMethod=getQisAna&comapp_id="+comapp_id+"&qistype="+qistype+"&quarter="+quarter+"&year="+year+"&comapp_name="+comapp_name;	
	//alert(url);
...
function dohlp()     
{
  var hlpvar = appUrl+"phlp/corp_postdis_qisanal.htm";
  var title = "QISAnalysis";
...
%>
        ...
        </table>  <font face="MS Sans Serif" size="1"><b>Borrower Name :</b></font> <font face="MS Sans Serif" size="1"><%=strCompDesc %> </font>
...
%>                             </table>
  ...
  <p>
   ...
   <table width="5%" border="1" cellspacing="0" cellpadding="0" bordercolorlight="#8F8369" bordercolordark="#FFFFFB"  align="center">
  <tr>
