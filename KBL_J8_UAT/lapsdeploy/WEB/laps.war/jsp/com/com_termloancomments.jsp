...
function doDelete()
{
	...
	document.forms[0].hidSourceUrl.value="action/com_termloancomments.jsp";	
	document.forms[0].method="post";
...
{   
	if(ConfirmMsg(102))
	{
	    ...
	    document.forms[0].hidPage.value="term";
		document.forms[0].hidBeanGetMethod.value="getComments";
		document.forms[0].action=appURL+"action/com_termloancomments.jsp";
		document.forms[0].method="post";
		document.forms[0].submit();
	}
}
...
<tr>
	<td><jsp:include page="../com/postsanctionlinks.jsp" flush="true">
		...
		<jsp:param name="subpageid" value="123" />
