...
function callPage(varappno,varQueryID)
{
		...
		document.forms[0].action="<%=ApplicationParams.getAppUrl()%>action/appqueryhome.jsp?hidBeanId=documentsupport&hidBeanGetMethod=getQueryData&strPageFrom=inbox&hidsno="+varQueryID+"&hidType="+varqueryType+"&hidCategoryType="+varhidcategory;
