    ...
    <tr> 
      <td >
         <table border="0" cellspacing="1" cellpadding="3" align="left" class="outertable" width="30%">
                <tr align="center"> 
                  <td width="15%" class="sub_tab_inactive"><a href="#" onclick="javascript:callExternalRating()">External Rating</a></td>
                  <td width="15%" class="sub_tab_active">Kalypto Rating</td>
