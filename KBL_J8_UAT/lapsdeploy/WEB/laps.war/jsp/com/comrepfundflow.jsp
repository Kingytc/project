...
var bnkname = document.forms[0].rpselect1.options[document.forms[0].rpselect1.selectedIndex].value;
		...
		document.all.ifrm2.src=path+"action/iframefundflow.jsp?hidBeanMethod=getData&hidMethod=getSearchData&hidBeanId=comrepprint&orgcode="+bnkname+"&field="+field+"&txtSearch="+val;
	}
}
                              ...
                              <table width="100%" border="0" cellspacing="0" cellpadding="5">
                                <tr> 
                                  <td width="17%" height="28">
									<font size="1" face="MS Sans Serif">Organisation Level </font>
								  </td>
                                  <td width="27%" height="28">
									<font size="1" face="MS Sans Serif">Entities 
                                    </font>
								  </td>
                                </tr>
                                <tr> 
                            ...
                            <td> 
                              <table width="100%" border="0" cellspacing="0" cellpadding="5">
                                ...
                                <tr> 
                                  ...
                                  <td width="2%">
									<font size="1" face="MS Sans Serif"> 
										<input type="radio" name="searchby" value="perapp_lname" >
                                    </font>
								  </td>
                                  ...
                                  <td width="4%"> 
									<font size="1" face="MS Sans Serif"> 
										<input type="radio" name="searchby" value="perapp_panno">
                                    </font>
								  </td>
                                  <td width="11%" id="defaultid">
									<font size="1" face="MS Sans Serif">Company Id </font>
								  </td>
                                  <td width="5%">&nbsp;</td>
                                  <td width="12%">
									<font size="1" face="MS Sans Serif"> 
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="3" bordercolorlight="#8F8369" bordercolordark="#FFFFFB">
                  ...
                  <tr bgcolor="#71694F"> 
                    ...
                    <td width="12%" height="20"> 
						<div align="left"><font  color="#FFFFFF"><b>Company Id </b></font></div>
                    </td>
                    <td width="25%" height="20"> 
                        <div align="center"><font  color="#FFFFFF"><b>Product</b></font></div>
                    </td>
                    <td width="13%" height="20"> 
                        <div align="left"><font  color="#FFFFFF"><b>Date Applied</b></font></div>
                    </td>
                     <td width="19%" height="20"> 
                          <div align="left"><font  color="#FFFFFF"><b>Application is </b></font></div>
                    </td>
                  </tr>
                </table>
                <iframe  height="154" width="100%" id="ifrm2" frameborder=0 style="border:0"  > 
                </iframe> 
			</td>
			</tr>
          </table>
