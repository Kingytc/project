...
{
	document.forms[0].action="<%=ApplicationParams.getAppUrl()%>action/solvencysearch.jsp?hidBeanGetMethod=getSolDetails&hidBeanId=comsolvency&customername="+customername+"&appid="+appid;
