...
<script LANGUAGE="JavaScript" src="<%=ApplicationParams.getAppUrl()%>js/com/com_searchbankers.js"> </script>
<script>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="outertable">
	<tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0" class="outertable">
			<tr>
			<td valign="top" class="page_flow">Home -&gt; Banker's -&gt; Customer
				Profile Search</td>
				</tr>
		</table>
		</td>
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="3" class="outertable">
								...
								<tr>
									...
									<table width="100%" border="0" cellspacing="1"
										cellpadding="3" class="outertable">
										<tr class="dataheader">
											<td width="20%"  align="center">Applicant Name
											</td>
											<td width="20%"  align="center">CBS Customer ID
											</td>
											<td width="20%"  align="center">Applicant ID
											</td>
											<td width="20%"  align="center">PAN No.
											</td>
											<td width="20%"  align="center">Branch Name
											</td>
										</tr>
									</table>
									</td>
