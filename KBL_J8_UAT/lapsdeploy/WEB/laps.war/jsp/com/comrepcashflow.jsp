...
document.all.ifrm2.src=path+"action/iframecashflow.jsp?hidBeanMethod=getData&hidMethod=getSearchData&hidBeanId=comrepprint&orgcode="+bnkname+"&field="+field+"&txtSearch="+val;
		}
	}
}
...
<iframe  height="0" width="0" id="ifrm" frameborder=0 style="border:0" ></iframe> 
  <div align="center"> 
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr> 
        <td> <font face="Times New Roman" size="3"> </font><font size="4"><b><i><font size="4"><b><i><font size="4"><b><i><font size="4"><b><i><font size="4"><b><font color="#000000" size="2"><i><font size="4"><b><i><font face="Times New Roman" size="3"><b><i>Home 
          ...
          </i></b></font></i></b></font></i></font></b></font></i></b></font></i></b></font></i></b></font></i></b></font><font face="Times New Roman" size="3"><b><i></i></b></font><font face="Times New Roman" size="3"><b><i>Cash 
          Flow</i></b> </font> </td>
      </tr>
      <tr> 
        <td align="right">&nbsp; </td>
                            ...
                            <td> 
                              <table width="100%" border="0" cellspacing="0" cellpadding="5">
                                ...
                                <tr> 
                                  <td width="4%">
									<font size="1" face="MS Sans Serif"> 
										<input type="radio" name="searchby" value="app_no" style="border-style:none">
                                    </font>
								  </td>
                                  <td width="15%">
                                  ...
                                  <td width="2%">
									<font size="1" face="MS Sans Serif"> 
										<input type="radio" name="searchby" value="comapp_companyname" style="border-style:none">
                                    </font>
								  </td>
                                  ...
                                  <td width="4%"> 
									<font size="1" face="MS Sans Serif"> 
										<input type="radio" name="searchby" value="comapp_companyid" style="border-style:none">
                                    </font>
								  </td>
          ...
          <tr valign="middle"> 
            <td valign="top" width="51%"> 
              <div align="center"> 
                ...
                <input type="button" name="cmdhelp" value="Help" style="background-color:#009966;cursor:help;;color:white;font-size=10;font-family:mssansserif;width:50;font-weight:bold" onClick="doHelp('commreport.htm')">
                </div>
              </td>
