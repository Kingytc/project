...
function doPrintPreview()
{
	<%if (arrRow.size()> 0){%>
		...
		win.document.write("<TR>");
		win.document.write("<TD width='20%'><strong><center>Corporate Rating Report for " +'<%=Helper.correctNull((String)hshValues.get("hidStatus")) %>'+" Proposal "+"</center></strong></TD>");
		win.document.write("</TABLE>");
		win.document.write("</center>");
...
<form name= "orgfrm" method="post">
  <table width="100%" border="0" cellspacing="0" cellpadding="3">
    ...
    <tr> 
      <td align="center"><b>Corporate Rating Report for  <%=Helper.correctNull((String)hshValues.get("hidStatus")) %> Proposal</b></td>
    </tr>
  </table>

  <table width="95%" border="0" cellspacing="0" cellpadding="3" align="center" bordercolor='#eeeeee'>
    <tr align="center"> 
