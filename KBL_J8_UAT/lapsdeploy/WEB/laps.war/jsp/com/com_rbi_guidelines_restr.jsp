...
function doEdit()
{
	...
	if(document.forms[0].chkbox.length >1)
	{
		for(var i=0;i<document.forms[0].chkbox.length;i++)
		{
			...
			{
				document.forms[0].txt_compliances[i].readOnly = false;
			}
			else
			{
				document.forms[0].txt_compliances[i].readOnly = true;
			}
		}
	}
	else
	{
		...
		{
			document.forms[0].txt_compliances.readOnly = false;
		}else{
			document.forms[0].txt_compliances.readOnly = true;
		}
	}
}
...
function doSave()
{
	...
	document.forms[0].hidBeanGetMethod.value="getRBIGuidelines_restr";
	document.forms[0].hidSourceUrl.value="/action/com_rbi_guidelines_restr.jsp";
	document.forms[0].submit();
}
...
function callRegulatory()
{
	document.forms[0].strPageType.value="S";
	document.forms[0].hidBeanId.value="comproposal";
	document.forms[0].hidBeanGetMethod.value="getRBIGuidelines_restr";
...
<% if(strCategoryType.equalsIgnoreCase("RET")){ %>
 <table width="100%" border="0" cellspacing="0" cellpadding="0" class="outertable">
    <tr> 
      <td> 
        <table width="90%" border="0" cellspacing="1" cellpadding="3" class="outertable">
          <tr> 
            <td width="15%"  align="center" class="sub_tab_inactive"><b><a href="javascript:callApplicant()" >By Applicant</a></b>
            </td>
             <%if(true){ %>
            <td width="15%"  align="center" class="sub_tab_inactive"><b><a href="javascript:callDocAttachment()" >Pre Sanction Document Attachment</a></b>
            </td>
            <%} %>
            ...
            <td width="15%"  align="center" class="sub_tab_inactive"><b><a href="javascript:callpostsancDocAttachment()" >Post Sanction Document Attachment</a></b>
            </td>
            <%} %>
    ...
    <tr> 
      <td> 
        <table width="30%" border="0" cellspacing="1" cellpadding="3" class="outertable">
          <tr> 
            <td align="center" width="15%" class="sub_tab_active"><b>General Principles</b>
            </td>
             <td width="15%"  align="center" class="sub_tab_inactive"><b><a href="javascript:callRegulatory()" >Special Regulatory Norms</a></b>
            </td>
          </tr>
        </table>
      </td>
    ...
    <td> 
            <table width="100%" border="0" cellspacing="1" cellpadding="4"  class="outertable">
              <tr class="dataheader"> 
                ...
                <td align="center" width="25%">General Principles and Prudential Norms for Restructured Accounts</td>
              ...
              <%
				...
				<td align="center"> 
				  <textarea name="txt_compliances" id="txt_compliances" cols="70" style="text-align:left" tabindex="12" rows="5" onKeyPress="textlimit(this,999)" onKeyUp="textlimit(this,999)" ><%=Helper.correctNull((String)arrCol.get(2))%></textarea>
				  <input type="hidden" name="txt_guideliness">
				  </td>
				</tr>
				<%}
				}
...
<input type="hidden" name="ssitype" value="<%=strSSIType%>"> 
 ...
 <input type="hidden" name="strPageType" value="G">
