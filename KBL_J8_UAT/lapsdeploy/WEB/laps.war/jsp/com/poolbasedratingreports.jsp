...
function runrep()
{
	...
	window.open(path+"action/poolbasedratingreportprint.jsp?hidBeanId=perrepappstatus&hidBeanMethod=getData&hidMethod=getPoolBasedRatingReport&sellevel="
				+level
				+"&orgselect="+orgselect
				+"&org_name="+org
			    +"&txtDate="+period
  ...
  <table class="outertable" width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      <td class="page_flow">Home 
        -&gt; Reports -&gt; Rating Reports -&gt;Pool Based Rating Reports</td>
