...
<script language="javascript" src="<%=ApplicationParams.getAppUrl()%>js/com/comrepdoc.js">
</script>
<script>
<!--
...
<form name="prim" method="post">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      <td><font size="2" face="Times New Roman"><b><i><font size="4"><b><i><font size="4"><b><i><font size="4"><b><i><font size="4"><b><i><font size="4"><b><font color="#000000" size="2"><i><font size="4"><b><i><font face="Times New Roman" size="3"><b><i>Home 
        ...
        </i></b></font></i></b></font></i></font></b></font></i></b></font></i></b></font></i></b></font></i></b></font><font face="Times New Roman" size="3"><b><i></i></b></font><font size="3">Document 
        Review</font></i></b></font></td>
    </tr>
    <tr> 
      <td align="right">&nbsp; </td>
    </tr>
                  ...
                  <tr> 
                    <td rowspan="4" width="75%" valign="top"> 
                      <table width="101%" border="0" cellspacing="0" cellpadding="5" height="196">
                        <tr align="center"> 
                          <td colspan="2" height="21" valign="top"><font size="1" face="MS Sans Serif">Organisation                             Level</font></td>
                        ...
                        <tr align="center"> 
                          ...
                          <td colspan="2" height="21" valign="top"><b><font face="MS Sans Serif" size="1"> 
                            <select name="selopt" style="width:100" onChange="selectData()">
                              ...
                              <option value="comapp_companyid">Organisation Id</option>
                              <option value="comapp_companyname">Company Name</option>
                            </select>
                            </font></b></td>
                        </tr>
                        <tr align="center"> 
                        ...
                        <tr align="center"> 
                          <td colspan="2" height="209" valign="top"><font size="1" face="MS Sans Serif"> 
                            <select name="rpselect1" size="12" style="width:150" onChange="resetData()" multiple>
                            </select>
                            </font></td>
                          <td colspan="2" height="209" valign="top"><font size="1" face="MS Sans Serif"> 
