...
{   
	if(ConfirmMsg(102))
	{
		document.forms[0].hidBeanId.value="facilities";
   		document.forms[0].hidPage.value="gist";
		document.forms[0].hidBeanGetMethod.value="getComments";
		document.forms[0].action=appURL+"action/com_gistproposal.jsp";
		document.forms[0].method="post";
		document.forms[0].submit();
	}
}
...
<lapstab:ComfacilityTab tabid="4"/>
<%} %>
...
<input type="hidden" name="hidPage" value="gist">
