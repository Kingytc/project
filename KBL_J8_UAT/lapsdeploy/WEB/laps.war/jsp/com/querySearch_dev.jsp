...
function changeQueryType()
{
	if(document.forms[0].sel_queryType.value=="S")
	{
		...
		document.all.result.src=appURL+"action/queryResult_dev.jsp?hidBeanGetMethod=getpermQueryDetails&area1="+area1+"&area2="+area2+"&area3="+area3+"&area4="+area4+"&area5="+area5+"&hidqueryType="+varqueryType+"&hidCategoryType="+varhidcategory;	
      ...
      <td> 
       ...
       <%if(strhidcategory.equals("PERM")){ %>
		...
		<% } else if(strhidcategory.equals("RET")) { %>
		 <tr>
			<td class="page_flow">Home -&gt; Retail -&gt; Query Reply </td>
		</tr>
                                          ...
                                          <tr>
                                             <td> Query  Type&nbsp;
                                             	<select name="sel_queryType" onchange="changeQueryType()">
                                             	 	...
                                             	 	<option value="REQ"> Received Queries</option>
                                             	 	<option value="RES"> Replied Queries</option>
                                             	</select>
                                             </td>
                                          </tr>
                                        </table>
