...
{ intSize	= arrRow.size();}
String apptypecon = Helper.correctNull((String) request.getParameter("strAppno"));
...
{	
	...
	document.forms[0].hidSourceUrl.value="/action/creditfacilityOtherBank.jsp?appstatus="+appstatus;
...
{  
	if(ConfirmMsg(102))
	{
		document.forms[0].hidBeanGetMethod.value="getourBankcreditDetails";
		document.forms[0].hidBeanId.value="comproposal";
		document.forms[0].action=appURL+"action/creditfacilityOtherBank.jsp?appstatus="+appstatus;
		document.forms[0].submit();		
	}	
}
...
function doComments()
{
	...
	var url=appURL+"action/com_bankingcomments.jsp?hidBeanId=facilities&hidBeanGetMethod=getComments&hidAppNo="+hidAppNo+"&hidPage1=custbankcomments";
				...
				<tr class="datagrid">
					<td align="center"><select
						...
						<option value="0" selected>&lt;----Select----&gt;</option>
						 <lapschoice:customerfacilityTag apptype='<%=apptypecon%>'/>
					</select></td>
...
<input type="hidden" name="hidourother" value="cust">
