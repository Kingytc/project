	...
	if(ConfirmMsg(102))
	 {
		...
		document.forms[0].hidSourceUrl.value="/action/comadditional_Parameter1.jsp";
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr> 
    <td valign="bottom" align="center" height="49"><font face="MS Sans Serif" size="2"><b>Sanction Particulars<br>
      <br>
      </b></font></td>
  </tr>
...
<table width="100%" border="1" cellspacing="0" cellpadding="5" height="10%" bordercolorlight="#8F8369" bordercolordark="#FFFFFB" align="center">
  ...
  <tr> 
    ...
    <td width="18%">Nature of Advance</td>
    <td width="37%">
