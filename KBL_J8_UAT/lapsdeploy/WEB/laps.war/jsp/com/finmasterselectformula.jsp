...
<body bgcolor="#DDE0F0" text="#000000" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" ><form name="selection" method="post" action=""> 
<div align="center"> 
  <p>&nbsp; </p>
  <table border="1" cellspacing="0" cellpadding="3"  bordercolorlight="#FFFFFF" bordercolordark="#C3CCF3" width="300">
    <tr> 
        <td valign="top"> 
          <table width="100%" border="0" cellspacing="0" cellpadding="5">
            <tr class="darkTabColor"> 
            ...
            <tr> 
              <td colspan="2"> 
                <table width="100%" border="1" cellspacing="0" cellpadding="3" bordercolorlight="#FFFFFF" bordercolordark="#C3CCF3" >
                  <tr> 
                    <td> 
                      <table width="100%" border="0" cellspacing="1" cellpadding="5">
                        <tr bgcolor="#F2F1EC"> 
                          <td bgcolor="#F2F1EC" align="center"> 
                            <input type="button" name="apply2" value="Add Formula" onClick="makeformula()" style="color:white;background-color:#3247A4">
                          </td>
                        </tr>
                      </table>
                    </td>
                ...
                <table width="100%" border="1" cellspacing="0" cellpadding="3" bordercolorlight="#FFFFFF" bordercolordark="#C3CCF3" >
                  <tr> 
                    <td> 
                      <table width="100%" border="0" cellspacing="1" cellpadding="5">
                        <tr> 
                          <td class="lightTabColor"><font size="1" face="MS Sans Serif">Formula</font></td>
                        </tr>
                        <tr> 
                          <td bgcolor="#F2F1EC"> 
            ...
            <br>
            <table width="12%" border="1" cellspacing="0" cellpadding="0" bordercolorlight="#FFFFFF" bordercolordark="#C3CCF3"   align="center">
              <tr> 
                <td> 
                  <table width="100%" border="0" cellspacing="0" cellpadding="2">
                    <tr valign="top"> 
                      <td width="0"> 
                        <input type="button" name="cmdok" value="OK" style="background-color:#3247A4;font-weight:bold;color:white;font-size=10;font-family:mssansserif;width:50" onClick="show_submit()">
                      </td>
                      <td width="0"> 
                        <div align="center"> 
