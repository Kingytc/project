...
<%
  ...
  vecOrg=(ArrayList)hshValues.get("vecRecords");
  String align="left";
...
<script>
var outlabel="Application No,Company Id,Company Name,Applied Date,Product Name,Status,Document,Document Type,Submission Status,Submitted Date";
var textlabel="";
...
function printpreview()
{
	...
	win.document.write("<TD width='20%'><font size='4' face='MS Sans Serif'><B><center>Document Review Report</center></B></font></TD>");
	...
	win.document.write("<TD ><font size='1' face='MS Sans Serif'>"+'<%=(String)Helper.getCurrentDateTime()%>'+"</font></TD>");
	win.document.write("</TR>");
	win.document.write("<TR>");
...
<br>
<h3><center>Document Review Report</center></h3>
