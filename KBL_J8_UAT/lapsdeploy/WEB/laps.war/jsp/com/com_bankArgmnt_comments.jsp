...
var btnenable="<%=Helper.correctNull((String) request
...
<table width="96%" border="0" cellspacing="0" cellpadding="3" align="center">
	...
	<tr>
		<td class="dataheader">&nbsp;Comments for Process Note</td>
	</tr>
</table>
	...
	<tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0" class="datagrid">
			<tr>
				...
				<div id="id_editor">
					<textarea name="txt_industryanalysis" cols="80" onkeyup="textlimitcorp1(this,200);" onkeydown="textlimitcorp1(this,200);" onKeyPress="checkEnter();textlimitcorp1(this,200)" wrap="VIRTUAL" rows="12"><%=Helper.correctNull((String) hshValues.get("fin_comments"))%>
					</textarea> 
				</div>
				</td>
			</tr>
...
<table width="96%" border="0" cellspacing="0" cellpadding="3" align="center">
	...
	<tr>
		<td class="dataheader">&nbsp;Comments for Annexure III</td>
	</tr>
</table>
<table width="96%" border="0" cellspacing="0" cellpadding="5" class="outertable border1" align="center">
	<tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0" class="datagrid">
			...
			<tr>
				...
				<div id="id_div1"><div class="EditorClassNew"> <%=Helper.correctNull((String)hshValues.get("fin_comments1")) %></div></div>
 				<div id="id_editor1"> 
 					<textarea name="txt_industryanalysis1" cols="150" rows="12" onKeyPress="textlimit(this,3999)" onKeyUp="textlimit(this,3999)" ><%=Helper.correctNull((String)hshValues.get("fin_comments1")) %>
 					</textarea></div>
  				</td>
			</tr>
			<%} %>
