...
<%
  ...
  ArrayList vecOrg1 = new ArrayList();
  vecOrg=(ArrayList)hshValues.get("vecValues");
  vecOrg1=(ArrayList)hshValues.get("vecValues1");
  String align="left";
...
var datalen1 ="<%= vecOrg1.size()%>";
function printpreview()
{
	if (datalen > 0 || datalen1 > 0 )
   	{
	...
	win.document.write("<TD width='20%'><font size='4' face='MS Sans Serif'><B><center>Sectorwise Analysis of NPA's</center></B></font></TD>");
	...
	if(datalen > 0)
		{
	win.document.write("<h5><left>Priority Sector</left></h5>");
    win.document.write("<center><TABLE border='1' cellspacing='0' cellpadding='0' >");
		var agln="";
		 ...
		 for(l=0;l<textlabel.length;l++)
			{
				win.document.write("<td width='11%' height='20'> ");
			...
			<%	  for(int j1=0;j1<vecVal.size();j1++)
             ...
             %>
					win.document.write("<td width='20%' height='20' align='<%=align%>'><font size='1' face='MS Sans Serif'>"+"<%=stp%>"+'&nbsp;'+"</td> ");	
			<%	j1=j1+1; 
				}
			%>
				  win.document.write("</tr>");
		...
		if(datalen1 > 0)
		{
			...
			win.document.write("<h5><left>Non Priority Sector</left></h5>");
	   win.document.write("<center><TABLE border='1' cellspacing='0' cellpadding='0' >");
		var agln="";
		 ...
		 for(l=0;l<textlabel.length;l++)
			...
			<%if (vecOrg1.size() > 0)
			{
				for(int i1=0;i1<vecOrg1.size();i1++)
				{
				  ArrayList vecVal = new ArrayList();
				  vecVal =(ArrayList)vecOrg1.get(i1);
			 %>
...
function printData1()
{
   ...
   else
	{
	   document.write("<tr><td align='center'>No Data Found</td></tr>");
         ...
         <%
		  for(int i=0;i<vecOrg1.size();i++)
		  {
			  ArrayList ht = new ArrayList();
			  ht =(ArrayList)vecOrg1.get(i);
		  %>
				document.write("<tr>");
		   <%	for(int j=0;j<ht.size();j++)
			    {
...
<br>
<h3><center>Sectorwise Analysis of NPA's</center></h3>
...
<br>
    ...
    <table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolorlight="#8F8369" bordercolordark="#FFFFFB" align="center">
			<tr>
			<td>
			 <h5><center>Priority Sector</center></h5>
			</td>
			</tr>
			<tr> 
				<td height="3"> 
	...
	<table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolorlight="#8F8369" bordercolordark="#FFFFFB" align="center">
	  <tr>
			<td>
			 <h5><center>Non Priority Sector</center></h5>
			</td>
			</tr>
	  <tr>
		  <td>
