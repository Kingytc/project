...
function doDelete()
{
	if(ConfirmMsg(101))
		{	
			...
			document.forms[0].hidBeanMethod.value="updatePresentStatusData";
			document.forms[0].hidBeanGetMethod.value="getPresentStatusData";
			document.forms[0].hidBeanId.value="reviewtermloantwo";
			document.forms[0].hidSourceUrl.value="action/tlr_presentstatus.jsp";	
...
{  
	if(ConfirmMsg(102))
	{
		...
		document.forms[0].hidBeanId.value="reviewtermloantwo";
		document.forms[0].hidBeanGetMethod.value="getPresentStatusData";
		document.forms[0].action=appURL +"action/tlr_presentstatus.jsp";
	    document.forms[0].submit();	
	}	
}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="outertable">
	<tr>
		...
		<td valign="top" colspan="5" class="page_flow">Home -&gt; Term Loan - Review -&gt; Comments -&gt; Present status of project</td>
	</tr>
</table>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="outertable">
	<tr>
		...
		<table width="45%" border="0" cellspacing="1" cellpadding="3" align="left" class="outertable">
			...
			<td width="15%" align="center" class="sub_tab_inactive">
							...
							>Basic Information</a></b> </td>
				<td width="15%" align="center" class="sub_tab_active">
				<b>Present status of project</b></td>								
	<td width="15%" align="center" class="sub_tab_inactive">
						<b> <a
    ...
    <table width="73%" border="0" cellspacing="1" cellpadding="3" align="center" class="outertable">
      <tr> 
        <td align="center"> 
        <textarea name="txt_presentstatus" cols="120" rows="15" onKeyPress="textlimit(this,3999)" onKeyUp="textlimit(this,3999)"><%=Helper.correctNull((String)hshValues.get("tlr_comments"))%></textarea>
...
editor_generate('txt_presentstatus');
</script>
</html>
