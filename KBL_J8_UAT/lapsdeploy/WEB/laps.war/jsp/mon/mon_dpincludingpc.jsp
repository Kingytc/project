...
<laps:handleerror />
  ...
  <%
double totalstock=Double.parseDouble(Helper.correctDouble((String)hshValues.get("mmr_totalunpaidstock")));
    ...
    <td valign="top" height=""> 
      <table width="100%" border="0" class="outertable border1" cellspacing="0" cellpadding="3">
        <tr> 
          ...
          <td  width="45%" colspan="2"><font size="1" face="MS Sans Serif">Grand 
            Total </font></td>
          <td width="50%"><%=nf.format(Double.parseDouble(Helper.correctDouble((String)hshValues.get("grand_total"))))%></td>
        </tr>
        <tr> 
          <td align="center" height="26" width="5%">II</td>
          <td  height="26" width="45%" colspan="2">&nbsp;<font size="1" face="MS Sans Serif">Total 
            Stock to be excluded for calculation of Drawing Power for Cash Credit/Demand 
            Loan (A+B) </font> </td>
          <td  width="50%"><%=nf.format(Double.parseDouble(Helper.correctDouble((String)hshValues.get("mmr_totalunpaidstock"))))%> 
          </td>
        </tr>
        <tr> 
          <td align="center" width="5%"><b><font size="1" face="MS Sans Serif"><b>III</b></font></b></td>
          <td  width="45%" colspan="2"><font size="1" face="MS Sans Serif">&nbsp;Stock 
            eliglible for calculation of Drawing Power for CASH CREDIT/DEMAND 
            LOAN ACCOUNTS (I-II)</font></td>
          <td align="left" width="50%"><%=nf.format(totalsub) %></td>
        </tr>
        <tr> 
          <td align="center" width="5%">IV</td>
          <td  width="45%" colspan="2">&nbsp;<font size="1" face="MS Sans Serif">Margin 
            % </font></td>
          <td align="left" width="50%"><%=Helper.correctNull((String)hshValues.get("marginpercent"))%> 
          </td>
        </tr>
        <tr> 
          <td align="center" width="5%">V</td>
          <td  width="45%" colspan="2"><font size="1" face="MS Sans Serif"> Total 
            Available DP against stocks (III-IV)</font></td>
          <td  width="50%"><%=nf.format(totalsub1) %></td>
        </tr>
        <tr> 
          <td ALIGN="center" width="5%" rowspan="2">VI</td>
          <td  width="22%" rowspan="2"><font size="1" face="MS Sans Serif">Our 
            Share in DP </font></td>
          <td  width="23%" height="28"><font size="1" face="MS Sans Serif">Consortium 
            share</font></td>
          <td  width="50%" height="28"> <%=banknamepercent %>%</td>
        </tr>
        <tr> 
          <td  width="23%"><font size="1" face="MS Sans Serif">Consortium Amount</font></td>
          <td  width="50%"><%=nf.format(ownbank) %></td>
        </tr>
        <tr> 
          <td width="5%">&nbsp;</td>
