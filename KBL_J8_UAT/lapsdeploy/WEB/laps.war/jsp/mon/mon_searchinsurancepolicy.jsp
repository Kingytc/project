...
<%	
	...
	String	index	= Helper.correctNull(((String)hshValues.get("index")));
	String	size	= Helper.correctNull(((String)hshValues.get("size")));
	//out.println(vecRow);
%>
<html>
<head>
...
function setValues(value1,value2,value3,value4)
	{
		...
		if(size >1)
		{
			window.opener.document.forms[0].txt_insuno[index].value = value1;
			window.opener.document.forms[0].txt_insuamount[index].value = value2;
			window.opener.document.forms[0].txt_insuexpirydate[index].value = value3;
			window.opener.document.forms[0].sel_endorsed[index].value = value4;
			window.close();
		}
		else if(size == 1)
		{
			window.opener.document.forms[0].txt_insuno.value = value1;
			window.opener.document.forms[0].txt_insuamount.value = value2;
			window.opener.document.forms[0].txt_insuexpirydate.value = value3;
			window.opener.document.forms[0].sel_endorsed.value = value4;
			window.close();
		}
	}
                  ...
                  <td valign="top" align="center" height="230"> 
                    <DIV class="cellcontainer"> 
                      ...
                      <table width="100%" border="0" cellspacing="1" cellpadding="2" bordercolorlight="#FFFFFB" bordercolordark="#DEDACF">
                        ...
                        <tr> 
                          <td width="24%"><%=i+1%> </td>
                          <td width="76%"><a href="javascript:setValues('<%= Helper.correctNull((String)vecCol.get(0))%>','<%= Helper.correctNull((String)vecCol.get(1))%>',
   												                        '<%= Helper.correctNull((String)vecCol.get(2))%>','<%= Helper.correctNull((String)vecCol.get(3))%>')"><%= Helper.correctNull((String)vecCol.get(0))%></a></td>
                        </tr>
                        <% 		  
                                    	  }
