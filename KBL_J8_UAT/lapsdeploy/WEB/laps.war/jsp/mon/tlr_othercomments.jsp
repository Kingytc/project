...
function doDelete()
{
	if(ConfirmMsg(101))
		{	
			...
			document.forms[0].hidBeanMethod.value="updateOthersData";
			document.forms[0].hidBeanGetMethod.value="getOthersData";
			document.forms[0].hidBeanId.value="reviewtermloantwo";
			document.forms[0].hidSourceUrl.value="action/tlr_othercomments.jsp";	
...
{  
	if(ConfirmMsg(102))
	{
		...
		document.forms[0].hidBeanId.value="reviewtermloantwo";
		document.forms[0].hidBeanGetMethod.value="getOthersData";
		document.forms[0].action=appURL +"action/tlr_othercomments.jsp";
	    document.forms[0].submit();	
	}	
}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="outertable">
	<tr>
		...
		<td valign="top" class="page_flow">Home -&gt; Term Loan - Review -&gt; Comments -&gt; Any Other Matter </td>
	</tr>
</table>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="outertable">
		...
		<table width="45%" border="0" cellspacing="1" cellpadding="3" align="left" class="outertable">
			<tr>
				<td width="15%" align="center" class="sub_tab_inactive">
							<b> <a
							href="JavaScript:callOtherLink('tlr_briefbackground.jsp','reviewtermloantwo','getBirefBackgroundData')"
							>Brief Background</a></b></td>
				<td width="15%" align="center" class="sub_tab_inactive">
						<b> <a
    ...
    <table width="73%" border="0" cellspacing="1" cellpadding="3" align="center" class="outertable">
      <tr> 
        <td align="center"> 
        <textarea name="txt_others" cols="120" rows="15" onKeyPress="textlimit(this,3999)" onKeyUp="textlimit(this,3999)"><%=Helper.correctNull((String)hshValues.get("tlr_comments"))%></textarea>
        <table width="12%" border="0" cellspacing="0" cellpadding="3" class="outertable"
