...
<table width="90%" border="0" cellspacing="0" cellpadding="3"
	...
	<tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="3">
			...
			<tr>
				<td align="center"><b><U><b>Proposal for : Review of Term Loan</b></U></b></td>
			</tr>
		</table>
		</td>
	</tr>
...
<tr valign="top"> 
			...
			<tr>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="3"
					...
					<tr>
						<td width="31%"><b>2. Tangible Net Worth (TNW)</b></td>
						<td width="17%" align="right"><%=strIncurred1[2]%></td>
						<td width="17%" align="right"><%=strIncurred1[2]%></td>
						<td width="18%" align="right"><%=strIncurred1[2]%></td>
					</tr>
					<tr>
						<td width="31%"><b>3. Sales</b></td>
					...
					<tr>
						<td width="31%"><b>4. Profit Before Tax (PBT)</b></td>
					...
					<tr>
						<td width="31%"><b>5. Profit After Tax (PAT)</b></td>
					...
					<tr>
						<td width="31%" height="2"><b>6. Current Ratio (CR)</b></td>
					...
					<tr>
						<td width="31%"><b>7. Debit Equity Ratio [DER</b></td>
					...
					<tr>
						<td width="31%"><b>8. Ratio of Total Outside liabilities to TNW</b></td>
			...
			<tr>
				<td width="2%">&nbsp;</td>
				<td width="44%"><b>Comments on Financial Indicator</b></td>
				<td width="1%">&nbsp;</td>
				<td width="53%">&nbsp;</td>
			</tr>
			<tr>
			...
			<tr>
				<td width="2%"><B>17.1</B>&nbsp;</td>
				<td colspan="3">In view of above we recommend for review Term Loan
				of Rs. <%=Helper.formatDoubleValue(Double.parseDouble(Helper.correctDouble((String)hshValues.get("proposedlimit")))) %>
