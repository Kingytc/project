...
<laps:handleerror />
<%
	String cattype = Helper.correctNull((String) hshValues
			.get("cattype"));
...
<table border="1" width="100%" cellspacing="0" cellpadding="3"
	...
	<tr>
			...
			<%
				...
				if (cattype.equalsIgnoreCase("OPS")) {
					if (Helper.correctNull((String) hshValues
							.get("ops_accountbusinessnature")) != "") {
						strnature = Helper.correctNull((String) hshValues
								.get("ops_accountbusinessnature"));
					}
				} else {
					if (Helper.correctNull((String) hshValues
							.get("comapp_businessnature")) != "") {
						strnature = Helper.correctNull((String) hshValues
								.get("comapp_businessnature"));
					}
				}
		...
		<table border="0" width="100%" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<%
					if (!Helper
							.correctNull((String) hshValues.get("appCreationBranch"))
							.equalsIgnoreCase("")) {
						out.println(Helper.correctNull((String) hshValues
								.get("appCreationBranch"))
								+ "<br>");
					}
				%> <%
 	if (!Helper.correctNull(
 			(String) hshValues.get("appCreationAddress"))
 			.equalsIgnoreCase("")) {
 		out.println(Helper.correctNull((String) hshValues
 				.get("appCreationAddress")));
 	}
 %> <br>
				<%
					if (!Helper.correctNull((String) hshValues.get("appCreationCity"))
							.equalsIgnoreCase("")) {
						out.println(Helper.correctNull((String) hshValues
								.get("appCreationCity")));
					}
				%> <%
 	if (!Helper.correctNull((String) hshValues.get("appCreationState"))
 			.equalsIgnoreCase("")) {
 		out.println(Helper.correctNull((String) hshValues
 				.get("appCreationState")));
 	}
 %> <%
 	if (!Helper.correctNull((String) hshValues.get("appCreationpin"))
 			.equalsIgnoreCase("")) {
 		out.println(Helper.correctNull((String) hshValues
 				.get("appCreationpin")));
 	}
 %>
		...
		<table border="0" width="100%" cellspacing="0" cellpadding="0"
			...
			<%
				String branch = "";
				String branch_val = Helper.correctNull((String) hshValues
						.get("org_branchIn"));
			...
			<tr>
				...
				<td valign="top">
				<%
					strOwner = Helper.correctNull((String) hshValues
							.get("comapp_ownership"));
			...
			<tr>
				...
				<td valign="top">
				<%
					if (Helper.correctNull((String) hshValues.get("comapp_companyid"))
							.contains("-")) {

						String strOccupation[] = Helper.correctNull(
								(String) hshValues.get("comapp_companyid")).split("-");
				%><%=strOccupation[0]%>
				<%
					} else {
				%> <%=Helper.correctNull((String) hshValues
								.get("comapp_companyid"))%>
				<%
					}
				%> &nbsp;</td>
			</tr>
	...
	<tr>
		...
		<table border="0" width="99%" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<td align="center"><%=Helper.formatDoubleValue(Double.parseDouble(Helper
							.correctDouble((String) hshValues.get("means"))))%></td>
			</tr>
		</table>
		</td>
		<td valign="top">
		<table border="0" width="100%" cellspacing="0" cellpadding="0">
			<tr>
				...
				<td width="71%" valign="top"><%=Helper.correctNull((String) hshValues
			...
			<tr>
				...
				<%
					if (!Helper.correctNull((String) hshValues.get("comapp_regadd1"))
							.equalsIgnoreCase("")) {
						out.println(Helper.correctNull((String) hshValues
								.get("comapp_regadd1"))
								+ ", ");
				...
				%> <%
 	if (!Helper.correctNull((String) hshValues.get("comapp_regadd2"))
 			.equalsIgnoreCase("")) {
 		out.println(Helper.correctNull((String) hshValues
 				.get("comapp_regadd2"))
 				+ ", ");
 ...
 %> <br>
				<%
					if (!Helper.correctNull((String) hshValues.get("city_name"))
							.equalsIgnoreCase("")) {
						out.println(Helper.correctNull((String) hshValues
								.get("city_name"))
								+ ", ");
					}
					if (!Helper.correctNull((String) hshValues.get("state_name"))
							.equalsIgnoreCase("")) {
						out.println(Helper.correctNull((String) hshValues
								.get("state_name"))
								+ ", ");
					}
					if (!Helper.correctNull((String) hshValues.get("comapp_regpin"))
							.equalsIgnoreCase("")) {
						out.println(Helper.correctNull((String) hshValues
								.get("comapp_regpin"))
								+ ", ");
		...
		<table border="0" width="99%" cellspacing="0" cellpadding="0">
			<tr>
				<td colspan="4"><strong>SECTORIAL/CATEGORY</strong></td>
			</tr>
			<tr>
				<td width="25%">A-1</td>
				<td width="25%">B-1</td>
	...
	<tr>
		...
		<table border="0" width="100%" cellspacing="0" cellpadding="0">
			...
			<tr>
				<%
					if ((Helper.correctNull((String) hshValues.get("comapp_ownership"))
							.equalsIgnoreCase("001"))
							|| (Helper.correctNull((String) hshValues
									.get("comapp_ownership")).equalsIgnoreCase("002"))) {
				%>
		...
		<table border="0" width="99%" cellspacing="0" cellpadding="0">
			...
			<tr>
				<td align="left">
				<%
					//=Helper.correctNull((String)hshValues.get("sanctionedauthority"))
				%>
				<%=Helper.correctNull((String) hshValues
							.get("sanc_auth_design"))%>&nbsp;</td>
			</tr>
		</table>
		</td>
	</tr>
	<tr>
		...
		<td><b>OUR NO:</b></td>
		<td><b>DATE</b><b>:</b> <%=Helper.correctNull((String) hshValues
							.get("app_processdate"))%>
		</td>
	</tr>
	<tr>
		<td><b>Dated:</b><%=Helper.correctNull((String) hshValues
							.get("appcreatedate"))%></td>
	...
	<tr>
		...
		<table width="100%" border="1" cellspacing="0" cellpadding="2"
			bordercolor="#999999">
			<tr valign="top">
				<td width="10%"><strong>New/ Renewal/ Modification</strong></td>
				<td width="20%"><strong>LIMIT(S)</strong></td>
				<td width="5%"><strong>SECURED</strong></td>
				<td width="5%"><strong>UNSECURED</strong></td>
				<td width="5%"><strong>MARGIN (%)</strong></td>
				<td width="5%"><strong>INT/COM (%)</strong></td>
				<td width="20%"><strong>DOCUMENTS </strong></td>
				<td><strong>SECURITY(GIVE BRIEF DETAILS)</strong></td>
			</tr>
			<%
				...
				for (int i = 0; i < arrTL_Funded_NonFunded_Size; i++) {
					...
					String strCategory = "";
					if (Helper.correctNull((String) TL_Funded_NonFunded.get(17))
							.equalsIgnoreCase("A")) {
						strCategory = "<br>(Adhoc Limit for "
					...
					int introwspan = Integer.parseInt(Helper
							.correctInt((String) TL_Funded_NonFunded.get(19)));
					if (arrSecurity != null && arrSecurity.size() > 0) {
						for (int j = 0; j < arrSecurity.size(); j++) {
							arrCol = new ArrayList();
							arrCol = (ArrayList) arrSecurity.get(j);
							arrtotRemark.add(Helper.correctNull((String) arrCol
									.get(3)));//Add only remarks to display separate
							if (j == 0) {
			%>
			<tr>
				<td width="10%" valign="top" rowspan="<%=introwspan%>"><%=Helper
													.correctNull((String) TL_Funded_NonFunded
															.get(3))%>&nbsp;</td>
				<td width="20%" valign="top" rowspan="<%=introwspan%>"><b><%=Helper
													.correctNull((String) TL_Funded_NonFunded
															.get(1))%></b>&nbsp;<%=strCategory%>&nbsp;</td>
				<td width="5%" valign="top" align="right" rowspan="<%=introwspan%>">&nbsp;<%=Helper
													.formatDoubleValue(Double
															.parseDouble(Helper
																	.correctDouble((String) TL_Funded_NonFunded
																			.get(4))))%></td>
				<td width="5%" valign="top" rowspan="<%=introwspan%>">&nbsp;</td>
				<td width="5%" valign="top">&nbsp;<%=Helper
													.correctNull((String) arrCol
															.get(1))%></td>
				<td width="5%" valign="top" rowspan="<%=introwspan%>">&nbsp;<%=Helper
													.correctNull((String) TL_Funded_NonFunded
															.get(6))%>
				</td>
				<td width="20%" valign="top" rowspan="<%=introwspan%>">&nbsp; <%
 	ArrayList arrUserDocuments = new ArrayList();
 					arrUserDocuments = (ArrayList) TL_Funded_NonFunded
 							.get(14);
 					if (arrUserDocuments != null
 							&& arrUserDocuments.size() > 0) {
 						for (int docno = 0; docno < arrUserDocuments
 								.size(); docno++) {
 %> <%=j + 1%>.&nbsp;<%=Helper
															.correctNull((String) arrUserDocuments
																	.get(docno))%><br>
				<%
					}
									} else {
 ...
 %>
			...
			%>
			<tr>
				<td width="10%" valign="top"><%=Helper.correctNull((String) TL_Funded_NonFunded
									.get(3))%>&nbsp;</td>
				<td width="20%" valign="top"><b><%=Helper.correctNull((String) TL_Funded_NonFunded
									.get(1))%>&nbsp;</b><%=strCategory%>&nbsp;</td>
				<td width="5%" valign="top">&nbsp;</td>
				<td width="5%" valign="top" align="right">&nbsp;<%=Helper
											.formatDoubleValue(Double
													.parseDouble(Helper
															.correctDouble((String) TL_Funded_NonFunded
																	.get(4))))%></td>
				<td width="5%" valign="top">&nbsp;</td>
				<td width="5%" valign="top">&nbsp;<%=Helper.correctNull((String) TL_Funded_NonFunded
									.get(6))%>
				</td>
 ...
 %>
				...
				//For the Sub-limits, under each one
					...
					if (arrSubFac != null && subFacSize > 0) {
						for (int j = 0; j < subFacSize; j++) {
							...
							int intsubtrowspan = Integer.parseInt(Helper
									.correctInt((String) arrSubFacRecords.get(16)));
							ArrayList arrSublimitSecurity = new ArrayList();
							arrSublimitSecurity = (ArrayList) arrSubFacRecords
									.get(14);
							if (j == 0) {
			%>
			<tr>
			...
			%>
			<%
				if (arrSublimitSecurity != null
									&& arrSublimitSecurity.size() > 0) {
								for (int k = 0; k < arrSublimitSecurity.size(); k++) {
									ArrayList arrsubCol = new ArrayList();
									arrsubCol = (ArrayList) arrSublimitSecurity
											.get(k);
									arrtotRemark
											.add(Helper
													.correctNull((String) arrsubCol
															.get(3)));//Add only remarks to display separate
									if (k == 0) {
			%>
			<tr>
				<td width="10%" valign="top" rowspan="<%=intsubtrowspan%>">&nbsp;<%=Helper
															.correctNull((String) arrSubFacRecords
																	.get(3))%></td>
				<td width="20%" valign="top" rowspan="<%=intsubtrowspan%>">&nbsp;<%=Helper
															.correctNull((String) arrSubFacRecords
																	.get(1))%></td>
				<td width="5%" valign="top" align="right"
					rowspan="<%=intsubtrowspan%>">&nbsp;(<%=Helper
															.formatDoubleValue(Double
																	.parseDouble(Helper
				...
				<%
					ArrayList arrSublimitDoc = new ArrayList();
											arrSublimitDoc = (ArrayList) arrSubFacRecords
													.get(13);
											if (arrSublimitDoc != null
													&& arrSublimitDoc.size() > 0) {
												for (int j1 = 0; j1 < arrSublimitDoc
														.size(); j1++) {
				%> <%=j1 + 1%>&nbsp;<%=Helper
																	.correctNull((String) arrSublimitDoc
																			.get(j1))%><br>
				<%
					}
											} else {
 ...
 %>
			...
			%>
			<tr>
				<td width="10%" valign="top">&nbsp;<%=Helper
													.correctNull((String) arrSubFacRecords
															.get(3))%></td>
				<td width="20%" valign="top">&nbsp;<%=Helper
													.correctNull((String) arrSubFacRecords
															.get(1))%></td>
				<td width="5%" valign="top">&nbsp;</td>
				<td width="5%" valign="top" align="right">&nbsp;(<%=Helper
 ...
 %>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<%
						for (int i = 0; i < arrtotRemark.size(); i++) {
								...
								if (!Helper
										.formatTextAreaData((String) arrtotRemark.get(i))
										.equalsIgnoreCase("")) {
					%>
					<tr>
						<td width="3%">&nbsp;</td>
					...
					<tr>
						...
						<td valign="top" class="just" width="97%"><%=Helper
												.formatTextAreaData((String) arrtotRemark
														.get(i))%>&nbsp;</td>
					</tr>
	...
	<tr>
		<td colspan="3">&nbsp;<%=i + 1%>.&nbsp;&nbsp;<%=Helper.correctNull((String) arrCollateral
											.get(i))%></td>
	</tr>
	<%
		}
	...
	<tr>
		...
		<td colspan="2" valign="top"><strong>Terms &amp;
	...
	<tr>
		...
		<table width="100%" border="1" cellspacing="0" cellpadding="0"
			...
			<%
				if (cattype != null) {
					if (cattype.equalsIgnoreCase("CORP")
							|| cattype.equalsIgnoreCase("SME")
							|| cattype.equalsIgnoreCase("ADC")
							|| cattype.equalsIgnoreCase("STL")) {
						double dbMeans = 0.00;
						...
						if (arrRow != null && arrRow.size() > 0) {
							...
							for (int i = 0; i < size; i++) {
								...
								dbMeans = Double.parseDouble(Helper
										.correctNull(Helper
												.correctDouble((String) arrCol
														.get(2))));
			%>
			<tr>
				<td nowrap="nowrap"><%=Helper
													.correctNull((String) arrCol
															.get(0))%>&nbsp;</td>
		...
		1.LIMITS SANCTIONED ARE SUBJECT TO ALL GENERAL INSTRUCTIONS ADVISED
		FROM TIME TO TIME.<br>
		2.OTHER TERMS &amp; CONDITION/SPECIAL INSRUCTIONS AS PER ENCLOSED
		ANNEXURES.<br>
		</td>
	</tr>
</table>
<table border="1" width="100%" bordercolor="#999999" cellspacing="0">
	<tr>
		<td width="29%" colspan="2" align="center"><strong>Authorised
		Signatory</strong></td>
		<td width="48%"></td>
		<td width="25%" colspan="2"><strong>&nbsp; Authorised
		Signatory</strong></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td width="19%">&nbsp;</td>
		<td width="48%"></td>
		<td width="8%"><strong>Designation</strong></td>
		<td width="17%">&nbsp;</td>
	</tr>
	<tr>
		<td width="10%"><strong>PA No</strong></td>
		<td width="19%">&nbsp;</td>
		<td width="48%"></td>
		<td width="8%"><strong>PA No</strong></td>
		<td width="17%">&nbsp;</td>
	</tr>
	<tr>
		<td width="10%"></td>
