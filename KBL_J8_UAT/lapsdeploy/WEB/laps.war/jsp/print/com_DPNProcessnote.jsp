...
<html>
<head>
<title>Interest Deferment DPN 2020</title>
...
<table width="95%" align="center" cellpadding="3" cellspacing="0"
	...
	<tr>
		...
		Interest Deferment DPN 2020</td>
	</tr>
	<tr>
		<td>Office Note: &nbsp;</td>
	</tr>
 ...
 %> <br>
	...
	<tr>
		<td class="title">I.Introduction:</td>
	</tr>
		...
		<table width="100%" align="center" cellpadding="3" cellspacing="0"
			...
			<tr>
				<td><jsp:include page="../print/com_AnnexureII.jsp"
					flush="true">
					<jsp:param name="pageVal" value="DPN" />
				</jsp:include></td>
			</tr>
		</table>
		<!-- END --></td>
				...
				<table width="95%" align="center" cellpadding="3" cellspacing="0"
					...
					<tr>
						...
						<table width="95%" align="center" cellpadding="3" cellspacing="0"
							border="0">
							<tr>
								<td class="title">Assessment of Interest Deferment DPN 2020</td>
							</tr>
							<tr>
								<td></br>Conversion of interest deferment for working capital limit in the form of Overdraft facility in to Funded Interest DPN.</td>
							</tr>
							<%
							ArrayList listAccRow=(ArrayList)hshValues.get("listAccRow");
							if(listAccRow!=null && listAccRow.size()>0){
							for(int i=0;i<listAccRow.size();i++){
								arrCol=(ArrayList)listAccRow.get(i);
								ArrayList listRow=(ArrayList)arrCol.get(4);
								%>
								<tr>
								<td class="title"><%=Helper.correctNull((String)arrCol.get(0)) %> - <%=Helper.correctNull((String)arrCol.get(1)) %> (<%=Helper.converAmount(Helper.correctDouble((String)arrCol.get(3)),strAmountValue) %>)</td>
								</tr>
								<tr>
								<td class="title">Existing Account no : <%=Helper.correctNull((String)arrCol.get(2)) %></td>
								</tr>
							
							<tr>
								<td><b>The proposed limit calculated as below</b></td>
							</tr>
							<tr>
								<td>	
									<div id="top">
										<table width="100%" align="center" cellpadding="3" cellspacing="0" border="0">
											<%if(listRow!=null && listRow.size()>0){
												...
												arrCol=(ArrayList)listRow.get(a);
												if(a==1){%>
												<tr>
												<td colspan="2" align="center">Interest Deferment&nbsp;</td>
											</tr>
												<%} %>
											<tr>
												<td width="50%"><%=Helper.correctNull((String)arrCol.get(0)) %>&nbsp;</td>
												<td align="right" width="35%"><%=Helper.converAmount(Helper.correctDouble((String)arrCol.get(1)),strAmountValue) %>&nbsp;</td>
											</tr>
											<%}}
											else{%>
											<tr>
