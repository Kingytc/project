  ...
  <tr>
    <td>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <td> 
            <div id="top"> 
              <table width="98%" border="0" cellspacing="0" cellpadding="0">
                <tr> 
                  <td colspan="3"><b>Submission before 5th of the following month 
                    mandatory. To be submitted in respect of all Standard / EAS 
                    - I / EAS - II / SMA accounts on a monthly basis to the authorities 
                    as per the cut off limits shown below (other than Large Corporate Branches):</b></td>
                </tr>
                <tr> 
                  <td align="center">Regional Office</td>
                  <td align="center">FGMO</td>
                  <td align="center">Credit Monitoring Cell, Corporate Credit 
                    &amp; SME Dept., C.O.</td>
                </tr>
                <tr> 
                  <td><b>Above Rs.50.00 lacs and upto Rs.1.00 crs. #</b></td>
                  <td><b>Above Rs.1.00 crs. and upto Rs.3.00 crs. #</b></td>
                  <td> 
                    <div align="center"><b>Above Rs.3.00 crs. </b></div>
                  </td>
                </tr>
              </table>
            </div>
        ...
        <tr> 
          <td><b> # On sanction of Adhoc facility, if the limit / exposure in 
            an account exceeds the aforesaid cut off limits, still MCMR should 
            continue to be submitted to the monitoring authority to whom the reports 
            are hitherto submitted. (Please refer the detailed explanation given 
            under point no.14.7.7.2). </b></td>
        </tr>
         <tr> 
          <td><b> # Large Corporate Branches shall monitor accounts upto Rs.3.00 crore at their level and submit MMR above Rs.3.00 crore to CO.</b></td>
        </tr>
        <tr> 
          <td>&nbsp;</td>
        </tr>
        ...
        <tr> 
          <td align="right"><b>[All values in lacs only]</b></td>
        </tr>
        <tr> 
          <td> 
            <div id="top"> 
          ...
          <td> 
            <div id="top"> 
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr> 
                  <td width="47%"><b>2-b. Nature of activity ( Mfg. / Trading 
                    / Service) </b></td>
		...
		%>
                <tr> 
                  <td align="right">&nbsp;<%=Helper.converToLakhs((String)arrCol.get(2))%>&nbsp;</td>
                  <td >&nbsp;<%=Helper.correctNull((String)arrCol.get(6))%></td>
                  <td align="right">&nbsp;<%=Helper.converToLakhs((String)arrCol.get(3))%>&nbsp;</td>
        ...
        <tr> 
          <td> 
            <div id="top"> 
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr align="center"> 
                  <td width="40%"><b>B-1. Sanctioning Authority</b></td>
                  <td width="22%"><b>Sanctioning Level</b></td>
                  <td width="38%"><b>Month of Review</b></td>
                </tr>
				<%
		...
		%>
                <tr> 
                  <td width="40%">&nbsp;<%=Helper.correctNull((String)arrCol.get(0))%></td>
                  <td width="22%">&nbsp;<%=Helper.correctNull((String)arrCol.get(1))%></td>
                  <td width="38%">&nbsp;<%=Helper.correctNull((String)arrCol.get(2))%></td>
                </tr>
				<%}}}%>
              </table>
            </div>
        ...
        <tr> 
          <td> 
            <div id="top"> 
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr> 
                  <td width="40%"><b>B-2. If due for renewal, date on which renewal 
                    submitted </b></td>
                  <td width="60%">&nbsp;<%=(Helper.correctNull((String)hshValues.get("renewalcompiled")).equals("S"))?"":(Helper.correctNull((String)hshValues.get("renewalcompiled")).equals("Y"))?"Yes":"NO"%> 
                    <br>
          ...
          <td> 
            <div id="top"> 
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr> 
                  <td width="9%" rowspan="2" align="center"><b>DebitCurrent month</b></td>
                ...
                <tr> 
                  ...
                  <td  width="10%" align="right">&nbsp;<%=Helper.correctDouble((String)hshValues.get("sanction_amount"))%>&nbsp;</td>
                  <td  width="10%" align="right">&nbsp;</td>
                  <td  width="10%" align="right">&nbsp;<%=Helper.correctDouble((String)hshValues.get("os_amount"))%>&nbsp;</td>
                  <td width="10%" align="right">&nbsp;<%=Helper.correctDouble((String)hshValues.get("excess_fundbasedoverdues"))%>&nbsp;</td>
                ...
                <tr> 
                  <td  width="3%" align="center">&nbsp;</td>
                  <td  width="17%" align="center"><b>Sub - Total</b></td>
                  <td  width="10%" align="right"><%=Helper.correctDouble((String)hshValues.get("nonfundbasedsanctionamout"))%>&nbsp;</td>
                  <td  width="10%" align="right">&nbsp;</td>
                  <td  width="10%" align="right">&nbsp;<%=Helper.correctDouble((String)hshValues.get("nonfundbasedos_amount"))%>&nbsp;</td>
                  <td width="10%" align="right">&nbsp;<%=Helper.correctNull((String)hshValues.get("excess_nonfundbasedoverdues"))%>&nbsp;</td>
                  <td width="10%" align="center">&nbsp;</td>
                  <td width="10%" align="left">&nbsp;</td>
                  <td width="10%" align="left">&nbsp;</td>
                  <td width="10%" align="left">&nbsp;</td>
                ...
                <tr> 
                  <td  width="3%" align="center">&nbsp;</td>
                  <td  width="17%" align="center">Grand - Total</td>
                  <td  width="10%" align="right"><%=Helper.correctDouble((String)hshValues.get("grandsanction_amount"))%>&nbsp;</td>
                  <td  width="10%" align="right">&nbsp;</td>
                  <td  width="10%" align="right"><%=Helper.correctDouble((String)hshValues.get("grandos_amount"))%>&nbsp;</td>
                  <td width="10%" align="right">&nbsp;<%=Helper.correctNull((String)hshValues.get("grand_overduestotal"))%>&nbsp;</td>
                  <td width="10%" align="center">&nbsp;</td>
                  <td width="10%" align="left">&nbsp;</td>
                  <td width="10%" align="left">&nbsp;</td>
                  <td width="10%" align="left">&nbsp;</td>
        ...
        <tr> 
          <td> 
            <div id="top"> 
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr> 
                  <td width="52%"><i><b>* Reasons for excess / overdue / irregular 
                    amount, whether reported to and ratified by higher office 
                    and steps initiated for adjustment to be furnished. </b></i></td>
                  <td width="48%">&nbsp;<%=Helper.correctNull((String)hshValues.get("gen_reasons"))%></td>
                </tr>
                <tr> 
                ...
                <tr> 
                  <td colspan="2">&nbsp; <b>Note : - Above details are directly 
                    captured from financle. The limits include sub limits (Within 
        ...
        <tr> 
          <td> 
            <div id="top"> 
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr> 
                  <td width="5%" height="28">a)</td>
                  <td width="61%" height="28">Interest on working capital recovered 
                    upto> <%=Helper.correctNull((String)hshValues.get("mon_recworkmonth"))%>.
                    Quantify arrears if any.</td>
                  <td width="34%" height="28" align="right">&nbsp;<%=Helper.correctNull((String)hshValues.get("mon_recworkvalue"))%>&nbsp;</td>
                </tr>
                <tr> 
                  <td width="5%" height="32">b)</td>
                  <td width="61%" height="32">Interest on Term Loan recovered 
                    upto <%=Helper.correctNull((String)hshValues.get("mon_rectermmonth"))%>. 
                    Quantify arrears if any. </td>
                  <td width="34%" height="32" align="right">&nbsp;<%=Helper.correctNull((String)hshValues.get("mon_rectermvalue"))%>&nbsp;</td>
                </tr>
                <tr> 
                  <td width="5%" height="28">c)</td>
                  <td width="61%" height="28">Term Loan installments recovered 
                    upto <%=Helper.correctNull((String)hshValues.get("mon_rectermins"))%>. 
                    Quantify arrears if any. </td>
                  <td width="34%" height="28" align="right">&nbsp;<%=Helper.correctNull((String)hshValues.get("mon_recterminsvalue"))%>&nbsp;</td>
                </tr>
                <tr> 
                  <td width="5%" height="40">d)</td>
                  <td width="61%" height="40">Age -wise break up of overdue 
                    bills</td>
                  <td width="34%" height="40" align="right">&nbsp;<%=Helper.correctNull((String)hshValues.get("mon_recage"))%>&nbsp;</td>
                </tr>
              </table>
			  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr> 
        ...
        <tr> 
          <td height="59"> 
            <div id="top"> 
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr> 
                  <td>Sales from 1st April upto the previous quarter</td>
                  <td>&nbsp;<%=Helper.correctNull((String)hshValues.get("mon_salesquarter"))%>&nbsp;</td>
                  <td>&nbsp;Rs&nbsp;<%=Helper.correctNull((String)hshValues.get("mon_salesamount"))%></td>
                </tr>
                <tr> 
                  <td colspan="3">&nbsp;</td>
                </tr>
                <tr> 
                  <td colspan="3"><b>Details of Unhedged foreign exchange exposure.</b></td>
                </tr>
                <tr> 
                  <td width="18%" colspan="2"><b>Nature</b></td>
                ...
                <%
                  ...
                  arrRow=(ArrayList)hshValues.get("arrRow1");
					...
					%>
                <tr> 
                  <td width="18%" colspan="2" height="2">&nbsp;<%=Helper.correctNull((String)arrCol.get(0))%></td>
                  <td width="17%" height="2" align="right">&nbsp;<%=Helper.correctNull((String)arrCol.get(1))%>&nbsp;</td>
                </tr>
                <%}}}%>
                <tr> 
                  <td colspan="3" height="2"><b>No.of days account remained in 
                    excess</b></td>
                </tr>
                <tr> 
                  <td width="18%" height="2">&nbsp;<b>Facility</b></td>
                  <td width="18%" height="2">&nbsp;<b>During the month</b></td>
                  <td width="17%" height="2">&nbsp;<b>From 1st April till current 
                    month</b></td>
                </tr>
                <%
			   
                  arrRow=(ArrayList)hshValues.get("arrRow7");
					...
					%>
                <tr> 
                  <td width="18%">&nbsp;<%=Helper.correctNull((String)arrCol.get(0))%></td>
        ...
        <tr> 
          <td><b>B -6. Details of Prime Securities: -</b></td>
        </tr>
        <tr> 
          <td> 
            <div id="top"> 
        ...
        <tr> 
          <td>B - 7. Details of Collateral Securities: - </td>
        </tr>
        <tr> 
          <td> 
            <div id="top"> 
          ...
          <td> 
            <div id="top"> 
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr> 
                  <td width="7%">3.</td>
                  <td width="60%">Whether adequate charges stipulated are registered 
                    with ROC </td>
          ...
          <td> 
            <div id="top"> 
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr> 
                  <td width="7%">1.</td>
                  <td width="60%">Are you satisfied with the operations in the 
                    account ?</td>
                ...
                <tr> 
                  ...
                  <td width="60%">Whether all the sanction stipulations including 
                    creation of EM / ROC are complied with. </td>
                ...
                <tr> 
                  ...
                  <td width="60%">Whether irregularities of earlier monitoring 
                    report observed by you and pointed out by RO /FGMO / CO are 
                    rectified. If not, reasons thereof.</td>
        ...
        <tr> 
          <td> 
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td>Nominated Officer</td>
                <td>Advances Incharge/Accountant </td>
                <td>Branch Head</td>
              </tr>
              <tr> 
