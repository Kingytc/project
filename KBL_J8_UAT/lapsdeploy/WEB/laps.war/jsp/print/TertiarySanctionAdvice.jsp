  ...
  <table border="1" width="100%" cellspacing="0" cellpadding="3" bordercolor="#999999">
        ...
        <table border="0" width="100%" cellspacing="0" cellpadding="0" bordercolor="#999999">
          ...
          <tr> 
            <td valign="top"><b>OCCUPATION:</b></td>
			 <td valign="top">
			<%
			if(cattype.equalsIgnoreCase("CORP") || cattype.equalsIgnoreCase("SME"))
			{
			String strCompanybsrcode=Helper.correctNull((String)hshValues.get("comapp_companyid"));
			String strBSRCODE[]=strCompanybsrcode.split("-");
			%>
           <b>"As per BSR Code" - </b><%=strBSRCODE[0]%> 
			<%}else{%>
			<%=Helper.correctNull((String)hshValues.get("comapp_companyid"))%>
			<%}%>
			&nbsp;</td>
          </tr>
    ...
    <tr> 
      <td valign="top"> 
        <table border="0" width="99%" cellspacing="0" cellpadding="0">
          ...
          <tr> 
            <td><b>DATE</b></td>
            <td ><b>AMOUNT</b>(Rs. in <%=strProposalvalue%>)</td>
          </tr>
          <tr> 
            <td align="left"><%=Helper.correctNull((String)hshValues.get("base_year"))%></td>
            <td align="center"><%=Helper.formatDoubleValue(Double.parseDouble(Helper.correctDouble((String)hshValues.get("TangibleNetworth"))))%></td>
          </tr>
        </table>
      </td>
      <td valign="top"> 
        ...
        <table border="0" width="99%" cellspacing="0" cellpadding="0">
          <tr> 
           ...
           <tr> 
            ...
            <td align="center"><b>AMOUNT</b>(Rs. in <%=strProposalvalue%>)</td>
          </tr>
          <tr> 
    ...
    <tr> 
      ...
      <td colspan="2" align="right">
      	<%if(cattype.equalsIgnoreCase("CORP") || cattype.equalsIgnoreCase("SME")){ %>
      		<b>(Rs. In <%=strProposalvalue%>)</b><%}else{ %>
      		<b>(Amt in Rs.)</b>
      		<%} %>
      		</td>
    </tr>
      ...
      <td colspan="3"> 
        <table width="100%" border="1" cellspacing="0" cellpadding="2" bordercolor="#999999">
          <tr valign="top"> 
            ...
            <td> <strong>SECURITY(GIVE BRIEF DETAILS)</strong> 
            </td>
          </tr>
          <%     
          ...
          <tr>
          	...
          	<td width="5%" valign="top" rowspan="<%=introwspan%>">
				...
				%>
				&nbsp;<%=Helper.formatDoubleValue(Double.parseDouble(Helper.correctDouble((String)TL_Funded_NonFunded.get(11))))%>
				<%}%>
			</td>
...
//For the Sub-limits, under each one
            	...
            	<tr>
            		...
            		<td width="5%" valign="top" rowspan="<%=intsubtrowspan%>">
						 	...
						 	<%} else {%>
						 	&nbsp;<%=Helper.formatDoubleValue(Double.parseDouble(Helper.correctDouble((String)arrSubFacRecords.get(11))))%>
						 	<%} %>
					</td>
    ...
    <tr> 
      ...
      <td colspan="2" valign="top"><strong>Terms &amp; Conditions:</strong></td>
    </tr>
    <tr> 
      <td> 
        <table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#999999">
          <tr> 
            <td><b>Name</b></td>
            <td><b>Means&nbsp;(Rs. In <%=strProposalvalue%>)</b></td>
          ...
          %>
           <tr> 
            <td nowrap><%=Helper.correctNull((String) hshValues
									.get("comapp_companyname"))%>&nbsp;</td>
            <td><%=Helper.formatDoubleValue(Double.parseDouble(Helper.correctDouble((String) hshValues.get("TangibleNetworth"))))%></td>
            <td nowrap><%=Helper.correctNull((String) hshValues
									.get("meansason"))%>&nbsp;</td>
          </tr>
          <%} %>
          ...
          <tr> 
            <td nowrap><%=Helper.correctNull((String)arrCol.get(0))%>&nbsp;</td>
            <td><%=Helper.formatDoubleValue(dbMeans)%></td>
            <td nowrap><%=Helper.correctNull((String)arrCol.get(3))%>&nbsp;</td>
          </tr>
          <%	}
                	}
						}
					...
					if(cattype!=null)
					{
						...
						{
		                double dbMeans=0.00;
		                arrRow=(ArrayList)hshValues.get("arrRow4");
				  		if(arrRow!=null && arrRow.size()>0)
							{
								int size=0;
								size=arrRow.size();
								...
								{
									arrCol=(ArrayList)arrRow.get(i);
									dbMeans=Double.parseDouble(Helper.correctDouble(Helper.correctNull((String)arrCol.get(8))));%>
          <tr> 
            <td nowrap><%=Helper.correctNull((String)arrCol.get(0))%>&nbsp;</td>
            <td><%=Helper.formatDoubleValue(dbMeans)%></td>
            <td nowrap><%=Helper.correctNull((String)arrCol.get(9))%>&nbsp;</td>
          </tr>
          <%	}
                	}
						}
      ...
      <table border="1" width="100%" bordercolor="#999999" cellspacing="0" >
        <tr> 
          <td width="29%" colspan="2" align="center"><strong>Authorised Signatory</strong></td>
          <td width="48%"></td>
          <td width="25%" colspan="2"> <strong>&nbsp; Authorised Signatory</strong> 
          </td>
        </tr>
        <tr> 
