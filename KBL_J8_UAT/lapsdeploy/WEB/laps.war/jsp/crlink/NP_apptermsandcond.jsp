...
function callhelp()
{
	...
	function setData()
	{
		...
		disableButton(false,false,true,true,false,false);
...
function doNew()
	...
	function doApply()
	{
		...
		document.forms[0].hidSourceUrl.value="/action/NP_apptermsandcond.jsp";
	...
	var url = "<%=ApplicationParams.getAppUrl()%>action/apptermsandcondexcep.jsp?appno="+appno+"&hidBeanId=apptermscond&hidBeanGetMethod=getDeletedTerms&hidAction=Retail&hidPageValue=Retail&sel_termstype=B&hidPageName=B";
...
<body class="bgcolor" text="#000000" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onLoad = "disablebutton();branchUserCheck();funEDappstatusnew()" >
<form name="frm1" method="post" >
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      <td height="20" class="outertablecolor"> 
        <table width="50%" border="0" cellspacing="3" cellpadding="3" align="left">
          <tr align="center"> 
            <td width="25%" class="tabinactive"><b><font size="1" face="MS Sans Serif"><a href="javascript:callBorrowerTerms()" class="blackfont">Terms &amp; Conditions For Borrower </a></font></b></td>
            <td width="25%" class="tabactive"><b><font size="1" face="MS Sans Serif" color="#FFFFFF">Terms &amp; Conditions For Branch</font></b></td>
                ...
                <tr> 
                  ...
                  <div Class = "cellContainer">
                    <table width="100%" border="0" cellspacing="1" cellpadding="3" align="center">
                      ...
                      if(arrTermId.size() > 0 && arrTermId !=null)
                      {
                      for(int i=0;i<arrTermId.size();i++)
					  {
						  if(Helper.correctNull((String)arrTermsFor.get(0)).trim().equalsIgnoreCase("B"))
						  {
					  %> 
                      <tr bgcolor="#FFFFFF"> 
                        <td width="3%"> 
  ...
  <INPUT TYPE="hidden" name="hidCoDemoId" value="<%=Helper.correctNull(request.getParameter("hidCoDemoId"))%>" >
  <INPUT TYPE="hidden" name="hidDemoId" value="<%=Helper.correctNull(request.getParameter("hidDemoId"))%>">
  <INPUT TYPE="hidden" name="hidGuaDemoId" value="<%=Helper.correctNull(request.getParameter("hidGuaDemoId"))%>">
...
<input type="hidden" name="hidPageName" value="B">
</form>
</body>
</html>
