...
//out.println("lib_total_amount=="+lib_total_amount);
	...
	if (SegType.equals("")) {
		SegType = Helper.correctNull((String) session.getAttribute("strapprefid"));
	}
	...
	var varLength = document.forms[1].radval_dynarow.length;
	 if(varLength>1){	 	
	 	for(var i=0;i<varLength;i++){
	 		...
	 		/*if(document.forms[1].txt_tot_disb[i].value== ""){
	 			alert("Total Disbursement Can Not Be Empty.");
	 			document.forms[1].txt_tot_disb[i].focus();
	 			return;
	 		}*/
	 	}
	 }else{ 
		 ...
		 if(document.forms[1].txt_date.value==""){
	 		...
	 		/*if(document.forms[1].txt_tot_disb.value== ""){
	 			alert("Total Disbursement Can Not Be Empty.");
	 			document.forms[1].txt_tot_disb.focus();
	 			return;
	 		}*/
	 }
	 	//	document.forms[1].hidappno.value="<%=Helper.correctNull((String)hshValues.get("hidApplicationNo"))%>";
			...
			document.forms[1].hidSourceUrl.value="/action/np_disbursement.jsp";
...
function callupdate(){
	...
	alert("once disbursemt details Uploaded to online protal, it cannot be mofdifired plz ensure corrected data");
	document.forms[1].cmdupdate.disabled = true;
	document.forms[1].hidBeanId.value="NationalPortal";
	document.forms[1].hidBeanGetMethod.value="invokeUpdateDsibursmentAPI";
	document.forms[1].action = appURL+"action/np_disbursement.jsp";
	document.forms[1].submit();
}
</script>
<link rel="stylesheet" href="<%=ApplicationParams.getAppUrl()%>css/style.css" type="text/css">
...
<tr class="dataheader" align="center">
	...
	<tr class="datagrid">
		...
		<tr height="30px">
				...
				<td><%=request.getParameter("hidApplicantId")%></td>
				<td><b>Scheme</b></td>
				<td><%=request.getParameter("hidschemeName")%></td>
			</tr>
		</table>
		</td></tr>
		<!-- <tr>
					...
					<tr>
						...
						<tr class="">
							...
							<td width="5%"><input type="text" name="txt_disb_amt" style="width: 100%;" title="disbursement_amount"
							    id="txt_disb_amt_<%=i %>" value="<%=arrayChild.get(3)%>" onkeypress="allowInteger('this')"></td>
							<td width="5%"><select name="mode" style="width: 100%;" title="mode" id="mode_<%=i %>">
					          <option value="s">--Select--</option>
					          <option value="RTGS">RTGS</option>
					          <option value="NEFT">NEFT</option>
					          <option value="CHEQUE">CHEQUE</option>
					          <option value="CHEQUE">SAVING TRANSFER</option>
							...
							<td width="5%"><input type="text" name="txt_emi" style="width: 100%;" title="emi"
								id="txt_emi_<%=i %>" value="<%=arrayChild.get(6)%>" onkeypress="allowInteger('this')"></td>
							...
							<td width="5%"><input type="text" name="txt_tenure" style="width: 100%;" title="tenure"
								id="txt_tenure_<%=i %>" value="<%=arrayChild.get(9)%>" onkeypress="allowInteger('this')"></td>
						...
						<tr class="">
							...
							<td width="5%"><input type="text" name="txt_disb_amt" style="width: 100%;" title="disbursement_amount"
								id="txt_disb_amt_<%=j %>" value="" onkeypress="allowInteger('this')"></td>
							...
							<td width="5%"><input type="text" name="txt_emi" style="width: 100%;" title="emi"
								id="txt_emi_<%=j %>" value="" onkeypress="allowInteger('this')"></td>
							...
							<td width="5%"><input type="text" name="txt_tenure" style="width: 100%;" title="tenure"
								id="txt_tenure_<%=j %>" value="" onkeypress="allowInteger('this')"></td>
							<!-- <td width="5%"><input type="text" name="txt_tot_disb" style="width: 100%;" title="total_disb"
								id="txt_tot_disb_<%=j %>" value="" onkeypress="allowInteger('this')"></td> -->
						</tr>
						<%} }%>
					</table>
					</td>
...
<table border="0" cellspacing="0" cellpadding="0"  align="center">
      ...
      <td>  
        ...
        <td>  
            <input type="button" name="cmdupdate" value="Authorize" style="background-color:#CC3300;font-weight:bold;color:white;font-size=10;font-family:mssansserif;width:50" onClick="callupdate()"> 
        </td>
        <!-- <td>  
    ...
    <input type="hidden" name="hidAppStatus" value="">
     <input type="hidden" name="hidsegtype" value="<%=SegType%>">
      <input type="hidden" name="hidAction" value="">
       <input type="text" name="hidapplino" value="<%=Helper.correctNull((String)hshValues.get("app_no"))%>">
