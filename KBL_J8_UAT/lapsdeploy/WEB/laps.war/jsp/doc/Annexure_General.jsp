...
<body>
		...
		<div id="top">
			<table width="98%" border="0" cellspacing="0" cellpadding="3" class="outertable" align="center">
						...
						<tr>
							<td width= "20%">Manager Contact no:</td>
			...
			<table width="98%" border="0" cellspacing="0" cellpadding="3" class="outertable" align="center">
				<tr>
					<td> <b> Reg:  Permission sought to entertain the loan proposal from &nbsp;<u><%=Helper.correctNull((String) hshValues.get("PG_APPLIANTNAME"))%></u>&nbsp;
...
<tr>
				...
				<div id="top">
					...
					%>	
						<tr>
							...
							<td>&nbsp;<%=arrCol5.get(2)%></td>
							<td>&nbsp;<%=nf.format(Double.parseDouble(Helper.correctDouble((String)arrCol5.get(5))))%></td>
							<td>&nbsp;<%=arrCol5.get(6)%></td>
						...
						<td colspan="3" style="border: none;" align="right">&nbsp;</td>
		    ...
		    <tr>	
				...
				<div id="top">
							...
							<tr class="tblhead">
								...
								<td width="18%" align="center"><b>Name of the Bank</b></td>
								<td width="18%" align="center"><b>Facility</b></td>
								<td width="18%" align="center"><b>Limit</b></td>
								<td width="18%" align="center"><b>Due Date</b></td>
								<td width="25%" align="center"><b>Arrears if any</b></td>
							</tr>
							<% 
			...
			<table width="98%" border="0" cellspacing="0" cellpadding="3" class="outertable" align="center">
					...
					<%if(strpermissionfalg.equalsIgnoreCase("Y")){%>
						<td   width="50%">Hunter Score</td>
				        <td  ><%=Helper.correctNull((String) hshValues.get("intHuntScore1"))%></td>
					<%} %>
					</tr>	
					<tr>
						<td width="50%">Last two years Income as per IT Returns (if joint applicants, furnish the same separately)</td>
						<td >&nbsp;<%=Helper.correctNull((String) hshValues.get("PG_ITRETURNS_TAXPAID"))%></td>
					</tr>
					<tr>
						<td width="50%">Policy/Scheme Guidelines</td>
						<td><%=Helper.correctNull((String) hshValues.get("PG_SCHEME_GUIDELINES"))%>&nbsp;</td>
					</tr>
					<tr>
						<td width="50%">Permission sought for</td>
						<td>&nbsp;<%=Helper.correctNull((String) hshValues.get("PG_DEVPERM_SOUGHTOTHERS"))%></td>
					</tr>
					<tr>
						<td width="50%">Background of the applicant</td>
						<td>&nbsp;<%=Helper.correctNull((String) hshValues.get("strBkgroundcmts"))%></td>
					</tr>
					<tr>
						<td width="50%">Justification by the Branch for specific consideration:</td>
						<td>&nbsp;<%=Helper.correctNull((String) hshValues.get("PG_CONCESSION_JUSTIF"))%></td>
					</tr>
					<tr>
						<td width="50%">Any other information</td>
						<td>&nbsp;<%=Helper.correctNull((String) hshValues.get("PG_ANYOTHER_INFO"))%></td>
					</tr>
					<tr>
						<td width="50%">Recommendation by the Branch/RLPC</td>
						<td>&nbsp;<%=Helper.correctNull((String) hshValues.get("PG_RECOMMEND_BRANCH"))%></td>
					</tr>
					<tr>
						<td width="50%">Sanction Department view</td>
						<td>&nbsp;<%=Helper.correctNull((String) hshValues.get("PG_RECOMMEND_HOVIEW"))%></td>
					</tr>
					<tr>
						<td width="50%">Sanction Department Recommendation</td>
						<td>&nbsp;<%=Helper.correctNull((String) hshValues.get("PG_RECOMMEND_HO"))%></td>
					</tr>
					<tr>
					<td colspan="2">
