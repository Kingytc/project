...
{  
	if(ConfirmMsg(102))
	{
		...
		document.forms[0].action=appUrl +"action/npa_suitsignatories.jsp";
...
if(ConfirmMsg(101))
	{	
		...
		document.forms[0].hidSourceUrl.value="/action/npa_suitsignatories.jsp";
		document.forms[0].hidBeanId.value="npacommon";
	...
	<tr>
		<td>
			<table width="100%" border="0" cellspacing="0" cellpadding="0" align="left" class="outertable">
				<tr>
					<td>
						<lapstab:suiturltag pageid="13"/>
					</td>
				</tr>
				  <tr> 
           <td valign="top" class="page_flow">Home 
				-&gt; NPA-&gt; Suit File -&gt; Signatories  
 </td>
          </tr>
          <tr>
