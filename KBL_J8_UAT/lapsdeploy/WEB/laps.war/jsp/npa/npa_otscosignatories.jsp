...
{  
	if(ConfirmMsg(102))
	{
		...
		document.forms[0].action=appUrl +"action/npa_otscosignatories.jsp";
...
if(ConfirmMsg(101))
	{	
		...
		document.forms[0].hidSourceUrl.value="/action/npa_otscosignatories.jsp";
		document.forms[0].hidBeanId.value="npacommon";
...
<table width="100%" border="0" cellspacing="0" cellpadding="0"
	...
	<tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
			...
			<tr>
				<td><lapstab:otscourltag pageid="13" /></td>
			</tr>
			<tr>
				<td valign="top" class="page_flow">Home -&gt; NPA-&gt; Compromise
				Proposal -&gt; Signatories</td>
			</tr>
			<tr>
	...
	<tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="4" class="outertable">
			<tr>
				...
				<td><input type="text" name="txt_refno"
					value="<%=Helper.correctNull((String)hshValues.get("refno"))%>"
					size="25" maxlength="25"></td>
				<td><b>Date of Compromise Proposal</b></td>
				<td><input type="text" name="txt_propdate"
					value="<%=Helper.correctNull((String)hshValues.get("propdate"))%>"
					size="12" maxlength="10"> <a alt="Select date from calender"
					href="javascript:callCalender('txt_propdate')"> <img
					src="<%=ApplicationParams.getAppUrl()%>img/calen.gif" border="0"></a></td>

			</tr>
			<tr>
				<td width="31%">Sanctioning Authority</td>
				<td width="21%"><select name="selsancauth"
					onChange="changemcmdetails()">
			...
			<tr id="idmcm">
				...
				<td valign="top"><input type="text" name="txt_agenda" size="15"
					maxlength="10"
					value="<%=Helper.correctNull((String)hshValues.get("agendano"))%>"
					onKeyPress="notAllowSplChar()"></td>
				<td valign="top">MCM of &nbsp;</td>
				<td valign="top"><input type="text" name="txt_mcmof" size="12"
					maxlength="10"
					value="<%=Helper.correctNull((String)hshValues.get("mcmof"))%>"> <a
					alt="Select date from calender"
					href="javascript:callCalender('txt_mcmof')"> <img
					src="<%=ApplicationParams.getAppUrl()%>img/calen.gif" border="0"></a></td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="4"><textarea name="txt_mcmresolution" cols="95"
					rows="7" onKeyUp="textlimit(this,3999)"
					onKeyPress="textlimit(this,3999)"><%=Helper.correctNull((String) hshValues
							.get("mcmresolution"))%></textarea>
				</td>
			...
			<tr>
				<td colspan="4"><textarea name="txt_commobservations" size="40"
					cols="95" rows="5" onKeyUp="textlimit(this,3999)"
					onKeyPress="textlimit(this,3999)"><%=Helper.correctNull((String) hshValues
							.get("commobservations"))%></textarea>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="4"><textarea name="txt_signatures" cols="95" rows="10"
