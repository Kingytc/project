...
{  
	if(ConfirmMsg(102))
	{
		...
		document.forms[0].hidSourceUrl.value="/action/npa_othermulbankdues.jsp";
...
function selectValues(val1,val2,val3,val4,val5)
{
	...
	document.forms[0].status.value=val5;
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="outertable">
	<tr>
		...
		Prudential Write Off -&gt; General -&gt; Multiple Banking</td>
	</tr>
</table>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
		<td valign="top" class='page_flow'>Home -&gt; NPA-&gt;
		Status Note -&gt; General -&gt; Multiple Banking</td>
	</tr>
</table>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
		<td valign="top" class='page_flow'>Home -&gt; NPA-&gt;
		Suit File  -&gt; General -&gt; Multiple Banking</td>
	</tr>
</table>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="outertable">
	<tr>
		<td valign="top" class='page_flow'>Home -&gt; NPA-&gt;
		Sarfaesi Proposal  -&gt; General -&gt; Multiple Banking</td>
	</tr>
</table>
<%} %>
...
<lapstab:npabankingdetails module='<%=Helper.correctNull((String)request.getParameter("hidmoduletype"))%>' pageid="2" bankarrangement='<%=Helper.correctNull((String)request.getParameter("hidbankarrangement"))%>'/>
<table width="100%" border="0" cellspacing="0" cellpadding="4"
	class="outertable border1">
	<tr>
		<td><b>Name of Bank</b></td>
		<td><input type="text" name="txt_consortium" size="35" maxlength="30" tabindex="10"></td>
	...
	<tr>
		...
		<td><lapschoice:CurrencyTag name="txt_present_outstanding" size="25" tabindex="12" maxlength="15" /></td>
            ...
            <td valign="top"> 
              <div align="left"> 
                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="outertable linebor">
                  <tr class="dataheader"> 
                    <td width="3%" >&nbsp;</td>
                    <td width="17%"  align="center">Name of the Bank</td>
