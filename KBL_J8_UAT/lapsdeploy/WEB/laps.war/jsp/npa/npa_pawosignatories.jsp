...
{  
	if(ConfirmMsg(102))
	{
		...
		document.forms[0].action=appURL +"action/npa_pawosignatories.jsp";
...
if(ConfirmMsg(101))
	{	
		...
		document.forms[0].hidSourceUrl.value="/action/npa_pawosignatories.jsp";
		document.forms[0].hidBeanId.value="npacommon";
	...
	<tr>
		<td>
			<table width="100%" border="0" cellspacing="0" cellpadding="0" align="left" class="outertable">
				<tr>
					<td>
						<lapstab:pwourltag pageid="9"/>
					</td>
				</tr>
				 <tr> 
           <td valign="top" class="page_flow">Home 
				-&gt; NPA-&gt; Write Off -&gt; Signatories  
 </td>
          </tr>
          <tr>
