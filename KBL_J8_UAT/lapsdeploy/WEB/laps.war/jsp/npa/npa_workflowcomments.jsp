...
function doSave()
{
	...
	else
	{
		...
		document.forms[0].hidBeanMethod.value="updateNPAMailComments";
		document.forms[0].hidBeanGetMethod.value="getNPAMailComments";
		document.forms[0].hidSourceUrl.value="/action/npa_workflowcomments.jsp";
                ...
                <tr> 
                  <td> 
                    <table width="100%" border="0" cellspacing="0" cellpadding="3" class="outertable">
                      ...
                      <tr> 
                        <td align="center"> 
                            <textarea name="comments" cols="100" wrap="VIRTUAL" rows="8" onKeyPress="textlimit(this,1950)" onKeyUp="textlimit(this,1950)" disabled></textarea>
                        </td>
                      </tr>
                    </table>
                  </td>
...
<input type="hidden" name="hidmoduletype" value="<%=request.getParameter("hidmoduletype")%>">
<input type="hidden" name="borrowername" value="<%=request.getParameter("borrowername")%>">
