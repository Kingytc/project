...
<% 
	...
	String exec_sno=Helper.correctNull((String)session.getAttribute("strExecSno"));
...
function callPage1(id,name,org)
{
	if(id!="")
	{
		...
		document.forms[0].action="<%=ApplicationParams.getAppUrl()%>action/npaaccountdetails.jsp";
