...
String strsecID = Helper.correctNull((String) request.getParameter("hidsecid"));
	...
	arrtempRow=(ArrayList)hshValues.get("arrsec_valuerlist");
...
<% if(!strPagefrom.equals("secmailbox")) { %>
...
<tr>
	<td class="page_flow" colspan="2">Home -&gt; Retail -&gt; Application -&gt; Security Master -&gt; Security Details</td>
</tr>
</table>
	...
	<tr>
		...
		<td>Valuer Name</td>
						<td><input type="text" name="txt_Valuers_name" size="30" maxlength="29"
												...
												<b><span onClick="" style="cursor: hand"><font
		...
		<tr>
				<% if(arrtempRow.size()>0) { %>
		<td colspan="2"> 
		<table width="95%" border="0" cellspacing="1" cellpadding="3" class="outertable border1" align="center" >		
				<tr class="dataheader" align="center">
					<td colspan="6"> Valuer List</td>
				</tr>	
				<tr class="dataheader" align="center">
				...
				<% for(int i=0;i<arrtempRow.size();i++) 
				{ 
					arrtempcol=(ArrayList)arrtempRow.get(i);
				%>			
				<tr class="datagrid"  >
					<td width="20%"><%=arrtempcol.get(0)%></td>
					<td width="20%" align="char"><%=arrtempcol.get(1)%></td>
					<td width="20%" align="center"><%=arrtempcol.get(2)%></td>
					<td width="20%" align="center"><%=arrtempcol.get(3)%></td>
					<td width="10%" align="right"><%=arrtempcol.get(4)%></td>
					<td width="10%" align="center"><%=arrtempcol.get(5)%></td>
				</tr>
				<% } %>
			</table>
		 </td>
		...
		<td colspan="2">
		<table id="id_jointsec" width="45%" border="0" cellspacing="1" cellpadding="3" class="outertable" align="right" >		
				<tr>
					<td colspan="5">Joint holders</td>
				</tr>
				<tr class="dataheader">
					<td width="0%">&nbsp;</td>
