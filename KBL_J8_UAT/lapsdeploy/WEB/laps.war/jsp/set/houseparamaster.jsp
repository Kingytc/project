...
{	
	...
	document.forms[0].hidSourceUrl.value="/action/houseparamaster.jsp";
...
function doCancel()
{
	...
	if(varconfirm)
	{
		document.forms[0].hidBeanId.value="staticdata";
		document.forms[0].hidBeanGetMethod.value="getDataHouseParameters";
		document.forms[0].action=appURL+"action/houseparamaster.jsp";	
		document.forms[0].submit();
	}
}
								...
								class="outertable"	>
									...
									<tr>
										...
										<td align="center" nowrap><input type="text"
											name="txt_noofyears" size="15" maxlength="10" tabindex="17"
											value="<%=Helper.correctNull((String)g2.get(3))%>"
...
<input type="hidden" name="hidfrom" value="HP">
