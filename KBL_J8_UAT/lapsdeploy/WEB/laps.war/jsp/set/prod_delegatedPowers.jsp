...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="outertable">
	<tr>
		...
		-&gt; Setup -&gt; Retail &amp; Agriculture Products -&gt; Delegated Powers </td>
	</tr>
</table>
<br>
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="outertable">
   <tr> 
       <td>Bank's Scheme&nbsp;<b><span class="mantatory">*</span></b></td>
		<td colspan="3"><select name="sel_bankscheme" style="width:465px;" onchange="callScheme()">
 ...
 <lapschoice:hiddentag pageid='<%=PageId%>'/>
  ...
  <input type="hidden" name="hideditflag">
    <input type="hidden" name="hidPage" value="Delegate">
