...
var varFACILITY_PROPOSEDValue= "<%=FACILITY_PROPOSEDValue%>";
function onload()
{
	...
	<% if(arrColFacID != null && arrColFacID.size()>0) 
	{
		for(int i=0;i<vecData.size();i++)
		{
			...
			String facID=Helper.correctNull((String)vecFacID.get(3));
			...
			for(int j=0;j<arrColFacID.size();j++)
			{
				...
				String strarrFacID=Helper.correctNull((String)arrFacID.get(7));
		...
		%>			
					...
					{
					%>
					document.forms[0].hidparentappno.value="<%=Helper.correctInt((String)vecFacID.get(10))%>";
					document.forms[0].hidparentsno.value="<%=Helper.correctInt((String)vecFacID.get(11))%>";
				...
				<%}if(Helper.correctNull((String)vecFacID.get(9)).equalsIgnoreCase("Y")||(strsectype.equalsIgnoreCase("2") &&
						!Helper.correctNull((String)vecFacID.get(24)).equalsIgnoreCase("0")))
				{
			%>
			...
			<% if(vecData != null && vecData.size()>0) 
			{
				for(int i=0;i<vecData.size();i++)
				{
					...
					{
						if(Helper.correctNull((String)vecFacID.get(9)).equalsIgnoreCase("Y")|| 
								Helper.correctNull((String)vecFacID.get(8)).equalsIgnoreCase("E") ||
								(Helper.correctNull((String)vecFacID.get(16)).equalsIgnoreCase("Y") && (Helper.correctNull((String)vecFacID.get(17)).equalsIgnoreCase("Y")||
										Helper.correctNull((String)vecFacID.get(19)).equalsIgnoreCase("N"))))
						{
						%>
						document.forms[0].chk_facility.disabled=true;
						document.forms[0].txt_margin.disabled=true;
								...
								Helper.correctNull((String)vecFacID.get(19)).equalsIgnoreCase("N"))))
				{
					...
					{
					%>
					document.forms[0].hidparentappno["<%=i%>"].value="<%=Helper.correctInt((String)vecFacID.get(10))%>";
					document.forms[0].hidparentsno["<%=i%>"].value="<%=Helper.correctInt((String)vecFacID.get(11))%>";
				...
				<% if(vecData != null && vecData.size()>0) 
				{
					for(int i=0;i<vecData.size();i++)
					{
						...
						<%if(Helper.correctNull((String)vecFacID.get(8)).equalsIgnoreCase("P")&& Helper.correctNull((String)session.getAttribute("strAppType")).equalsIgnoreCase("P")){%>
							...
							document.forms[0].sel_Securitytype.disabled=true;
							document.forms[0].chk_facility.disabled=true;
							<%if(Helper.correctNull((String)vecFacID.get(13)).contains("@LAD@")||Helper.correctNull((String)vecFacID.get(13)).contains("@SUBLIMIT@")
									||Helper.correctNull((String)vecFacID.get(13)).contains("@SEC@")){%>
							...
							<%if(Helper.correctNull((String)vecFacID.get(13)).contains("@MODSEC@")){%>
								...
								document.forms[0].txt_margin.readOnly=false;
							<%}%>
							<%if(Helper.correctNull((String)vecFacID.get(13)).contains("MARGIN")){%>
								document.forms[0].txt_margin.readOnly=false;
							<%}
						 if(!Helper.correctNull((String)vecFacID.get(13)).equalsIgnoreCase("4") && Helper.correctNull((String)vecFacID.get(13)).equalsIgnoreCase(""))
							{%>
							document.forms[0].txt_margin.readOnly=false;
							document.forms[0].sel_sectype.disabled=false;
							document.forms[0].sel_Securitytype.disabled=false;
					...
					<%if(Helper.correctNull((String)vecFacID.get(8)).equalsIgnoreCase("P")){%>
						if(document.forms[0].sel_sectype.value=="1")
						   ...
						   <%}%>
						   <%if(Helper.correctNull((String)vecFacID.get(14)).equalsIgnoreCase("N")){%>
						   document.forms[0].txt_margin.readOnly=true;
							document.forms[0].sel_sectype.disabled=true;
							document.forms[0].sel_Securitytype.disabled=true;
							document.forms[0].chk_facility.disabled=true;
						 ...
						 <%if(Helper.correctNull((String)vecFacID.get(8)).equalsIgnoreCase("P") && Helper.correctNull((String)session.getAttribute("strAppType")).equalsIgnoreCase("P")){%>
							...
							document.forms[0].sel_Securitytype[<%=i%>].disabled=true;
							document.forms[0].chk_facility[<%=i%>].disabled=true;
							 <%if(Helper.correctNull((String)vecFacID.get(13)).contains("@SEC@")||Helper.correctNull((String)vecFacID.get(13)).contains("@SEC@")
									 ||Helper.correctNull((String)vecFacID.get(13)).contains("@SEC@")){%>
						 ...
						 if(!Helper.correctNull((String)vecFacID.get(13)).equalsIgnoreCase("4") && Helper.correctNull((String)vecFacID.get(13)).equalsIgnoreCase(""))
							...
							<%}}%>
							<%if(Helper.correctNull((String)vecFacID.get(8)).equalsIgnoreCase("P")){%>
							if(document.forms[0].sel_sectype[<%=i%>].value=="1")
						    {
...
function checkSecurity()
{
			...
			{%>
				if(document.forms[0].chk_facility["<%=l%>"].checked==true)
				{
					...
					{%>
						...
						document.forms[0].hid_proposedtype["<%=l%>"].value="<%=Helper.correctNull((String)vecRow.get(8))%>";
					<%}%>
				}
			<%}
		}
		...
		{%>
			if(document.forms[0].chk_facility.checked==true)
			{
				...
				{%>
					...
					document.forms[0].hid_proposedtype.value="<%=Helper.correctNull((String)vecRow.get(8))%>";
	...
	//window.opener.document.forms[0].hidFacID.value=sec;
}
function hideMargin(sno)
{
	<%if(intVecSize>1)
    { %>
    if(document.forms[0].chk_facility[sno].checked && document.forms[0].hidFacgroup[sno].value!="0")
	{
    ...
    if(document.forms[0].chk_facility.checked && document.forms[0].hidFacgroup.value!="0")
	{
    ...
    <%}%>
	    ...
	    { %>
			if(document.forms[0].sel_sectype.value=="2")
			{
				if(document.forms[0].txt_CGTMSEFLAG.value=="Y")
				{
	    ...
	    { %>
			if(document.forms[0].sel_sectype[sno].value=="2")
			{
				if(document.forms[0].txt_CGTMSEFLAG[sno].value=="Y")
				{
					alert("Collateral security cannot be added if the facility is covered under CGTMSE");
					document.forms[0].sel_sectype[sno].value="0";
...
function doSave()
{
	if(document.forms[0].chk_facility.length >1)
	{
		...
		{
			for(var j=0;j<document.forms[0].chk_facility.length;j++)
			{
					if(document.forms[0].hidBasesno[j].value==document.forms[0].hidFacilitySno[i].value && document.forms[0].hidBaseappno[j].value==document.forms[0].appno.value)
					{
						if(document.forms[0].chk_facility[i].checked==true)
						{
							document.forms[0].chk_facility[j].checked=true;
							document.forms[0].sel_sectype[j].value=document.forms[0].sel_sectype[i].value;
							document.forms[0].txt_margin[j].value=document.forms[0].txt_margin[i].value;
							document.forms[0].sel_Securitytype[j].value=document.forms[0].sel_Securitytype[i].value;
						}
					}
					if(document.forms[0].hidFacgroup[j].value==document.forms[0].hidFacilitySno[i].value && document.forms[0].txt_type[j].value=="P")
					{
						if(document.forms[0].sel_sectype[i].value=="2")
						{
							...
							{
								document.forms[0].chk_facility[j].checked=false;
								document.forms[0].sel_sectype[j].value=="0";
								document.forms[0].txt_margin[j].value="";
								document.forms[0].sel_Securitytype[j].value="S";
							}
						}
						else
						{
							if(document.forms[0].chk_facility[j].checked && document.forms[0].sel_sectype[j].value=="2")
							{
								document.forms[0].chk_facility[j].checked=false;
								document.forms[0].sel_sectype[j].value=="0";
								document.forms[0].txt_margin[j].value="";
	...
	if(document.forms[0].chk_facility.length >1)
	{
		for(var i=0;i<document.forms[0].chk_facility.length;i++)
		{
				if(document.forms[0].chk_facility[i].checked && document.forms[0].sel_sectype[i].value=="0" && document.forms[0].hid_proposedtype[i].value=="P")
				{
					alert("Select Type");
					document.forms[0].sel_sectype[i].focus();
					return;
				}
				if(document.forms[0].chk_facility[i].checked && document.forms[0].sel_sectype[i].value=="1" && 
						(document.forms[0].txt_margin[i].value=="" || document.forms[0].txt_margin[i].value=="0.00" )&& document.forms[0].hid_proposedtype[i].value=="P")
				{
					alert("Enter Margin Value");
					document.forms[0].txt_margin[i].focus();
					return;
				}
				if(document.forms[0].chk_facility[i].checked && document.forms[0].sel_Securitytype[i].value=="S" && document.forms[0].hid_proposedtype[i].value=="P")
				{
	...
	{
			if(document.forms[0].chk_facility.checked && document.forms[0].sel_sectype.value=="0" && document.forms[0].hid_proposedtype.value=="P")
			{
				alert("Select Type");
				document.forms[0].sel_sectype.focus();
				return;
			}
			if(document.forms[0].chk_facility.checked && document.forms[0].sel_sectype.value=="1" && document.forms[0].txt_margin.value=="" && document.forms[0].hid_proposedtype.value=="P")
			{
				alert("Enter Margin Value");
				document.forms[0].txt_margin.focus();
				return;
			}
			if(document.forms[0].chk_facility.checked && document.forms[0].sel_Securitytype.value=="S" && document.forms[0].hid_proposedtype.value=="P")
			{
				alert("Select Security Type");
	...
	<%if(Securitycount.equalsIgnoreCase("1")){%>
...
function chkenablefield(sno)
{
    ...
    { %>
		...
		else
		{
			...
			document.forms[0].txt_margin.value="";
			document.forms[0].sel_sectype.value="0";
			document.forms[0].sel_Securitytype.value="S";
		}
	<%}
    else
    { %>
	    if(document.forms[0].chk_facility[sno].checked==true)
		{    
		...
		{
			document.forms[0].txt_margin[sno].readOnly=true;
			document.forms[0].sel_sectype[sno].disabled=true;
			document.forms[0].sel_Securitytype[sno].disabled=true;
			document.forms[0].txt_margin[sno].value="";
			document.forms[0].sel_sectype[sno].value="0";
			document.forms[0].sel_Securitytype[sno].value="S";
...
function fncopySecurity(Val21,Val22,Val23,Val24,obj,sno)
{
	if(Val23=="R")
	{
		 	if(document.forms[0].chk_facility.length >1)
			{
				for(var i=0;i<document.forms[0].chk_facility.length;i++)
				{
						if(document.forms[0].hidBasesno[i].value==Val24 && document.forms[0].hidBaseappno[i].value==document.forms[0].appno.value)
						{
							if(obj.checked==true)
							{
								document.forms[0].chk_facility[i].checked=true;
							...
							{
								document.forms[0].chk_facility[i].checked=false;
							}
						}
				}
			}
	}
	else if(Val23=="A"||Val23=="D")
	{
		if(document.forms[0].chk_facility.length >1)
		{
			for(var i=0;i<document.forms[0].chk_facility.length;i++)
			{
					if(document.forms[0].hidFacilitySno[i].value==Val22 && Val21==document.forms[0].appno.value)
					{
						if(document.forms[0].chk_facility[i].checked==true)
						{
							obj.checked=true;
    ...
    if(document.forms[0].chk_facility[sno].checked && document.forms[0].hidFacgroup[sno].value!="0")
	{
    	document.forms[0].sel_sectype[sno].value="1";
    	document.forms[0].sel_sectype[sno].disabled=true;
    	document.forms[0].txt_margin[sno].disabled=false;
	}
    <%}else{%>
    ...
    if(document.forms[0].chk_facility.checked && document.forms[0].hidFacgroup.value!="0")
	{
    	document.forms[0].sel_sectype.value="1";
    	document.forms[0].sel_sectype.disabled=true;
    	document.forms[0].txt_margin.disabled=false;
	}
...
%>
<body onload="onload();checkmargin();">
									...
									<tr>
										...
										<table width="100%" border="0" cellspacing="0" cellpadding="3" class="outertable">
											...
											<tr>
												...
												<td><lapschoice:application /></td>
													...
													<tr class="dataheader">
														...
														<td align="center"><b>Residual Value</b>
														</td>
													</tr>
													<tr class="datagrid">
														<td align="right"><b><%=Helper.correctNull((String)request.getParameter("secValue"))%>&nbsp;</b>
														</td>
														<td align="right"><b><%=Helper.correctNull((String)request.getParameter("resiValue"))%>&nbsp;</b>
														</td>
													</tr>
												</table>	
												<br>
											...
											if(str_Proposed.equalsIgnoreCase("Y"))
											{
												...
												<tr class="dataheader">
															<td width="100%" align="left" colspan="7"><b>Proposed Facilities</b></td>
													</tr>
												<%
											int vecsize = 0;
											if (vecData != null) 
											...
											%>		
												<tr class="datagrid">
													<td width="5%"><input type="checkbox" name="chk_facility" style="border-style: none" onClick="chkapprovedsec('<%=Helper.correctNull((String) vecRow.get(18)) %>','<%=i%>');checkSecurity();chkenablefield('<%=i%>');fncopySecurity('<%=Helper.correctNull((String) vecRow.get(21)) %>','<%=Helper.correctNull((String) vecRow.get(22)) %>','<%=Helper.correctNull((String) vecRow.get(23)) %>','<%=Helper.correctNull((String) vecRow.get(3)) %>',this,'<%=i%>')"></td>
													<td width="5%" align="center"><%=Helper.correctNull((String) vecRow.get(3))%></td>
													...
													<input type="hidden" name="hid_proposedtype" value="">
													<input type="hidden" name="hidparentappno" value="">
													<input type="hidden" name="hidparentsno" value="">
													<input type="hidden" name="hidBaseappno" value="<%=Helper.correctNull((String) vecRow.get(21)) %>">
													<input type="hidden" name="hidBasesno" value="<%=Helper.correctNull((String) vecRow.get(22)) %>">
													<input type="hidden" name="hidFacCategory" value="<%=Helper.correctNull((String) vecRow.get(23)) %>">
													<input type="hidden" name="hidFacilitySno" value="<%=Helper.correctNull((String) vecRow.get(3)) %>">
													<input type="hidden" name="hidFacgroup" value="<%=Helper.correctNull((String) vecRow.get(24)) %>">
													<% if(!FACILITY_PROPOSEDValue.equalsIgnoreCase("")){
													if(d>=0&&d<=2000000){%>
													...
													<%}else{ %>	
														<select name="sel_sectype" onChange="hideMargin('<%=i%>')">
															...
															<%} %>
												   <input type="hidden" name="txt_CGTMSEFLAG" value="<%=Helper.correctNull((String) vecRow.get(20))%>"><input type="hidden" name="txt_type" value="<%=Helper.correctNull((String) vecRow.get(8))%>"></td>
													...
													<td width="20%" align="right"><input type="text" id="hidMarginId" name="txt_margin" style="text-align: right;" onblur="checkSecurity();checkPercentage(this);roundtxt(this)" onkeypress=" allowNumber(this);"></td>
													<td  width="20%"><select name="sel_Securitytype">
											...
											%>
											<tr class="datagrid">
													<td width="100%" align="center" colspan="6">&nbsp;NO FACILITIES &nbsp;</td>
											</tr>
											<%}} 
											if(str_Existing.equalsIgnoreCase("Y"))
											{
												%><tr><td colspan="5">&nbsp;</td></tr>
													<tr class="dataheader">
														...
														<td width="20%"  align="center">Security type
														</td>
													</tr>
													...
													<tr class="dataheader">
													<td width="100%" align="left" colspan="7"><b>Existing Facilities</b></td>
											</tr>
												<%
											int vecsize = 0;
											if (vecData != null) 
											...
											%>		
												<tr class="datagrid">
													<td width="5%" colspan="2" align="center"><input type="checkbox" name="chk_facility" style="border-style: none" onClick="checkSecurity()"></td>
													<td width="55%"><%=Helper.correctNull((String) vecRow.get(0))%> <input type="hidden" name="txt_facility" value="<%=Helper.correctNull((String) vecRow.get(0))%>"> </td>
													<td width="20%" align="center">
													...
													<input type="hidden" name="hidparentappno" value="">
													<input type="hidden" name="hidparentsno" value="">
													<input type="hidden" name="hidBaseappno" value="">
													<input type="hidden" name="hidBasesno" value="">
													<input type="hidden" name="hidFacilitySno" value="">
													<input type="hidden" name="txt_CGTMSEFLAG" value="">
													<input type="hidden" name="hidFacgroup" value="0">
													<select name="sel_sectype" onChange="hideMargin('<%=i%>')">
																<option value="0" >--Select--</option>
																<option value="1" >Primary</option>
																<option value="2" >Collateral</option>
