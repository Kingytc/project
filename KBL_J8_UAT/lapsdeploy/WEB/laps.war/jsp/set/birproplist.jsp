...
function searchData()
{
	...
	document.forms[0].hidBeanGetMethod.value="getBIRListprop";
	...
	document.forms[0].action=appUrl+"action/birproplist.jsp";
...
function doClose()
	...
	function radioCheck(){
		 if(document.forms[0].rad[0].checked==false && document.forms[0].rad[1].checked==false ){
			 alert("Please Select Either Agent ID  or Name");
			 return;
		 }
	}
	function doSelect()
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="3" class="outertable" align="center">
          <tr> 
            <td>Search By 
              ...
              <tr> 
               <td><input type="radio" name="rad" onClick="doSelect();" style="border-style: none" value="1">Agent ID</td>
              
              <td><input type="radio" name="rad" onClick="doSelect();" style="border-style: none" value="2">&nbsp;BIR Name</td>
