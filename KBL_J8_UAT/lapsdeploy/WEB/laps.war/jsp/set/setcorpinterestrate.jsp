...
function callFlowtype(type)
{
	...
	{
		document.forms[0].wrk_flowtype1.value=type;
		document.forms[0].action=appUrl+"action/setfacilityintterms.jsp?hidBeanId=setproducts&hidBeanGetMethod=corpinterestTerm";
	}
...
document.forms[0].prd_rng_from.readOnly=true;
document.forms[0].prd_rng_to.readOnly=true;
document.forms[0].prd_maxterm.readOnly=true;
}
function doSave()
{
var flag = true;
...
if(parseFloat(document.forms[0].amtfrom.value) > parseFloat(document.forms[0].prd_rng_to.value) || parseFloat(document.forms[0].amtfrom.value) < parseFloat(document.forms[0].prd_rng_from.value) )
	{
	alert("Amount Range Should Be Between Product Amount Range");
	return;
	}
if(parseFloat(document.forms[0].amtto.value) > parseFloat(document.forms[0].prd_rng_to.value) )
	{
	alert("Amount Range Should Be Between Product Amount Range");
	return;
	}
if(parseFloat(document.forms[0].amtto.value) <  parseFloat(document.forms[0].amtfrom.value))
	...
	if (document.all.labelhelp.style.visibility == "hidden")
		...
		if (document.forms[0].amtfrom.value != "" && document.forms[0].amtto.value != "")
			{
				if (document.forms[0].tenorfrom.value == "" || document.forms[0].tenorto.value == "")
				{
					alert("Enter tenor range");
					return;
				}
			work="<%=strWrkflowtype%>";
			if (work == "")
			...
			document.forms[0].hidBeanMethod.value="getCorpOtherinterestTerm";
			document.forms[0].hidSourceUrl.value="/action/setcorpinterestrate.jsp";
			document.forms[0].action=appUrl+"controllerservlet?work="+work;
			document.forms[0].submit();
			}
		else
			{
			alert("Enter amount range");
			}
	}
	if(document.all.labelhelp.style.visibility != "hidden")
	{
...
function getvalues()
{
	...
	document.forms[0].action=appUrl+"action/setcorpinterestrate.jsp?work="+work;
	document.forms[0].hidBeanId.value="setproducts";
	document.forms[0].hidBeanGetMethod.value="getCorpOtherinterestTerm";
...
{
//var fixedto=document.forms[0].prd_maxterm.value;
...
{
	document.all.ifrminterest.src=appUrl+"action/iframeinttypes.jsp?hidBeanGetMethod=getOtherinterestTypes&hidBeanId=setproducts&prdCode="+document.forms[0].prdCode.value+"&inttype="+document.forms[0].wrk_flowtype1.value+"&interestfor="+document.forms[0].sel_inttype.value+"&strRule="+varRuleID+"&strModule=C&strROIType="+document.forms[0].sel_inttype1.value;
}	
			...
			<tr>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="3" class="outertable">
					...
					<tr>
						...
						<table width="40%" border="0" cellspacing="1" cellpadding="3" class="outertable">
							...
							<td width="50%" align="center"  class="sub_tab_inactive">
						...
						<tr>
								...
								<td width="85%"><select name=sel_inttype tabindex="1" onchange="clearfields();clearreftype();">
									...
									<lapschoice:interesttype appmodule="C"  appvalue='<%=request.getParameter("fac_id")%>'/>
								</select></td>
							</tr>
							<tr>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="3" class="outertable">
					<tr class="dataheader">
						...
						<td width="15%" align="center" nowrap="nowrap">Business Strategic Premium </td>
					</tr>
					<%ArrayList g1 = null;
						for (int l = 0; l < 5; l++) {
							int colSize = 0;
					...
					<tr class="datgrid" >
						...
						style="text-align: right;" size="12"  onkeypress="allowNumber(this)" value='<%=Helper.correctNull((String) g1.get(3))%>'/></td>
					</tr>
					<%} else {%>
					<tr class="datagrid">
						<td width="5%">
