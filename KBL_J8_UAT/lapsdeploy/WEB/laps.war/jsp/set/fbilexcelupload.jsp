		...
		if(ConfirmMsg(198))
		 {
			...
			document.forms[0].action=appUrl+"action/prdspreadexcelupload.jsp?strExcelUpload=YES&hidFileType=MULTIPART&hidBeanId=excelfunction&hidBeanGetMethod=updateSpreadvalueforfbil";
			showMessage();
			document.forms[0].submit();
		 }
	}
...
<form name="myfrm"  class="normal" method="post" enctype="multipart/form-data"
	action="<%=ApplicationParams.getAppUrl()%>action/fbilexcelupload.jsp?strFinUpload=NO&hidFileType=MULTIPART&hidBeanId=excelfunction&hidBeanGetMethod=updateProductSpread">
		...
		<table width="75%" border="0" cellspacing="0" cellpadding="0"
			...
			<tr>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="5"
					 class="outertable">
					<tr  class="dataheader">
						<td align="center" colspan="2"><b>Excel upload for fibil</b></td>
					</tr>
