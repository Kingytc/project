...
<%
	...
	String strFromLink = Helper.correctNull((String) hshValues.get("strfrom"));
	...
	int vecsize1 = 0;
	if (hshValues != null) {
		arrData = (ArrayList) hshValues.get("vecRow");
	}
...
function searchData()
	...
	document.forms[0].stype.value ="Actname"; 
	document.forms[0].svalue.value = document.forms[0].txt_ser.value; 
	
	document.forms[0].action=appUrl+"action/ActivityMasterList.jsp";
...
{
	if(from_link == "activityname")
	{
		
			if(window.opener.document.forms[0].txt_activity.value==val1)
			{
				alert("both the value remains same!!!")
			}
			else
				{
				window.opener.document.forms[0].txt_activity.options[0].text=val2;
				window.opener.document.forms[0].txt_activity.options[0].value=val1;
			window.opener.document.forms[0].txt_activity.value = val1;
				}
			window.close();
		}
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="3"
					...
					<tr>
						...
						<table width="97%" border="0" cellspacing="1" cellpadding="3"
							...
							<tr class="dataheader">
								...
								<td width="85%"><b>Activity Name </b></td>
							</tr>
						</table>
						</td>
					</tr>
			...
			if (v != null) 
			{
				...
				for (int l = 0; l < vecsize; l++) 
				{
					...
					if(strFromLink.equalsIgnoreCase("activityname"))
					{
					%>
