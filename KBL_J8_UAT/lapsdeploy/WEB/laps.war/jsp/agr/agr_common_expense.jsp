...
<SCRIPT LANGUAGE="JavaScript" src="<%=ApplicationParams.getAppUrl()%>js/agr/agr_common_expense.js"></script>
...
<table width="100%" border="0" align="center" cellspacing="0" cellpadding="5" class="outertable">
  <tr> 
    <td> 
     <table width="98%" border="0" align="center"  cellspacing="1" cellpadding="2"  class="outertable">
          <tr class="dataheader"> 
