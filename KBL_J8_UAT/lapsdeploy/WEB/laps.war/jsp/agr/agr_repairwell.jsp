...
function doSave()
{
	...
	document.forms[0].hidAction.value="insert";
	document.forms[0].hidSourceUrl.value="/action/agr_repairwell.jsp?tabid=R";
...
function doDelete() 
{
	if( ConfirmMsg(101))
	{
		...
		document.forms[0].hidBeanGetMethod.value="getfarmMechMinorIrrig";
		document.forms[0].hidBeanId.value="agrcrops";
		document.forms[0].hidSourceUrl.value="/action/agr_repairwell.jsp";	
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="outertable">
	<tr>
      <td class="page_flow">Home -&gt; Agriculture -&gt; Minor Irrigation -&gt; Repair of Well
      				</td>
	</tr>
</table>
...
<table width="100%" border="0" cellspacing="1" cellpadding="3" class="outertable" align="center">
		...
		<td  align="center" nowrap class="sub_tab_active">Repair of Well</td>
		</tr>
		</table>
<br>
	...
	<tr>
        ...
        <!--  <tr><td>Margin %</td>
         <td><input type="text" name="txt_margin" size="15" maxlength="5" onKeyPress="allowNumber(this)" onblur="checkPercentage(this)" style="text-align: right" 
          ...
          <tr> 
            <td>Location of the wells proposed to be repaired (Give Survey/Khasara No.)</td>
            <td> 
              <input type="text" name="txt_wellSurveyNo" size="15" onKeyPress="notAllowSingleAndDoubleQuote()"
                ...
                <tr> 
                  <td> <b>Particulars of proposed repairs</b> </td>
                  <td> <b>Estimated Cost <%=ApplicationParams.getCurrency()%></b> </td>
                </tr>
                <tr> 
                  <td width="40%"> &nbsp;&nbsp;&nbsp;Deepening </td>
                  <td> 
                    <input type="text" name="txt_deepeningcost" size="15" onkeypress="allowNumber(this)" style="text-align:right"
								onblur="calculateRepairsTotal();roundtxt(this)" value="<%=Helper.correctNull((String)hshValues.get("am_deepeningcost"))%>">
                  </td>
                </tr>
                <tr> 
                  <td> &nbsp;&nbsp;&nbsp;Walls </td>
                  <td> 
                    <input type="text" name="txt_wallscost" size="15" onkeypress="allowNumber(this)" style="text-align:right"
									onblur="calculateRepairsTotal()" value="<%=Helper.correctNull((String)hshValues.get("am_wallscost"))%>">
                  </td>
                </tr>
                <tr> 
                  <td> &nbsp;&nbsp;&nbsp;Others </td>
                  <td> 
                    <input type="text" name="txt_othercost" size="15"  onkeypress="allowNumber(this)" style="text-align:right"
								onblur="calculateRepairsTotal()" value="<%=Helper.correctNull((String)hshValues.get("am_othercost"))%>">
                  </td>
                </tr>
                <tr> 
                  <td> &nbsp;&nbsp;&nbsp;Total </td>
                  <td> 
                    <input type="text" name="txt_totalcost" size="15" style="text-align:right"
								value="<%=Helper.correctNull((String)hshValues.get("am_esttotalcost"))%>">
                  </td>
                </tr>


          <tr> 
            <td>What is the arrangement for lifting water from the well?</td>
            <td> 
...
<input type="hidden" name="txt_tabid" value="R">
</form>
</body>
</html>