...
var varInterestFlag="<%=Helper.correctNull((String)hshValues.get("strInterestFlag"))%>";
function onLoad()
{
	disableFields(true);
	calculatecount();
	if(varInterestFlag=="Y")
	{
		alert("Interest Rate value is 0% for some facilities,Kindly Check Interest Rate defined for all the facilites");
...
function doEdit()
{
	...
	<%}%>
	document.forms[0].txt_avg_pecentagesurplus.readOnly=true;
	disableCmdButtons(true, false, false, false, true, false);	
}
function doSave()
{   
	disableCmdButtons(true, true, true, true, true, false);	
	...
	document.forms[0].hidSourceUrl.value="/action/com_dssassessment.jsp";
...
{   
	if(ConfirmMsg(102))
	{
		document.forms[0].hidBeanGetMethod.value="getDSS";
		document.forms[0].hidBeanId.value="comproposal";
		document.forms[0].action=appUrl+"action/com_dssassessment.jsp";
		document.forms[0].submit(); 		
	}
}
...
function calculatecount()
{
	...
	<%}%>
	document.forms[0].txt_avg_pecentagesurplus.value=roundVal(avgnetsurplus/size);
}
...
<span class="page_flow">Home -&gt; Corporate &amp; SME -&gt;Proposal -&gt; Financial Analysis -&gt; Assessment -&gt; DSS</span><br>
<span style="display: none"><lapschoice:borrowertype /></span> <lapschoice:application />
<jsp:include page="../com/com_commentstab.jsp" flush="true">
<jsp:param name="tabid" value="31" />
</jsp:include> <br>
...
<!--					</tr>-->
				...
				<tr class="datagrid" height="25">
					...
					<tr class="datagrid" height="25">
						<td><input type="text" maxlength="20" size="25" border="0"
							style="text-align: left" value="% of Total Net Surplus"></td>
					</tr>
...
<!--					</tr>-->
			...
			<tr class="datagrid" height="25">
				...
				<td align="right" colspan='<%=arraySize%>'><input type="text"
					maxlength="15" tabindex="1" name="txt_avg_pecentagesurplus" size="16"
					onKeyPress="allowWholeNumber(this)" onblur="calculatecount()"
					style="text-align: right" readonly="readonly"></td>
			</tr>
