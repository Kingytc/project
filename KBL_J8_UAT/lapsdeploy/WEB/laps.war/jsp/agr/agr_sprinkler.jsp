...
function doSave()
{
	...
	document.forms[0].hidAction.value="insert";
	document.forms[0].hidSourceUrl.value="/action/agr_sprinkler.jsp?tabid=S";
...
function doDelete() 
{
	if( ConfirmMsg(101))
	{
		...
		document.forms[0].hidBeanGetMethod.value="getfarmMechMinorIrrig";
		document.forms[0].hidBeanId.value="agrcrops";
		document.forms[0].hidSourceUrl.value="/action/agr_sprinkler.jsp";	
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
      <td class="page_flow">Home -&gt; Minor Irrigation -&gt; Repair to Well -&gt; Purchase of Sprinkler
      				</td>
	</tr>
</table>
...
<table width="100%" border="0" cellspacing="1" cellpadding="3" class="outertable" align="center">
		...
		<td  align="center" nowrap class="sub_tab_inactive"><a
			href="javascript:callPage()" class="darkTabcolor">Purchase of Pumpset</a></td>
		<td  align="center" nowrap class="sub_tab_active">Purchase of Sprinkler</td>
		<td  align="center" nowrap class="sub_tab_inactive"><a
			href="javascript:callPage2()" class="darkTabcolor">Drip Irrigation</a></td>
		<td  align="center" nowrap class="sub_tab_inactive"><a
			href="javascript:callPage3()" class="darkTabcolor">Sinking of new Well</a></td>
		<td  align="center" nowrap class="sub_tab_inactive"><a
			href="javascript:callPage4()" class="darkTabcolor">Construction of Bore Well/Tube Well</a></td>
		<td  align="center" nowrap class="sub_tab_inactive"><a
			href="javascript:callPage5()" class="darkTabcolor">Construction of check Dam</a></td>
		<td  align="center" nowrap class="sub_tab_inactive"><a
			href="javascript:callPage6()" class="darkTabcolor">Repair of Well</a></td>
		</tr>
		</table>
		<br>
...
<input type="hidden" name="txt_tabid" value="S">
</form>
</body>
</html>