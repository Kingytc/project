...
function doSave()
{
	    ...
	    document.forms[0].hidSourceUrl.value="/action/agr_income.jsp";
		document.forms[0].submit();		
		}
}
...
function selectValues(sno,val1,val2,val3,val4,val5,val6,val7,val8,val9,val10)
{
	...
	if(sno!="")
	{	
		document.all.ifrm.src=appURL+"action/iframeagr_common_income.jsp?hidBeanId=agrlandholdings&appno="+appno+"&seqno="+sno+"&hidBeanGetMethod=getIncome&hidAction=edit";
	}
...
function doCancel()
{
	if(ConfirmMsg(102))
	{
		document.forms[0].hidBeanId.value="agrcommon";
		document.forms[0].hidBeanGetMethod.value="getIncome";
		document.forms[0].action=appURL+"action/agr_income.jsp";
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td><jsp:include page="../agr/Applurllinkagr.jsp" flush="true">
			<jsp:param name="pageid" value="117" />
        ...
        <tr class="datagrid"> 
          ...
          <td width="4%">
              <input type="radio" name="radio_seqno" onclick="selectValues('<%=Helper.correctNull((String) data.get(1))%>', 
					...
					'<%=Helper.correctNull((String) data.get(10))%>','<%=Helper.correctNull((String) data.get(11))%>')"  style="border-style:none">
           </td>
