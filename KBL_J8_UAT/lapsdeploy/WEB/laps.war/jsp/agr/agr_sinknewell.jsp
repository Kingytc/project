...
function doSave()
{
	...
	document.forms[0].hidAction.value="insert";
	document.forms[0].hidSourceUrl.value="/action/agr_sinknewell.jsp?tabid=N";
...
function doDelete() 
{
	if( ConfirmMsg(101))
	{
		...
		document.forms[0].hidBeanGetMethod.value="getfarmMechMinorIrrig";
		document.forms[0].hidBeanId.value="agrcrops";
		document.forms[0].hidSourceUrl.value="/action/agr_sinknewell.jsp";	
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
      <td class="page_flow">Home -&gt; Agriculture -&gt; Minor Irrigation -&gt; Sinking of New Well
      				</td>
	</tr>
</table>
...
<table width="100%" border="0" cellspacing="1" cellpadding="3" class="outertable" align="center">
		...
		<td  align="center" nowrap class="sub_tab_inactive"><a
			href="javascript:callPage()">Purchase of Pumpset</a></td>
		<td  align="center" nowrap class="sub_tab_inactive"><a
			href="javascript:callPage1()">Purchase of Sprinkler</a></td>
		<td  align="center" nowrap class="sub_tab_inactive"><a
			href="javascript:callPage2()">Drip Irrigation</a></td>		
		<td  align="center" nowrap class="sub_tab_active">Sinking of new Well</td>
		<td  align="center" nowrap class="sub_tab_inactive"><a
...
<table width="98%" border="0" cellspacing="0" cellpadding="5"  align="center" class="outertable border1">
	<tr>
       ...
       <!--    <tr><td>Margin %</td>
         <td colspan="2"><input type="text" name="txt_margin" size="15" maxlength="5" onKeyPress="allowNumber(this)" onblur="checkPercentage(this)" style="text-align: right" 
								value="<%=Helper.correctNull((String)hshValues.get("agr_margin"))%>"></td></tr>-->
          <tr id="tr_location1" > 
            <td id="td_locationtext">Location of the Proposed well(Give survey No.)</td>
            <td colspan="2"> 
              <input type="text" name="txt_wellSurveyNo" size="15" onKeyPress="notAllowSingleAndDoubleQuote()"
					 value="<%=Helper.correctNull((String)hshValues.get("am_location"))%>"
					 maxlength="9">
            </td>
          </tr>
          
                <tr> 
                  <td width="40%"> Type of proposed well </td>
                  <td colspan="2"> 
                    <input type="text" name="txt_typeofpropwell" maxlength="145" onKeyPress="notAllowSingleAndDoubleQuote()"
								value="<%=Helper.correctNull((String)hshValues.get("am_typeofwell"))%>">
                  </td>
                </tr>
                <tr> 
                  <td rowspan="2">Size of Proposed Well</td>
                  <td><b>Depth (feet)</b></td>
                  <td><b>Diameter/Surface(feet)</b></td>
                </tr>
                <tr> 
                  <td> 
                    <input type="text" name="txt_boreHeight" size="15" onKeyPress="allowDecimals(this)" maxlength="15" style="text-align:right"
								value="<%=Helper.correctNull((String)hshValues.get("am_sizeofwell"))%>">
                  </td>
                  <td> 
                    <input type="text"
								name="txt_boreDiameter" size="15" style="text-align:right"
								value="<%=Helper.correctNull((String)hshValues.get("am_welldiameter"))%>"
								onKeyPress="allowDecimals(this)" maxlength="5">
                  </td>
                </tr>

          <tr> 
            <td> Estimated total cost of the proposed well </td>
            <td colspan="2"> 
              <input type="text" name="txt_estcost" maxlength="15"  onkeypress="allowDecimals(this)" style="text-align:right"
					value="<%=Helper.correctNull((String)hshValues.get("am_estcostpropwell"))%>">
            </td>
          </tr>
          <tr id="tr_waterlift"> 
            <td id="td_waterlifttext">How is water proposed to be lifted from the proposed well?</td>
            <td colspan="2"> 
            <textarea name="txt_liftsource" cols="30" style="text-align:left" wrap="VIRTUAL" rows="4" onKeyPress="textlimit(txt_liftsource,149);notAllowSingleAndDoubleQuote()" onKeyUp="textlimit(this,149)"><%=Helper.correctNull((String)hshValues.get("am_waterliftsource"))%></textarea>
            </td>
             
          </tr>
          <tr id="id_availability">
          	<td>Availability of ground water potential in the area</td>
          	<td colspan="2"> 
              <input type="text" name="txt_groundWater" size="10" maxlength="6" onBlur="checkPercentage(this)"
					onKeyPress="allowNumber(this)" style="text-align:right"
					value="<%=Helper.correctNull((String)hshValues.get("agr_groundwater"))%>">%
            </td>
           </tr>
           <tr id="id_noofwells">
            <td>Number of Existing Irrigation Wells</td>
            <td colspan="2"> 
              <input type="text" name="txt_noofwells" size="10" maxlength="9" onKeyPress="allowInteger()"
            	  style="text-align:right"
					value="<%=Helper.correctNull((String)hshValues.get("agr_noofwells"))%>">
            </td>
          </tr>
          <tr id="id_potential">
            <td>Potential for additional wells without effecting the recharge rate of water in the existing wells.
					</td>
            <td colspan="2"> 
              <input type="text" name="txt_potential" size="10" maxlength="9" onKeyPress="allowInteger()"
            	  style="text-align:right"
					value="<%=Helper.correctNull((String)hshValues.get("agr_potential"))%>">
            </td>
          </tr>
          <tr id="id_distancewells">
            <td>Minimum Distance Between the wells (prescribed by GWSDA)</td>
            <td colspan="2"> 
              <input type="text" name="txt_minDistance" size="15" maxlength="10" onKeyPress="allowNumber(this)"
            	  style="text-align:right"
					value="<%=Helper.correctNull((String)hshValues.get("agr_mindistance"))%>"> metres
            </td>
          </tr>
          <tr id="tr_area"> 
            <td> Area to be Benefited(in acres)</td>
            <td colspan="2"> 
...
<input type="hidden" name="txt_tabid" value="N">
</form>
</body>
</html>