...
{  
	if(ConfirmMsg(102))
	{
		...
		document.forms[0].action=appURL+"action/agr_plantation_expenses.jsp";	
...
{	
	if(varRecordFlag=="Y") {
		...
		{	
			...
			document.forms[0].hidSourceUrl.value="/action/agr_plantation_expenses.jsp";
			document.forms[0].hidBeanId.value="agrcrops";
...
<form name="form1" method="post" action="" class="normal">
  <table width="100%" border="0" cellspacing="1" cellpadding="2">
    ...
    <tr> 
      <td width="18%"> 
        <input type="text" name="item" size="33" maxlength="50" value='<%=Helper.correctNull((String)arryCol.get(2))%>' onKeyPress="allowAlphaSpaIntPunct()">
      </td>
      ...
      <td width="5%"><lapschoice:CurrencyTag name="txt_year16" onBlur="Rowtotal('<%=i%>')" size="12" maxlength="8" value='<%=Helper.correctNull((String)arryCol.get(18))%>'/> </td>
      <td width="5%"><lapschoice:CurrencyTag name="txt_year17" onBlur="Rowtotal('<%=i%>')" size="12" maxlength="8" value='<%=Helper.correctNull((String)arryCol.get(19))%>'/> </td>
      <td width="5%"><lapschoice:CurrencyTag name="txt_year18" onBlur="Rowtotal('<%=i%>')" size="12" maxlength="8" value='<%=Helper.correctNull((String)arryCol.get(20))%>'/> </td>
      <td width="5%"><lapschoice:CurrencyTag name="txt_year19" onBlur="Rowtotal('<%=i%>')" size="12" maxlength="8" value='<%=Helper.correctNull((String)arryCol.get(21))%>'/> </td>
      <td width="5%"><lapschoice:CurrencyTag name="txt_year20" onBlur="Rowtotal('<%=i%>')" size="12" maxlength="8" value='<%=Helper.correctNull((String)arryCol.get(22))%>'/> </td>
      <td width="5%"><lapschoice:CurrencyTag name="txt_year21" onBlur="Rowtotal('<%=i%>')" size="12" maxlength="8" value='<%=Helper.correctNull((String)arryCol.get(23))%>'/> </td>
      <td width="5%"><lapschoice:CurrencyTag name="txt_year22" onBlur="Rowtotal('<%=i%>')" size="12" maxlength="8" value='<%=Helper.correctNull((String)arryCol.get(24))%>'/> </td>
      <td width="5%"><lapschoice:CurrencyTag name="txt_year23" onBlur="Rowtotal('<%=i%>')" size="12" maxlength="8" value='<%=Helper.correctNull((String)arryCol.get(25))%>'/> </td>
      <td width="5%"><lapschoice:CurrencyTag name="txt_year24" onBlur="Rowtotal('<%=i%>')" size="12" maxlength="8" value='<%=Helper.correctNull((String)arryCol.get(26))%>'/> </td>
      <td width="5%"><lapschoice:CurrencyTag name="txt_year25" onBlur="Rowtotal('<%=i%>')" size="12" maxlength="8" value='<%=Helper.correctNull((String)arryCol.get(27))%>'/> </td>
      <td width="7%"> <lapschoice:CurrencyTag name="txt_total" onBlur="Rowtotal('<%=i%>')" size="12" maxlength="8" value='<%=Helper.correctNull((String)arryCol.get(28))%>'/> 
      </td>
    </tr>
    <%}}
  else
...
%>
    <tr> 
      <td width="18%"> 
        <input type="text" name="item" size="33" maxlength="50" onKeyPress="allowAlphaSpaIntPunct()">
      </td>
...
<lapschoice:combuttonnew btnnames="Edit_Save_Cancel_Delete_Audit Trail" btnenable='<%=Helper.correctNull((String)request.getParameter("btnenable"))%>'/>
	...
	<input type="hidden" name="type1" value="EXP">
