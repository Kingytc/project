...
function doSave()
{
	...
	document.forms[0].hidAction.value="insert";
	document.forms[0].hidSourceUrl.value="/action/agr_constructdam.jsp?tabid=D";
...
function doDelete() 
{
	if( ConfirmMsg(101))
	{
		...
		document.forms[0].hidBeanGetMethod.value="getfarmMechMinorIrrig";
		document.forms[0].hidBeanId.value="agrcrops";
		document.forms[0].hidSourceUrl.value="/action/agr_constructdam.jsp";	
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
      <td class="page_flow">Home -&gt; Agriculture -&gt; Minor Irrigation -&gt; Construction of check Dam
      				</td>
	</tr>
</table>
...
<table width="100%" border="0" cellspacing="1" cellpadding="3" class="outertable" align="center">
		...
		<td  align="center" nowrap class="sub_tab_active">Construction of check Dam</td>
		<td  align="center" nowrap class="sub_tab_inactive"><a
	...
	<tr>
		...
		<table width="100%" border="0" cellspacing="3" cellpadding="3" class="outertable">
         ...
         <td><input type="text" name="txt_margin" size="15" maxlength="5" onKeyPress="allowNumber(this)" onblur="checkPercentage(this)" style="text-align: right" 
          ...
          <tr id="tr_waterlift"> 
            <td id="td_waterlifttext">Other Details</td>
            <td> 
...
<input type="hidden" name="txt_tabid" value="D">
</form>
</body>
</html>