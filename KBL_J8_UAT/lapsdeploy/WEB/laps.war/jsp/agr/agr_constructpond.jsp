...
function doSave()
{
	...
	document.forms[0].hidAction.value="insert";
	document.forms[0].hidSourceUrl.value="/action/agr_constructpond.jsp?tabid=T";
...
function doDelete() 
{
	if( ConfirmMsg(101))
	{
		...
		document.forms[0].hidBeanGetMethod.value="getfarmMechMinorIrrig";
		document.forms[0].hidBeanId.value="agrcrops";
		document.forms[0].hidSourceUrl.value="/action/agr_constructpond.jsp";	
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
      <td class="page_flow">Home -&gt; Agriculture -&gt; Minor Irrigation -&gt; Construction of Bore Well/Tube Well
      				</td>
	</tr>
</table>
...
<table width="100%" border="0" cellspacing="1" cellpadding="3" class="outertable" align="center">
		...
		<td  align="center" nowrap class="sub_tab_active">Construction of Bore Well/Tube Well</td>
		<td  align="center" nowrap class="sub_tab_inactive"><a
	...
	<tr>
      ...
      <!--    <tr><td>Margin %</td>
         <td><input type="text" name="txt_margin" size="15" maxlength="5" onKeyPress="allowNumber(this)" onblur="checkPercentage(this)" style="text-align: right" 
          ...
          <tr> 
            <td>Location of the Bore Well/Tube Well(Give Survey/Khasara No.)</td>
            <td> 
              <input type="text" name="txt_wellSurveyNo" size="15" onKeyPress="notAllowSingleAndDoubleQuote()"
                ...
                <tr> 
                  <td colspan="3"> <b>Type and size of Bore well/Tube well</b> </td>
                </tr>
                <tr> 
                  <td width="40%"> &nbsp;&nbsp;&nbsp;Electric or diesel(With H.P.) 
                  </td>
                  <td> 
                    <input type="text" name="txt_tubeelectric" size="15" maxlength="18" onKeyPress="notAllowSingleAndDoubleQuote()"
								value="<%=Helper.correctNull((String)hshValues.get("am_tube_elecdsl"))%>">
                  </td>
                </tr>
                <tr> 
                  <td> &nbsp;&nbsp;&nbsp;Cavity or Stainer </td>
                  <td> 
                    <input type="text" name="txt_tubecavity" size="15" maxlength="18" onKeyPress="notAllowSingleAndDoubleQuote()"
								value="<%=Helper.correctNull((String)hshValues.get("am_tube_cavstnr"))%>">
                  </td>
                </tr>
                <tr> 
                  <td> &nbsp;&nbsp;&nbsp;Size of boring pipe(diameter)</td>
                  <td> 
                    <input type="text" name="txt_tubeboresize" size="15" maxlength="15" onKeyPress="allowDecimals(this)"
								value="<%=Helper.correctNull((String)hshValues.get("am_tube_borepipesize"))%>">&nbsp;(In Inches)
                  </td>
                </tr>
                <tr> 
                  <td> &nbsp;&nbsp;&nbsp;Size of delivery pipe(diameter)</td>
                  <td> 
                    <input type="text" name="txt_tubedeliverysize" size="15" maxlength="15" onKeyPress="allowDecimals(this)"
								value="<%=Helper.correctNull((String)hshValues.get("am_tube_delivpipisize"))%>">&nbsp;(In Inches)
                  </td>
                </tr>
                <tr > 
                  <td> How the excess water,if any, is proposed to be used? </td>
                  <td> 
                    <textarea rows="4" cols="40" name="txa_tubewaterexcessusage" onkeyup="textlimit(this,149);"
                    onKeyPress="textlimit(txa_tubewaterexcessusage,149);notAllowSingleAndDoubleQuote()" onKeyUp="textlimit(this,149)"><%=Helper.correctNull((String)hshValues.get("am_excesswaterusage"))%></textarea>
                  </td>
                </tr>
                <tr id="tr_area"> 
...
<input type="hidden" name="txt_tabid" value="T">
</form>
</body>
</html>