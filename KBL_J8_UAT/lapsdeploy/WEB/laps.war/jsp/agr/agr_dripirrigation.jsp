...
function doSave()
{
	...
	document.forms[0].hidAction.value="insert";
	document.forms[0].hidSourceUrl.value="/action/agr_dripirrigation.jsp?tabid=I";
...
function doDelete() 
{
	if( ConfirmMsg(101))
	{
		...
		document.forms[0].hidBeanGetMethod.value="getfarmMechMinorIrrig";
		document.forms[0].hidBeanId.value="agrcrops";
		document.forms[0].hidSourceUrl.value="/action/agr_dripirrigation.jsp";	
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
      <td class="page_flow">Home -&gt; Agriculture -&gt; Minor Irrigation -&gt; Drip Irrigation
      				</td>
	</tr>
</table>
...
<table width="100%" border="0" cellspacing="1" cellpadding="3" class="outertable" align="center">
		...
		<td  align="center" nowrap class="sub_tab_active">Drip Irrigation</td>
		<td  align="center" nowrap class="sub_tab_inactive"><a
	...
	<tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="3" class="outertable">
         ...
         <td><input type="text" name="txt_margin" size="15" maxlength="5" onKeyPress="allowNumber(this)" onblur="checkPercentage(this)" style="text-align: right" 
          ...
          <tr> 
            <td width="40%">Type of Drip System</td>
            <td > 
          ...
          <tr id="tr_area"> 
            <td width="40%"> Area to be Benefited(in acres)</td>
            <td> 
...
<input type="hidden" name="txt_tabid" value="I">
</form>
</body>
</html>