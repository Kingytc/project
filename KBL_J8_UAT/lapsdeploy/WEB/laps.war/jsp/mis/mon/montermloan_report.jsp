...
function doRunReport()
{
	...
	rpselect1 =org;
    window.open(path+"action/mon_termloan_print.jsp?hidBeanId=perrepappstatus&hidBeanMethod=getData&hidMethod=getTermLoanReviewReport&sellevel="
			+sellevel
			+"&rpselect1="+rpselect1
			+"&offset="+offset
  ...
  <table class="outertable"  width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      <td class="page_flow">Home 
        -&gt; Monitoring -&gt; Reports -&gt; Status Of Term Loan Review Note </td>
    </tr>
    <tr> 
      <td align="right">&nbsp; </td>
    </tr>
                      ...
                      <tr> 
                        ...
                        <td width="51%" align="center"> 
                          <select name="selrepstatus" style="width:100" tabindex="1" >
                              ...
                              <option value="OP">Open/Pending</option>
                              <option value="PA">Approved</option>
                            </select></td>
							</tr>
                    </table>
                  </td>
                    ...
                    <table class="outertable"  width="100%" border="0" cellspacing="0" cellpadding="4">
                      ...
                      <tr align="center"> 
                        <td align="center" colspan="2"> 
                          <table class="outertable border1"  width="85%" border="0" cellspacing="0" cellpadding="3" align="center" >
                            <tr> 
                              <td> 
                                <table class="outertable"  width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                                  <tr> 
                                    ...
                                    <td width="60%">
												<table class="outertable" width="40%">
													<tr>
														<td>From &nbsp;&nbsp;</td>
														<td><input type="text" name="fromdate" maxlength="20"
															size="12" onKeyPress="allowNumber(this)"> </td><td><a
															alt="Select date from calender"
															href="javascript:callCalender('fromdate')"><img
															src="<%=ApplicationParams.getAppUrl()%>img/calen.gif"
															border="0"></a>&nbsp;&nbsp;</td>
														<td>To&nbsp;&nbsp;</td>
														<td>
															<input type="text" name="todate" maxlength="20" size="12" onKeyPress="allowNumber(this)" >
                                   ...
                                   <tr>
                                    <td width="40%" align="center" nowrap height="35">No 
