...
function nextRep()
{
	...
	document.forms[0].hidSourceUrl.value=AppUrl+"action/mon_overstressedaccount_print.jsp";
...
<table width="100%" border="0" cellspacing="0" cellpadding="3">
      ...
      <td align="center"><img src="<%=ApplicationParams.getAppUrl()%>img/bank_rep_logo.jpg" width="30" height="20"></td>          		
        ...
        <tr> 
      <td align="center">Position of over Stressed <b><%=Status%></b> Accounts <b><%=Parameter%></b></td>
        </tr>
         <tr> 
      <td align="center">of (&nbsp;<b><%=Org_Name%></b>&nbsp;)&nbsp; as on <%=Helper.getCurrentDateTime()%></td>
        </tr>
        <tr> 
