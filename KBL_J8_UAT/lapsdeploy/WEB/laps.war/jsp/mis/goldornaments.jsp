...
function runreport()
{
    ...
    {
    	alert("Please Fill appraisername");
    }

	else if(document.forms[0].txtFromDate.value=="")
	{
	...
	else if(document.forms[0].txtToDate.value=="")
	{
		...
		var cbsid=document.forms[0].txt_appraisernameid.value;
		fromdate=document.forms[0].txtFromDate.value;
		todate=document.forms[0].txtToDate.value;
		document.forms[0].method="post";
		appraisername=document.forms[0].txt_appraisername.value;
		var purl = appURL+"action/reappraisalgold_ornaments.jsp?hidBeanId=agrotherassets&hidBeanGetMethod=getgoldpenddingreappforreport&fromdate="+fromdate+"&todate="+todate+"&cbsid="+cbsid+"&appraisername="+appraisername;
		var title = "Report";
...
{	
		...
		var url=appURL+"action/valuerslistforreport.jsp?hidBeanId=staticdata&hidBeanGetMethod=getValuerMasterListList&hidAction=search&strfrom=ValuersMaster&hidAppVal="+"J&appraiser="+"reappraiser";
...
<table class="outertable" width="100%" border="0" cellspacing="0" cellpadding="20">
	<tr>
		...
		<table class="outertable border1 tableBg" border="0" cellspacing="0" cellpadding="3" align="center" width="65%">
			...
			</td><td><a href="#" onClick="showAppraiserName();" style="cursor:hand" tabindex="22">
...
<input type ="hidden" name="txt_appraisernameid" value="">
