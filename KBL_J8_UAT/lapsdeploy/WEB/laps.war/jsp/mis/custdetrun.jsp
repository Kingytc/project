...
function doPrintPreview()
{
	...
	win.document.write("<TR>");
	win.document.write("<TD width='20%'><B><center>"+'<%=(String)hshValues.get("desc")%>'+"</center></B></TD>");
	win.document.write("</TABLE>");
	win.document.write("</center>");
	...
	win.document.write("<TR>");
	win.document.write("<TD width='20%' nowrap='nowrap'><font size='1' face='MS Sans Serif'><B>Generated On :</B></font></TD>");
...
<table width="100%" border="0" cellspacing="0" cellpadding="3" class="outertable">
        ...
        <tr> 
          <td align="center"><b><%=Helper.correctNull((String)hshValues.get("desc"))%></b></td>
        </tr>
   </table>
