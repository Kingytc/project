...
function doSearch()
{
	...
	document.forms[0].action=appURL+"action/set_misactivityhelp.jsp";	
...
function setValues(val0,val1,val2,val3,val4,val5,val6,val7,val8,val9,val12,val14,val17,val18,val19,val20,val21,val22,val23)
{
	if(varPage=="mis")
	{
		var prd_cgtmse=window.opener.document.forms[0].hid_prd_cgtmse.value;

		if(prd_cgtmse=='Y' && (val22=='N' || val22==''))
		{
	...
	window.opener.document.forms[0].sel_MainActivity.value=val1;
	if(varPage=="master")
	{
	window.opener.clearvalues();
	}
	setSubActCode(val2);
	window.opener.document.forms[0].sel_Purpose.value=val3+"_"+val12;
	window.opener.document.forms[0].txt_ActivityCode.value=val4;
	window.opener.document.forms[0].sel_BSRCode.value=val5;
	window.opener.document.forms[0].sel_BSR1Code.value=val6;
	window.opener.document.forms[0].sel_IndustryType.value=val8;
	window.opener.document.forms[0].sel_DisplayScreen.value=val7;
	if(varPage=="master")
	{
		window.opener.document.forms[0].sel_Visibility.value=val9;
		window.opener.document.forms[0].sel_LBRCode.value=val14;
		window.opener.document.forms[0].sel_ratbasedon.value=val18;	
		window.opener.document.forms[0].sel_cg.value=val22;
		window.opener.document.forms[0].allied_act_code.value=val23;
		window.opener.doDisplayScreenVal();
		window.opener.disableCommandButtons(true,false,true,false,true,true);
		var freecode6=val19;
		if(freecode6!="")
		{
		window.opener.document.forms[0].sel_freecode6.value = freecode6;
		}else
		{
			window.opener.document.forms[0].sel_freecode6.value = "0";
		}
		window.opener.getFreeCode7(val20,val21);
	}
	else if(varPage=="mis")
	{
		window.opener.callIndustryType();
		window.opener.callDisplayScreenChange();
		window.opener.callsalesrestriction();
		window.opener.document.forms[0].txt_OrigInvest.value="";
		window.opener.document.forms[0].txt_OriginalInvest.value="";
		window.opener.document.forms[0].txt_investDate.value="";
		window.opener.document.forms[0].sel_criteria_invest.value="0";
		window.opener.document.forms[0].sel_min_industry.value="s";
		window.opener.document.forms[0].txt_floorarea.value="";
		window.opener.document.forms[0].sel_maxind_house.value="0";
		
		
		window.opener.document.forms[0].hidmisdataflag.value="Y";
	}
	window.opener.document.forms[0].sel_busruleid.value=val17;
	window.close();
}
