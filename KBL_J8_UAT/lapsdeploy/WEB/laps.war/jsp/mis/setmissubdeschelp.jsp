...
function callSearch()
	{
		...
		var txtval=document.forms[0].txt_SubActCode.value;
		...
		document.forms[0].hidBeanMethod.value="getMISActivity";
		document.forms[0].hidBeanGetMethod.value="getMISActivity";
		document.forms[0].hidBeanId.value="mis";
		document.forms[0].action=appURL+"action/setmissubdeschelp.jsp";	
...
function setValues(value1,value2,value3,value4,value5,value6)
	{
		if("<%=strPage%>"=="subactdesc")
		{
				window.opener.document.forms[0].txt_SubActCode.value=value1;
				window.opener.document.forms[0].txt_SubActDesc.value=value2;
				window.opener.document.forms[0].hidMainActivityDesc.value=value3;
				window.opener.document.forms[0].txt_MainActivityCode.value=value4;
				window.opener.document.forms[0].txt_MainActivity.value=value5;
				window.opener.document.forms[0].sel_Visibility.value=value6;
			...
			<tr>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="1" class="outertable">
					<tr>
						...
						<td width="25%" nowrap><b>Sub Activity Code</b></td>
						<td width="4%" nowrap><input type="radio" name="cat" value="2"
							onClick="doSelect()" style="border-style:none"></td>
						<td width="17%" nowrap><b>Sub Activity Description</b></td>
						<td width="16%"><input type="text" name="txt_SubActCode" size="20"
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0" class="outertable">
					<tr>
						...
						<table width="100%" border="0" cellspacing="1" cellpadding="3" class="outertable">
							<tr class="dataheader">
								<td width="15%"><b>Sub Activity Code</b></td>
								<td width="45%"><b>Sub Activity Description</b></td>
							</tr>
						</table>
						</td>
					</tr>
