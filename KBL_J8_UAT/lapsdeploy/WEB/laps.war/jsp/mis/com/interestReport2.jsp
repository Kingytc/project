...
function doRunReport()
{
	...
	window.open(path+"action/runInterestReport.jsp?hidBeanId=perrepapptrack&hidBeanGetMethod=getData&hidMethod=getspreadreport&txtFromDate="+fromdt+"&txtToDate="+todt,"stat","scrollbars=Yes,toolbars=No,menubar=yes ,width=900 , height=600,top=10,left=10");
}
function doExcelExport()
{
	...
	if(document.forms[0].txtToDate.value=="")
	{
		...
		var FileName='CAExcelReportProposal';
		var prop="scrollbars=yes,menubar=yes,width=1400, height=650, top=10, left=10";
        window.open(path+"action/"+FileName+".xls?hidBeanId=perrepapptrack&hidBeanMethod=getData&hidMethod=getSpreadSheetTwoExcel&txtFromDate="+fromdt+"&txtToDate="+todt,"BuilderReport",prop);    	
...
<table class="outertable" width="100%" border="0" cellspacing="0"
	cellpadding="0">
	<tr>
		<td class="page_flow">Home -&gt; Reports -&gt; Spread Updation Reports II</td>
	</tr>
	<tr>
		<td align="right">&nbsp;</td>
	</tr>
...
<table class="outertable" width="69%" border="0" cellspacing="0"
	...
	<tr>
		...
		<table class="outertable border1 tableBg" width="69%" border="0" cellspacing="0"
			...
			<tr>
				<td><lapschoice:combuttonnew btnnames="Run Report_Excel Export_Reset"
...
<input type="hidden" name="txtSaveDate"
	value='<%=Helper.getCurrentDateTime()%>'></form>
</body>
</html>