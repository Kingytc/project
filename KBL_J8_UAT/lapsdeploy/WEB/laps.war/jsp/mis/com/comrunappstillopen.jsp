<%@include file="../../share/directives.jsp"%><%
  ...
  String align="left";
  String strLabel=Helper.correctNull((String)hshValues.get("labels"));
  int intsize=0;
...
function printpreview()
{
	...
	win.document.write("<TR>");
	win.document.write("<TD > </TD>");
	win.document.write("<TD align='right'><font size='1' face='MS Sans Serif'>&nbsp;</font></TD>");
	win.document.write("</TR>");
	win.document.write("</TABLE>");
    ...
    <table class="outertable border1"  width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr> 
        <td height="3"> 
          ...
          stk = new StringTokenizer(strLabel,",");  
          while(stk.hasMoreTokens())
          {%>
        	  <td width="5%"><%=stk.nextToken() %></td> 
         <% }}else{
          %>
          <td>No Data Found</td>
          <%} %>
          ...
          if(intsize>0){
    		   ...
    		   <%	for(int j=0;j<ht.size();j++)
    			    {
    					...
    					{dt="&nbsp;";}
    			%>		
    					<td height = '30' align='<%=align%>'>
    					<div align='<%=align%>'><%=dt%></div>
    					</td>
    		  ...
    		  <%}} %>
    			...
    			<tr>		
				<td align='left' ><font size='1' face='MS Sans Serif'>
				<b>Total Applications = &nbsp;</font></b>
				<b><font size='1' face='MS Sans Serif'><%=totcount%></font></b>
				</td>
				</tr>
      ...
      <td height="17"> 
        <table class="outertable" width="100%" border="0" cellspacing="0" cellpadding="2">
          <tr> 
            <td width="45%"> 
              <div align="center"> 
                <input type="button" name="Button232253" value="&lt;&lt; Previous" class="buttonothers"
