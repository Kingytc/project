...
function resetValues()
{
	...
	document.forms[0].selsector.value="S";
	document.forms[0].selproposal.value="S";
...
function runrep()
{
	...
	if(document.forms[0].selprocessat.value=="S")
	{
		alert("Select Process At");
		return;
	}
	...
	var processat=document.forms[0].selprocessat.value;
	var org_name="";
	...
	window.open(path+"action/appregister_report_print.jsp?hidBeanId=perrepappstatus&hidBeanMethod=getData&hidMethod=getAppRegisterReport&sellevel="
				+level
				+"&orgselect="+orgselect
				+"&org_name="+org
			    +"&txtDate="+period
  ...
  <table class="outertable" width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      <td class="page_flow">Home 
        -&gt; Retail-&gt; General Reports -&gt;Loan application Register</td>
    </tr>
    <tr> 
      <td align="right">&nbsp; </td>
    </tr>
                  ...
                  <td colspan="2" height="30">
                    <table class="outertable" width="100%" border="0" cellspacing="0" cellpadding="3">
                      <tr> 
                        ...
                        <td width="39%" align="center">Process At</td>
                      </tr>
                      <tr> 
                       ...
                       <td width="39%" align="center"> <select name="sellevel" style="width:100" onChange="selectValues()" tabindex="1" >
                        ...
                        <td width="22%" align="center">&nbsp;</td>
                        <td width="39%" align="center"><select name="selprocessat" style="width:100" tabindex="3" >
