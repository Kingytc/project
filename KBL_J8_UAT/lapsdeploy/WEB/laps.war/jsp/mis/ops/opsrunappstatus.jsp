...
function printpreview()
{
	...
	win.document.write("</tr>");
	win.document.write("<tr>");
	win.document.write("<td align='center'><strong>"+'<%=Helper.correctNull((String)hshValues.get("Org_Name"))%>'+"</strong</td>");
	win.document.write("</tr>");
	...
	win.document.write("<TR>");
	win.document.write("<TD width='20%'><strong><center>Application " +'<%=Helper.correctNull((String)hshValues.get("strStatus"))%>'+" Status Report</center></strong></TD>");
	win.document.write("</TABLE>");
	win.document.write("</center>");
...
<form class="normal" name= "orgfrm" method="post">
 <table class="outertable" width="100%" border="0" cellspacing="0" cellpadding="3">
        ...
        <tr> 
          <td align="center"><b>Application <%=Helper.correctNull((String)hshValues.get("strStatus"))%> Status Report</b></td>
        </tr>
   </table>
