...
function printpreview()
{
	...
	<%if(Helper.correctNull((String)hshValues.get("Loan_type")).equalsIgnoreCase("P")){ %>
	win.document.write("<center>");
	win.document.write("<TABLE border='0'>");
	win.document.write("<TR>");
	win.document.write("<TD width='20%'><B><center>Userwise Applications " +'<%=Helper.correctNull((String)hshValues.get("strStatus"))%>' + " Report under Retail</center></B></TD>");
	win.document.write("</TABLE>");
	win.document.write("</center>");
		<%}
        else if(Helper.correctNull((String)hshValues.get("Loan_type")).equalsIgnoreCase("A")){%>
    win.document.write("<center>");
	win.document.write("<TABLE border='0'>");
	win.document.write("<TR>");
	win.document.write("<TD width='20%'><B><center>Userwise Applications " +'<%=Helper.correctNull((String)hshValues.get("strStatus"))%>' + " Report under Agriculture</center></B></TD>");
	win.document.write("</TABLE>");
	win.document.write("</center>");
	 <%}
        else{%>
	...
	win.document.write("<TABLE border='0'>");
	win.document.write("<TR>");
	win.document.write("<TD width='20%'><B><center>Userwise Applications " +'<%=Helper.correctNull((String)hshValues.get("strStatus"))%>' + " Report</center></B></TD>");
	win.document.write("</TABLE>");
	win.document.write("</center>");
	  <%} %>
	win.document.write("<center>");
	win.document.write("<TABLE border='0'>");
	win.document.write("<TR>");
	win.document.write("<TD width='20%'><B><center>For user " +'<%=Helper.correctNull((String)hshValues.get("App_Name"))%>' + "</center></B></TD>");
	win.document.write("</TABLE>");
	win.document.write("</center>");
	...
	win.document.write("<TD ><font size='1' face='MS Sans Serif'>"+'<%=(String)hshValues.get("txtDate1")%>'+"-"+'<%=(String)hshValues.get("txtDate")%>'+"</font></TD>");
	win.document.write("</TR>");
...
<table width="100%" border="0" cellspacing="0" cellpadding="3">
        ...
        <%if(Helper.correctNull((String)hshValues.get("Loan_type")).equalsIgnoreCase("P")){ %>
        <tr> 
          <td align="center"><b>Userwise Applications <%=Helper.correctNull((String)hshValues.get("strStatus"))%>  Report under Retail</b></td>
        </tr>
        <%}
        else if(Helper.correctNull((String)hshValues.get("Loan_type")).equalsIgnoreCase("A")){%>
         <tr> 
          <td align="center"><b>Userwise Applications <%=Helper.correctNull((String)hshValues.get("strStatus"))%>  Report under Agriculture</b></td>
        </tr>
        <%}
        else{%>
        <tr> 
          <td align="center"><b>Userwise Applications <%=Helper.correctNull((String)hshValues.get("strStatus"))%>  Report</b></td>
        </tr>
        <%} %>
        <tr> 
          <td align="center"><b>For user &nbsp; <%=Helper.correctNull((String)hshValues.get("App_Name"))%> </b></td>
        </tr>
   </table>
