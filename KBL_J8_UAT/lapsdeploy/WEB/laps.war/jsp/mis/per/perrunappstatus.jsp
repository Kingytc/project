...
function doPrintPreview()
{
	...
	win.document.write("<TR>");
	win.document.write("<TD width='20%'><strong><center>Application " +'<%=Helper.correctNull((String)hshValues.get("strStatus"))%>'+" Status Report for "+'<%=Helper.correctNull((String)hshValues.get("loantype"))%>' +"</center></strong></TD>");
	win.document.write("</TABLE>");
	win.document.write("</center>");
	...
	var agln="";
	 ...
	 textlabel =outlabel.split(',');
		  ...
		  for(l=0;l<textlabel.length;l++)
			{
				win.document.write("<td align='center'><B>"+ textlabel[l] + "</B>");
				win.document.write("</td>");
			}
			win.document.write("<tr>"); 
			win.document.write("</tr>"); 
      ...
      %>
      win.document.write("<td align='<%=align%>'><font size='1' face='MS Sans Serif'>"+"<%=stp%>"+'&nbsp;'+"</font></td>");	
		<%	j1=j1+1; 
			}
		%>
			  win.document.write("</tr>");
...
function printData()
{
   ...
   else
	{
	   document.write("<tr class=datagrid><td align='center'>No Data Found</td></tr>");
		...
		document.write("<b>"+"<%=totcount%>" + "</font></b>");
		document.write("</td>");
		document.write("</tr>");		
...
<form name= "orgfrm" method="post" class="normal">
 <table class="outertable"  width="100%" border="0" cellspacing="0" cellpadding="3">
        ...
        <tr> 
          <td align="center"><b>Application <%=Helper.correctNull((String)hshValues.get("strStatus"))%> Status Report for <%=Helper.correctNull((String)hshValues.get("loantype"))%></b></td>
        </tr>
        <tr><td><div class="cellContainer">
