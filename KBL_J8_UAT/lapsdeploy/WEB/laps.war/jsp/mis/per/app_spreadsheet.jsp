...
<%
	...
	//out.print("HDHKLKJHKJS============"+str_report);
...
<script>
	...
	function doRunReport()
	{
		...
		if(document.forms[0].txtToDate.value=="")
		{
			...
			var url=appURL+"action/app_spreadsheet_run_report.jsp?hidBeanId=perrepappstatus&hidBeanMethod=getData&hidMethod=getAppSpreadData&txtFromDate="+fromdt+"&txtToDate="+todt+"&txtSaveDate="+sdt+"&hidOrgCode="+code+"&orglevel="+orglevel+"&report="+report+"&hidOrgName="+orgname+"&seldepartment="+vardepartment+"&seldesignation="+vardesignation;
			window.open(url,"app_spreadsheet",prop);
	}
	...
	function doExcelExport()
	{
		...
		if(document.forms[0].txtToDate.value=="")
		{
	        ...
	        window.open(path+"action/"+FileName+".xls?hidBeanId=perrepappstatus&hidBeanMethod=getData&hidMethod=getSpreadSheetExcel&txtFromDate="+fromdt+"&txtToDate="+todt+"&txtSaveDate="+sdt+"&hidOrgCode="+code+"&orglevel="+orglevel+"&report="+report+"&hidOrgName="+orgname+"&seldepartment="+vardepartment+"&seldesignation="+vardesignation,"BuilderReport",prop);    	
