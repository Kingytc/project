...
function doPrintPreview()
{
	<%if (arrRow.size()> 0){%>
		...
		win.document.write("<TR>");
		win.document.write("<TD width='20%'><strong><center>Only for Rating " +'<%=Helper.correctNull((String)hshValues.get("hidStatus")) %>'+" Proposal "+"</center></strong></TD>");
		win.document.write("</TABLE>");
		win.document.write("</center>");
		...
		var agln="";
		win.document.write("<TR>");
		win.document.write("<TD rowspan='2' width='5%'>");
		...
		win.document.write("</TD >");
		win.document.write("<TD rowspan='2' width='10%'>");
		win.document.write("<div align='center'><font size='1' face='MS Sans Serif'>"+"Cust ID" +'&nbsp;'+ "</font></div>");
		win.document.write("</TD >");
		...
		win.document.write("</TR>");	
		 ...
		 <%
	      ...
	      for(int i=0;i<arrRow.size();i++){
	    	...
	    	win.document.write("</TD >");
	    	win.document.write("<TD>");
	    	win.document.write("<div align='center'><font size='1' face='MS Sans Serif'>"+'<%=Helper.correctNull((String)arrCol.get(2))%>' +'&nbsp;'+ "</font></div>");
	    	win.document.write("</TD >");
	    	win.document.write("<TD>");
...
<form name= "orgfrm" method="post">
  <table width="100%" border="0" cellspacing="0" cellpadding="3">
    ...
    <tr> 
      <td align="center"><b>Only for Rating - <%=Helper.correctNull((String)hshValues.get("hidStatus")) %> Proposal</b></td>
    </tr>
  </table>
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="3" align="center" class="outertable border1">
    <tr> 
      ...
      <td  width="8%" rowspan=2 valign="top"><b>Cust ID</b></td>
