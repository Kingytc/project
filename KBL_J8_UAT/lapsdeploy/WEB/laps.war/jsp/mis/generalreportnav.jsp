...
<table width="90%" border="0" cellspacing="0" cellpadding="0" class="outertable" align="center">
	...
	<tr>
		...
		<table class="outertable" width="20%" border="0" cellspacing="0" align="center" cellpadding="4">
			<tr>
				<td valign="top">
				<table class="outertable border1 tableBg" width="100%" border="0" align="center" cellspacing="0" cellpadding="0">
					<tr class="dataheader">
						<td valign="top" align="center">General Reports</td>
						</tr>
						<tr>
						<td>
						<table class="outertable" width="100%" border="0" cellspacing="0" cellpadding="8">
							<!--<tr>
						<td class="menubackflow"><a href="javascript:callFunction('dcbreport.jsp')">DCB Register</a></td>
					</tr>
							<tr>
						<td class="menubackflow"><a href="javascript:callFunction('perrepsanctioned.jsp')">M-27</a></td>
							</tr>
							--><tr>
							<td class="menubackflow"><a href="javascript:callFunction('appregister_report.jsp')">Loan application Register</a></td>
					</tr>
					<tr>
