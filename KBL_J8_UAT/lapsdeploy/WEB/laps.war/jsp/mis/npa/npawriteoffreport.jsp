...
if(checkfields())
	...
	var writeofftype=document.forms[0].sel_writeofftype.value;
	var processstatus=document.forms[0].sel_processstatus.value;
	window.open(appUrl+"action/npawriteoffrptresult.jsp?hidBeanId=npaapprep&hidMethod=getWriteoff&hidBeanGetMethod=getData&hidorgcode="+orgcode+"&hidperiod="+period+"&hidfromamt="+fromamt+"&hidtoamt="+toamt+"&hidlevel="+org_level+"&hidSchemes="+schemes+"&hidorgname="+orgname+"&hidwriteofftype="+writeofftype+"&hidprocessstatus="+processstatus,"stat","scrollbars=Yes,toolbars=No,menubar=no ,width=750 , height=550,top=10,left=10");
	}
}
...
function checkfields()
{
	...
	{
		alert("Select an Process Status");
...
<tr>
	<td class="page_flow">Home -&gt; NPA -&gt; Write Off Reports</td>
</tr>
</table>
                        ...
                        <td> 
                          <table cellspacing="0" cellpadding="0"   class="outertable" width="100%" border="0">
                            <tr> 
                              ...
                              <td width="33%" align="center" > Write off Type 
                              </td>
                              <td width="33%" align="center" > Process Status 
                              </td>
                            </tr>
                          </table>
                        </td>
                        ...
                        <td> 
                          <table cellspacing="0" cellpadding="0"   class="outertable" width="100%" border="0">
                            <tr> 
                              ...
                              <td width="33%" align="center"> 
                                <select name="sel_writeofftype">
                                  <option value="0" selected>&lt;---select---&gt;</option>
                                  <option value="PWO">Prudential Write Off</option>
                                  <option value="AWO">Absolute Write Off</option>
                                </select>
                              </td>
                              <td width="33%" align="center"> 
                                <select name="sel_processstatus">
                                  <option value="0" selected>&lt;---select---&gt;</option>
...
<!--                                <%//String strapptype = "36";%>-->
                      ...
                      <tr> 
                        <td> 
                          <table cellspacing="0" cellpadding="4"   class="outertable" width="30%" border="0" align="center">
                           <br> <tr> 
                      ...
                      <tr>
                        <td>
                          <table cellspacing="0" cellpadding="4"   class="outertable" width="70%" border="0" align="center">
                            <tr> 
