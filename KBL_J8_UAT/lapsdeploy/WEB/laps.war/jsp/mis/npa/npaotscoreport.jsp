...
function runreport()
{
	if(checkfields())
	{
		...
		var varcompromisetype=document.forms[0].sel_compromisetype.value;
		window.open(appUrl+"action/npaotscorptresult.jsp?hidBeanId=npaapprep&hidBeanGetMethod=getData&hidMethod=getCompromiseSettlement&hidOrgLevel="+varorglevel+"&hidOrgcode="+varorgcode+"&hidSchemes="+varschemes+"&hidotstype="+varcompromisetype+"&txtfromamt="+varfrmamt+"&txttoamt="+vartoamt+"&hidPeriod="+varperiod,"Decreedcases","scrollbars=Yes,toolbars=No,menubar=no ,width=750 , height=550,top=10,left=10");
	}
}
...
<tr>
	<td class="page_flow">Home -> NPA -> NPA Reports
	</td>
</tr>
</table>
<table cellspacing="0" cellpadding="0"  class="outertable" width="100%" border="0">
...
<td>
			...
			<td>
				    <table cellspacing="0" cellpadding="0"  class="outertable" width="100%" align="center" border="0">
                        ...
                        <td> 
                          <table cellspacing="0" cellpadding="0"  class="outertable" width="100%" border="0">
                            <tr> 
                              ...
                              <td width="33%" align="center" > Compromise Type 
                            </tr>
                          </table>
                        </td>
                      </tr>
                        ...
                        <td> 
                          <table cellspacing="0" cellpadding="0"  class="outertable" width="100%" border="0">
                            <tr> 
                              ...
                              <td width="33%" align="center"> 
                                <select name="sel_compromisetype">
                                  <option value="0" selected>&lt;---select---&gt;</option>
                                  <option value="OTS">Compromise </option>
                                  <option value="CO">Counter Offer</option>
                                </select>
                              </td>
                            </tr>
                          </table>
                      ...
                      <tr>
                        <td>
                          <table cellspacing="0" cellpadding="0"  class="outertable" width="70%" border="0" align="center">
                            <tr> 
