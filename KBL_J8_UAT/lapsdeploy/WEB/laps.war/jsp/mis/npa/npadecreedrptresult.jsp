...
function printpreview()
{
	...
	var varPrint = "Y";
	window.open(appUrl+"action/npadecreedrptresult.jsp?hidBeanId=npaapprep&hidBeanGetMethod=getData&hidMethod=getDecreedCases&hidOrgLevel="+varorglevel+"&hidOrgcode="+varorgcode+"&hidSchemes="+varschemes+"&txtfromamt="+varfrmamt+"&txttoamt="+vartoamt+"&hidPeriod="+varperiod+"&hidPrint="+varPrint,"DecreedcasesPrint","scrollbars=Yes,toolbars=No,menubar=no ,width=800 , height=500,top=10,left=10");
}
</script>
</head>
...
<form name= "orgfrm" method="post">
 <table  width="100%" border="0" cellspacing="0" cellpadding="3">
        ...
        <tr class="font_style"> 
          <td align="center"><b>Decreed cases</b></td>
        </tr>
</table>
