...
function runreport()
{
	if(checkfields())
	{
		...
		window.open(appUrl+"action/npadecreedstatusrptresult.jsp?hidBeanId=npaapprep&hidBeanGetMethod=getData&hidMethod=getDecreedEP&hidOrgLevel="+varorglevel+"&hidOrgcode="+varorgcode+"&hidSchemes="+varschemes+"&txtfromamt="+varfrmamt+"&txttoamt="+vartoamt+"&hidPeriod="+varperiod,"DecreedEP","scrollbars=Yes,toolbars=No,menubar=no ,width=750 , height=550,top=10,left=10");
	}
}
...
<form class="normal" class="normal">
...
<tr>
	<td class="page_flow">
		...
		Home -> NPA -> NPA Reports -> Status of Decree execution petition 
	</td>
</tr>
</table>
<table cellspacing="0" cellpadding="0"  class="outertable" width="100%" border="0">
...
<tr>
<td>
	<table cellspacing="0" cellpadding="0"  class="outertable border1" width="100%" border="0" >
		<tr>
			<td valign="middle">
			...
			<td>
				    <table cellspacing="0" cellpadding="0"  class="outertable" width="100%" align="center" border="0">
                      ...
                      <tr>
                        <td>
                          <table cellspacing="0" cellpadding="05"  class="outertable" width="70%" border="0" align="center">
                            <tr> 
