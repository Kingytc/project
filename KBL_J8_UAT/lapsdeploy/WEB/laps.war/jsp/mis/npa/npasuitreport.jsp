...
function checkfields()
{
	...
	if(document.forms[0].sel_court.value=="0")
	{
		alert("Select Legal Action");
		document.forms[0].sel_court.focus();
		return false;
	}
	...
	if(i==document.forms[0].sel_schemes.length)
	{
		alert("Select Schemes");
		document.forms[0].sel_schemes.focus();
		return false;
	}*/
...
function runreport()
{
	if(checkfields())
	{
		...
		var varcourt=document.forms[0].sel_court.value;
		window.open(appUrl+"action/npasuitrptresult.jsp?hidBeanId=npaapprep&hidBeanGetMethod=getData&hidMethod=getLegalCases&hidOrgLevel="+varorglevel+"&hidOrgcode="+varorgcode+"&hidSchemes="+varschemes+"&hidCourt="+varcourt+"&txtfromamt="+varfrmamt+"&txttoamt="+vartoamt+"&hidPeriod="+varperiod,"stat","scrollbars=Yes,toolbars=No,menubar=no ,width=750 , height=550,top=10,left=10");
	}
}
...
<form class="normal"><iframe height="0" width="0" id="ifrm" frameborder=0
	style="border:0"></iframe>
<table cellspacing="0" cellpadding="0"  class="outertable" width="100%" border="0"
	>
	<tr>
		<td class="page_flow">Home -&gt; NPA -&gt;
		Status of Legal Cases Reports</td>
	</tr>
</table>
<table cellspacing="0" cellpadding="0"  class="outertable" width="100%" border="0">
	<tr>
					...
					<tr>
						...
						<table cellspacing="0" cellpadding="0"  class="outertable" width="100%" align="center" border="0">
							<tr>
								...
								<table cellspacing="0" cellpadding="0"  class="outertable" width="100%" border="0">
									<tr>
										<td width="33%" align="center">Level</td>
										<td width="33%" align="center">Legal Action</td>
							...
							<tr>
								...
								<table cellspacing="0" cellpadding="0"  class="outertable" width="100%" border="0">
									<tr>
										<td width="33%" align="center"><select name="sel_level"
											onChange="selectValues()">
											<option value="0" selected>&lt;---select---&gt;</option>
											<lapschoice:reptag beanid="setupreport" methodname="getLevels"
												param="" />
										</select></td>
										<td width="33%" align="center"><select
											name="sel_court">
												<option value="0" selected>&lt;---select---&gt;</option>
							...
							<tr>
								...
								<table cellspacing="0" cellpadding="0"  class="outertable" width="100%" border="0">
									<tr>
										<td align="center" width="50%"><select name="sel_org"
											size="10" style="width:250">
										</select></td>
										<td align="center" width="50%"><select name="sel_schemes"
											size="10" style="width:250">
							...
							<tr>
								...
								<br>	<tr>
										...
										<td width="75%" align="center"><input type="text"
											maxlength="21" name="txt_period" size="23"> &nbsp; <a
											href="#" onClick="JavaScript:showPeriod()" class="blackfont"><b>?</b></a>
										</td>
									</tr>
								</table>
								</td>
								...
								<table cellspacing="0" cellpadding="5"  class="outertable" width="70%" border="0" align="center">
									<tr>
										...
										<td width="25%" align="center"><lapschoice:CurrencyTag
											maxlength="15" name="txt_frmamt" size="20" /> &nbsp;</td>
										<td width="25%" align="center">Amount Range To</td>
										<td width="25%" align="center"><lapschoice:CurrencyTag
											maxlength="15" name="txt_toamt" size="20" /> &nbsp;</td>
									</tr>
								</table><br>
								</td>
							</tr>
	...
	<tr>
		...
		<br>	<tr>
				...
				<table cellspacing="0" cellpadding="0"  class="outertable" border="0">
					<tr>
						<td><input type="button" name="cmdRunReport" value="Run Report" class="buttonothers"onclick="runreport()">
...
<input type="hidden" name="hidOrgCode"></form>
</body>
</html>
