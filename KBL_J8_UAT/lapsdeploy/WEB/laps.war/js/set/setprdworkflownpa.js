...
function doSave(){
	...
	document.forms[0].wrk_flowtype.value=strWrkflowtype;	
		if(document.forms[0].prdCode.value!="S")
		{
			...
			document.forms[0].hidBeanMethod.value="updateNPAWorkflowData";
			document.forms[0].hidBeanGetMethod.value="getWorkflowNPA";
		}
		else
		{
			alert("Select the NPA module");
			return;
		}
	document.forms[0].hidRecordflag.value=varRecordFlag;
	document.forms[0].hidSourceUrl.value="/action/setprdworkflowcomnpa.jsp";
