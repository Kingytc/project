...
function doSave()
{
	...
	{
		alert("Select Limit to view its details");
		return;
	}
	...
	document.forms[0].hidBeanMethod.value="updateWorkflowData";
	document.forms[0].hidBeanGetMethod.value="getWorkflowData";	
	document.forms[0].hidSourceUrl.value="/action/setprdworkflowcom.jsp";
