/*
*	JavaScript variables to fill the constant labels
*/
var varratios=new Array();
varratios[0]="Interest Coverage";
varratios[1]="PAT/TNW";
varratios[2]="PAT/NetSales";
varratios[3]="PBDIT/Networth";
varratios[4]="NetSales/TotalTangible Assets";
varratios[5]="Operational Profit/Net Sales";
varratios[6]="DSCR";
varratios[7]="Sales/Fixed Assets";
...
/*
*	Function called when balance sheet tab is clicked
*/
function callBalanceSheet()
{
