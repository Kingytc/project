...
{	
	...
	var noofrows = document.forms[0].txt_noofrows.value;
		document.all.isearch.src=appURL+"action/iframesearchaddkpowerdetails.jsp?hidBeanGetMethod=getSolvencySearch&hidBeanId=mastapplicant&txtsearch="+txtval+"&radiobutton="+rdovalue+"&hid_rowcount="+hid_rowcount+"&noofrows="+noofrows+"&hidCategoryType="+varCategoryType+"&checkcbs=Y&pageType="+varPageType;
