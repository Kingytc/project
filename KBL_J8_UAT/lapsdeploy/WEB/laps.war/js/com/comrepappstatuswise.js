 ...
 function runrep()
{
   ...
   if (document.forms[0].txtDate.value == "")
	...
	if (param !="")
	{
		window.open(path+"action/comrunappstatuswise.jsp?hidBeanId=repappstatuswise&hidBeanMethod=getData&hidMethod=getRepDetails&hidLoanType=C&hidStatus="+stat+"&txtDate="+dt+"&hidOrgCode="+code+"&hidOpFields="+outf+"&txtSaveDate="+sdt+"&hidSelFields="+dbf+"&orglevel="+orglevel,"stat","scrollbars=Yes,toolbars=No,menubar=no,width=750,height=550,top=10,left=10");
	}
...
function save()
{
	...
	var beanid ="repData";
	var action="Insert";
	var source="/action/comrepappstatuswise.jsp";
