function showPeriod()
{
	...
	var prop = "scrollbars=no,width=350,height=310";	
...
function runrep()
{
	...
	window.open(path+"action/comunuserwiseapp.jsp?hidBeanId=comrepapptrack&hidBeanMethod=getData&hidMethod=getComUserDetails&txtDate="+dt+"&hidStatus="+stat+"&hidAppno="+appno+"&hidOrgCode="+code+"&hidOpFields="+outf+"&hidSelFields="+dbf+"&orglevel="+orglevel+"&hidOrgName="+orgname+"&hidappname="+appname+"&hidLoanType="+prodtype,"track","scrollbars=Yes,toolbars=No,menubar=no ,width=750 , height=550,top=10,left=10");
	}
