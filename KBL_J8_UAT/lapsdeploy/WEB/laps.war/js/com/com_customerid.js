...
function callExisting()
{
	...
	if(txtlen<=2 && document.forms[0].radiobutton.checked == true)
	{
	...
	document.all.isearch.src=appURL+"action/com_customerid_display.jsp?hidBeanGetMethod=getMasterSearch&hidBeanId=commappmaster&txtsearch="+txtval+"&radiobutton="+rdovalue+"&hid_rowcount="+hid_rowcount+"&noofrows="+noofrows+"&hidCategoryType="+varCategoryType+"&checkcbs=Y&pageType="+varPageType+"&count="+countvar+"&appCount="+appCountvar;		
}
