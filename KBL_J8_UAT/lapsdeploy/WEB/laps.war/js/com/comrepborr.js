...
function runrep()
{
	...
	if (param !="")
	{
		window.open(path+"action/comrunborr.jsp?hidBeanId=comrepborr&hidBeanMethod=getData&hidMethod=getRepDetails&txtDate="+dt+"&hidOrgCode="+code+"&txtSaveDate="+sdt+"&hidOpFields="+outf+"&hidSelFields="+dbf,"Prod","scrollbars=Yes,toolbars=No,menubar=no ,width=750 , height=550,top=10,left=10");
	}
...
function save()
{
	...
	var beanid ="repData";
	var action="Insert";
	var source="/action/comrepborr.jsp";
