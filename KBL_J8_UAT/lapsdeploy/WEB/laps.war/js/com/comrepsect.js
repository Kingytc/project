...
function runrep()
{
	...
	if (param !="")
	{
		//alert(path+"action/comrunsect.jsp?hidBeanId=comrepsect&hidBeanMethod=getData&hidMethod=getRepDetails&txtDate="+dt+"&txtSaveDate="+sdt+"&hidOpFields="+outf+"&hidSelFields="+dbf,"Prod","scrollbars=Yes,toolbars=No,menubar=no ,width=750 , height=550,top=10,left=10");
		window.open(path+"action/comrunsect.jsp?hidBeanId=comrepsect&hidBeanMethod=getData&hidMethod=getRepDetails&txtDate="+dt+"&txtSaveDate="+sdt+"&hidOpFields="+outf+"&hidSelFields="+dbf,"Prod","scrollbars=Yes,toolbars=No,menubar=no ,width=750 , height=550,top=10,left=10");
	}
...
function save()
{
	...
	var beanid ="repData";
	var action="Insert";
	var source="/action/comrepsect.jsp";
...
function setParam()
{
	...
	//{
		...
		{
			document.forms[0].txtDate.value="Prior";
		}
		var dt =document.forms[0].txtDate.value;
...
function closeWindow()
{
	...
	document.forms[0].action=path+"action/nparepnav.jsp";
