 ...
 function runrep()
{
	...
	if (param !="")
	{
		window.open(path+"action/comrunappinterestmod.jsp?hidBeanId=repappinterestmod&hidBeanMethod=getData&hidMethod=getRepDetails&hidStatus="+stat+"&hidLoanType=C&txtDate="+dt+"&hidOrgCode="+code+"&hidOpFields="+outf+"&txtSaveDate="+sdt+"&hidSelFields="+dbf,"stat","scrollbars=Yes,toolbars=No,menubar=no ,width=750 , height=550,top=10,left=10");
	}
...
function save()
{
	...
	var beanid ="repData";
	var action="Insert";
	var source="/action/comrepappinterestmod.jsp";
