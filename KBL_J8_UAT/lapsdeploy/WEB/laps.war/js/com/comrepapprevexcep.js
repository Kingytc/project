 ...
 function runrep()
{
	...
	if (param !="")
	{
		window.open(path+"action/comrunapprevexcep.jsp?hidBeanId=repapprevexcep&hidBeanMethod=getData&hidMethod=getRepDetails&hidStatus="+stat+"&hidLoanType=C&txtDate="+dt+"&hidOrgCode="+code+"&txtSaveDate="+sdt+"&hidOpFields="+outf+"&hidSelFields="+dbf,"stat","scrollbars=Yes,toolbars=No,menubar=no ,width=750 , height=550,top=10,left=10");
	}
...
function save()
{
	...
	var beanid ="repData";
	var action="Insert";
	var source="/action/comrepapprevexcep.jsp";
