 ...
 function runrep()
{
	...
	else if(document.forms[0].txtfromamt.value=="" && document.forms[0].txttoamt.value=="")
	{
	...
	{
		window.open(path+"action/opsrunappstatus.jsp?hidBeanId=opsreport&hidBeanMethod=getData&hidMethod=getOpsRepDetails&hidStatus="+stat+"&txtDate="+dt+"&txtSaveDate="+sdt+"&txtfromamt="+txtfromamt+"&txttoamt="+txttoamt+"&hidOrgCode="+code+"&hidOpFields="+outf+"&hidSelFields="+dbf+"&orglevel="+orglevel+"&hidOrgName="+orgname,"stat","scrollbars=Yes,toolbars=No,menubar=no ,width=750 , height=550,top=10,left=10");
	}
