...
function doSave()
{
	    ...
	    document.forms[0].hidSourceUrl.value="/action/agr_common_income.jsp";
		document.forms[0].submit();		
		}
}
...
function selectValues(sno)
{
	...
	if(sno!="")
	{	
		document.all.ifrm.src=appURL+"action/ifagr_common_income.jsp?hidBeanId=agrcommon&appno="+appno+"&seqno="+sno+"&hidBeanGetMethod=getIncome&hidAction=edit";
	}
...
function doCancel()
{
	if(ConfirmMsg(102))
	{
		document.forms[0].hidBeanId.value="agrcommon";
		document.forms[0].hidBeanGetMethod.value="getIncome";
		document.forms[0].action=appURL+"action/agr_common_income.jsp";
