...
function callOnAmtReqstd()
{
	...
	{
		var descvalue=(document.forms[0].txtprd_desc.value).split("-");
		var varfrom=descvalue[2];			
		var varto=descvalue[3];
...
function doEdit()
{
	...
	if(document.forms[0].hidCategoryType.value!="LAD" && document.forms[0].sel_Processed_Type.value=="NC")
	{
	...
	if(document.forms[0].hidCategoryType.value!="LAD")
		{
	if(apppostparentdigi=="Y" && loanoperativeacc=="" && val=="E")
	{
		document.forms[0].txt_operativeaccno.readOnly = false;
		document.forms[0].selmodepayment.disabled = false;
	}
		
	if(varPRDCGTMSEFALG=="Y")
	{
		document.forms[0].sel_wht_cgtmse.value="Y";
		document.forms[0].sel_wht_cgtmse.disabled=true;
	}
		}
}
...
function doSave()
{
	...
	if(varAppType=="R" && document.forms[0].hidCategoryType.value!="LAD")
	{ 
...
if(document.forms[0].hidCategoryType.value!="LAD")
{
if(document.forms[0].selectgovt.value=="1" && (document.forms[0].schemetype.value=="080" || document.forms[0].schemetype.value=="081"))
{
	if(document.forms[0].hidconstitution.value!="01" || document.forms[0].selrepaymenttype.value!="1")
	{
		alert("AHP Loans Eligible only for Individual Constitution and EMI Loans only");
		return;
	}
}
}
...
/*if(document.forms[0].hidCategoryType.value=="RET" && varAppType!="P")
{
	...
	if(document.forms[0].prd_type.value=="pG"&& document.forms[0].hidCategoryType.value=="LAD")
		{
		if(document.forms[0].selmodepayment.value!="E" )
			{
			alert("Gold loans Mode of Payment should be Transfer from Saving current ac only");
 ...
 if(varAppType!="P")
 {
	...
	if(varappraisalFlag=="Y")
	{
		...
		else
		{
			...
			{
				document.forms[0].hidoperativeacc.value=document.forms[0].txt_operativeaccno.value;
				document.forms[0].action=appURL+"action/perloandetails.jsp";  		
			}
			document.forms[0].submit();
			return;
...
{	
	...
	var varDeviationAmount = NanNumber(parseFloat(document.forms[0].hiddeviated_amount.value));
	...
	if(varDeviationAmount!="" && varDeviationAmount!="0" && varDeviationAmount!="0.00")
	{
		varEligibleAmount = varDeviationAmount;
	}
...
function disabledvalues()
{
	...
	if(varOtherDepFlag=="Y" && document.forms[0].sel_mclrtype.value!="")
	{
		...
		if(varMCLR[0]!="Y" && varMCLR[0]!="ST")
		{
			alert("Third Party Deposits involved in this proposal, so Reference Type should be One yearly MCLR/Six Months Treasury Bill");
			document.forms[0].sel_mclrtype.value="";
			return;
		}
	}
...
function changlabelCop()
{
  ...
  else if(document.forms[0].prd_type.value=="pB")
  {
	  document.all.cpl.innerText="Total "+varGSTReturns+" Years of GST Return";
  }
  else
  {
...
function moratperiod()
{
	...
	if(varAppType=="P")
	{
		...
		for(var i=0;i<varPSterms.length;i++)
		{
			...
			if(varPSterms[i] == "MOEX")
			{
				if(parseInt(document.forms[0].hidloan_reqterms.value) > parseInt(document.forms[0].txtloan_reqterms.value))
				{
					alert("Loan Period should not lesser then "+document.forms[0].hidloan_reqterms.value+" months");
					document.forms[0].txtloan_reqterms.value="";
					return;
				}
				var total=parseInt(document.forms[0].hidloan_reqterms.value)+(parseInt(document.forms[0].txt_installments.value)-parseInt(document.forms[0].hidloan_moratorium.value));
				if(parseInt(total) < parseInt(document.forms[0].txtloan_reqterms.value))
				{
					alert("Loan Period should not more then "+total+" months");
					document.forms[0].txtloan_reqterms.value="";
					return;
				}
				if(parseInt(document.forms[0].hidloan_moratorium.value) > parseInt(document.forms[0].txt_installments.value))
				{
					alert("Holiday Period should not lesser then "+document.forms[0].hidloan_reqterms.value+" months");
					document.forms[0].txt_installments.value="";
					return;
				}
				var total=parseInt(document.forms[0].hidloan_moratorium.value)+parseInt(varMaxMort);
				if(parseInt(total) < parseInt(document.forms[0].txt_installments.value))
				{
					alert("Holiday Period should not more then "+total+" months");
					document.forms[0].txt_installments.value="";
					return;
				}
			}
...
function enablefields()
{
	...
	if(hidmortflag=='Y') //if(producttype!="" && producttype=='pM' && prdLoanType == 'OD')
	{
		...
		document.all.idemi3.style.visibility = "hidden";
		document.all.idemi3.style.position = "absolute";
...
function callOnLoad() 
{
	if(vartakeover != "")
	 ...
	 // document.forms[0].action=appURL+"action/per_house_proposed_asset.jsp?hidtakeover="+document.forms[0].sel_take_over.value;
	//document.forms[0].submit();
	document.all.idhous.style.visibility = "hidden";
	document.all.idhous.style.position = "absolute";
...
/*	if(document.forms[0].hidCategoryType.value=="RET")
	{	
		document.all.idCFR.style.display="table-row";
		...
		if(varCFRverified!="")
		{
			document.forms[0].CFR_verified.value=varCFRverified;
		}
		if(varCFRnameCheck!="")
		{
			document.forms[0].Namein_CFR.value=varCFRnameCheck;
		}
		CheckCFR_verified();
		CheckCFR_name();
	...
	else
	{
		...
		*/
	if(varCGTMSE_APPLICABLE=="Y"){
		document.forms[0].CGTMSE_coverage.disabled=false;//for cgtmse button
	}
	//document.forms[0].CGTMSE_coverage.disabled=false;//for cgtmse button
	document.forms[0].txt_repaycapacity.value=roundVal(loan_repaycapacity);
	...
	if(mortFlag=='N') //if(varPrdType!='pM' && prdLoanType != 'OD')
	{
		document.all.idrepay.style.visibility = "visible";
		document.all.idrepay.style.position = "relative";
		document.all.idrepay1.style.visibility = "visible";
	...
	if((varPrdType=='pA'  || varPrdType=='pS') && varPurposeID=='U')
	{
		document.all.idveh.style.visibility = "visible";
		document.all.idveh.style.position = "relative";
	...
	else if(varPrdType=='pU' && document.forms[0].hidvehicletype.value=='2')
	{
		document.all.idveh.style.visibility = "visible";
		document.all.idveh.style.position = "relative";
	...
	if(varPrdType=='pL')
	{
		...
		document.all.leas.style.visibility = "visible";
		document.all.leas.style.position = "relative";
		document.all.idlease1.style.display = "table-row";
	}	
	else
	{
		document.all.leas.style.visibility = "hidden";
		document.all.leas.style.position = "absolute";
		document.all.idlease1.style.display = "none";
	}				
	/* To show co-operative society value   */
	if(society != "")
	{		
	document.forms[0].co_operative.value=society;
	}
	/*if(varguafee != "")
	{		
	//document.forms[0].sel_cg_fee.value=varguafee;
	}
	else
	{
	...
	/*
	* To store the value in the "Interest charged during Repayment Holiday" field
	*/
	if (servised != "")
	{
	...
	/*
	* To store the value in the "Interest charged " field
	*/
	if(interestcharged!="")
	{
	...
	/*
	* To store the value in the "Interest Calculation mode" field
	*/
	if(varIntCalcMode!="")
	{
	...
	*/
	...
	/*
	* To store the value in the "Whether Secured" field
	*/
	if (secured != "")
	{
	...
	*/
	entersecure();
	/*
	* To store the value in the "Interest type second" field
	*/
	if(steptype!="")
	{
		document.forms[0].sel_steptype.value=steptype;
	}
	/*
	* To store the value in the "Measurement Type" field
	*/
	if(measurement!="")
	{
		document.forms[0].measurementtype.value=measurement;
	}
	else
	{
		document.forms[0].measurementtype.value="c";
	}
	/*
	* To store the value in the "Mode of payment" field
	*/
	if(val=="")
	{
	...
	*/
	...
	{
		document.forms[0].sel_facilitytype.value=varloanfac;
	}
		
	//Disable Interest EMI when the loan is not for staff
	var varProductType = document.forms[0].prd_type.value.toUpperCase();
	...
	{
		document.all.interestEMI1.style.visibility="hidden";
		document.all.interestEMI1.style.position="absolute";
		
		document.all.interestEMI2.style.visibility="hidden";
		document.all.interestEMI2.style.position="absolute";
		
		document.all.interestEMI3.style.visibility="hidden";
		document.all.interestEMI3.style.position="absolute";
		
		document.all.idcooperative.style.visibility="hidden";
		document.all.idcooperative.style.position="absolute";
		
		document.forms[0].co_operative.value="2";
	}
	
	if(varProductType.charAt(0) == "A")
	{
		document.all.measurementtype.style.visibility="visible";
		document.all.Measurementtype1.style.visibility="visible";
		
	}
	else if(varProductType.charAt(0) == "P")
	{
		document.all.measurementtype.style.visibility="hidden";
		document.all.Measurementtype1.style.visibility="hidden";
	}
	...
	else if(document.forms[0].hidPrdFlag.value=="Y")
	{
	...
	{	
		...
		if(document.forms[0].btnenable.value=="Y")
		{
			...
			document.forms[0].amort.disabled=false;
			if(varCGTMSE_APPLICABLE=="Y"){
			document.forms[0].CGTMSE_coverage.disabled=false;
			}
		}
		else
		{	
		...
		disablefields(true);
		document.forms[0].txtloan_reqterms.disabled=true;	
	}	
	...
	if(varinternetappln == 'Y' && (document.forms[0].selmodepayment.value == '' || document.forms[0].selmodepayment.value == '0')){
		alert("This Application is uploaded from Online. Please provide remaining details and Save the page to proceed");   
		callCalculate();
		calculateLoanAmount();
		doEdit();
	}
	...
	{
		if(trim(loan_cgtmse)!="")
			document.forms[0].sel_facility_cover.value=trim(loan_cgtmse);
		else
			document.forms[0].sel_facility_cover.value="0";
		
		if(varSHGcustomer=="Y" && document.forms[0].appno.value!="new")
			document.all.idshgdet.style.display="table";
		else
			document.all.idshgdet.style.display="none";
	...
	document.all.costproject5.style.position="absolute";
	 ...
	 if(varPrdType=='pP' ||  varPrdType=='pC' || varPrdType=='pJ' || varPrdType=='pN' || varPrdType=='pV')
		{
			document.all.costproject1.style.visibility = "hidden";
			document.all.costproject1.style.position = "absolute";
	 ...
	 if(varLoanRenewRestr=="R" || varLoanRenewRestr=="S")
	 {
	 ...
	 if (varloandnwrevisions != "")
	 {
		 document.forms[0].sel_downwardrevision.value = varloandnwrevisions;
	 }
	 else 
	 {
		 document.forms[0].sel_downwardrevision.value = "s";
	 }
	 if(document.forms[0].hidNSDLFlag.value=="Y")
	 {
		document.all.idnsdl1.style.visibility = "visible";
		document.all.idnsdl1.style.position = "relative";
		document.all.idnsdl2.style.visibility = "visible";
		document.all.idnsdl2.style.position = "relative";
	 }
	 
	/* if(varPrdType=="pH")
	 {
		 document.all.idhouse.style.display="table-row"; 
	 }
	 else
	 {
		 document.all.idhouse.style.display="none"; 
	 }*/
	 
	if(strOrgLevel=="D")
	{
		document.all.idclpu.style.display="inline"; 
	}
	else
	{
	...
	else if(varAppType=="S")
	{
		document.forms[0].sel_restr_scheme.value=varRestrscheme;
		checkdateval();
	}
	if(varCGTMSE_APPLICABLE!="")
	{
		document.forms[0].sel_wht_cgtmse.value=varCGTMSE_APPLICABLE;
	}
	sel_whtCGTMSE();
...
var varVisibility;
	...
	document.all.idemi3.style.visibility=varVisibility;
	document.all.idemi3.style.position="relative";
}
...
function loadROIFields()
{
	if(parseInt(document.forms[0].sel_interesttype.length)>2)
	{
		document.all.idint3.style.visibility="visible";
		document.all.idint3.style.position="relative";
		document.all.idint4.style.visibility="visible";
		document.all.idint4.style.position="relative";
	}
	else
	{
		document.all.idint3.style.visibility="hidden";
