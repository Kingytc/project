...
//	var loantype = document.forms[0].selprodtype.value;
	...
	///if (param !="")
	//{
		//window.open(path+"action/msme_Statusreport.jsp?hidBeanId=perrepappstatus&hidBeanMethod=getData&hidMethod=getRepDetails&hidStatus="+stat+"&txtDate="+dt+"&txtSaveDate="+sdt+"&txtfromamt="+txtfromamt+"&txttoamt="+txttoamt+"&hidOrgCode="+code+"&hidOpFields="+outf+"&hidSelFields="+dbf+"&orglevel="+orglevel+"&hidOrgName="+orgname+"&loantype="+loantype,"stat","scrollbars=Yes,toolbars=No,menubar=no ,width=750 , height=550,top=10,left=10");
		window.open(path+"action/msme_Statusreport.jsp","stat","scrollbars=Yes,toolbars=No,menubar=no ,width=750 , height=550,top=10,left=0");//hidBeanId=perrepappstatus&hidBeanMethod=getData&hidMethod=getRepDetails&hidStatus="+stat+"&txtDate="+dt+"&txtSaveDate="+sdt+"&txtfromamt="+txtfromamt+"&txttoamt="+txttoamt+"&hidOrgCode="+code+"&hidOpFields="+outf+"&hidSelFields="+dbf+"&orglevel="+orglevel+"&hidOrgName="+orgname+"&loantype="+loantype,"stat","scrollbars=Yes,toolbars=No,menubar=no ,width=750 , height=550,top=10,left=10");
	//}
