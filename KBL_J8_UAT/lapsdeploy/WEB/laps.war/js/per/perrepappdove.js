...
function runrep()
{
	...
	if (param !="")
	{
		window.open(path+"action/perrunappdove.jsp?hidBeanId=repappdove&hidBeanMethod=getData&hidMethod=getRepDetails&loantype=P&txtDate="+dt+"&txtSaveDate="+sdt+"&hidOrgCode="+code+"&hidOpFields="+outf+"&hidSelFields="+dbf,"dove","scrollbars=Yes,toolbars=No,menubar=no ,width=750 , height=550,top=10,left=10");
	}
...
function save()
{
	...
	var beanid ="repData";
	var action="Insert";
	var source="/action/perrepappdove.jsp";
