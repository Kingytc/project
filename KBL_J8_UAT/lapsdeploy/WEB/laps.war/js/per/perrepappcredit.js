...
function runrep()
{
	...
	if (param !="")
	{
		window.open(path+"action/perrunappcredit.jsp?hidBeanId=repappcredit&hidBeanMethod=getData&hidMethod=getRepDetails&hidLoanType=P&hidPrdCode=p&hidCatFields="+rpout+"&txtDate="+dt+"&hidOrgCode="+code+"&txtSaveDate="+sdt+"&hidOpFields="+outf+"&hidSelFields="+dbf,"cred","scrollbars=Yes,toolbars=No,menubar=no ,width=750 , height=550,top=10,left=10");
	}
